...
#region units
	private static Unit_ centimeterpersecondsqr_ = new Unit_("CentimeterPerSecondSqr", "cm/s²", 1.0);
	private static Unit_ millimeterpersecondsqr_ = new Unit_("MillimeterPerSecondSqr", "mm/s²", 0.1);
	private static Unit_ meterpersecondsqr_ = new Unit_("MeterPerSecondSqr", "m/s²", 100.0);
	private static Unit_ inchpersecondsqr_ = new Unit_("InchPerSecondSqr", "in/s²", 2.56);
...
#region comparisons
    ...
    public bool Equals(Acceleration other) => other is object && Equals((object)other);
...
#region conversions
		public static Acceleration FromCentimeterPerSecondSqrs(double value, double minValue, double maxValue) => new Acceleration(value * centimeterpersecondsqr_.Factor, minValue * centimeterpersecondsqr_.Factor, maxValue * centimeterpersecondsqr_.Factor);
		public static Acceleration FromCentimeterPerSecondSqrs(double value) => new Acceleration(value * centimeterpersecondsqr_.Factor);
		public double GetValueInCentimeterPerSecondSqrs() => Value_ / centimeterpersecondsqr_.Factor;
		public static Acceleration FromMillimeterPerSecondSqrs(double value, double minValue, double maxValue) => new Acceleration(value * millimeterpersecondsqr_.Factor, minValue * millimeterpersecondsqr_.Factor, maxValue * millimeterpersecondsqr_.Factor);
		public static Acceleration FromMillimeterPerSecondSqrs(double value) => new Acceleration(value * millimeterpersecondsqr_.Factor);
		public double GetValueInMillimeterPerSecondSqrs() => Value_ / millimeterpersecondsqr_.Factor;
		public static Acceleration FromMeterPerSecondSqrs(double value, double minValue, double maxValue) => new Acceleration(value * meterpersecondsqr_.Factor, minValue * meterpersecondsqr_.Factor, maxValue * meterpersecondsqr_.Factor);
		public static Acceleration FromMeterPerSecondSqrs(double value) => new Acceleration(value * meterpersecondsqr_.Factor);
		public double GetValueInMeterPerSecondSqrs() => Value_ / meterpersecondsqr_.Factor;
		public static Acceleration FromInchPerSecondSqrs(double value, double minValue, double maxValue) => new Acceleration(value * inchpersecondsqr_.Factor, minValue * inchpersecondsqr_.Factor, maxValue * inchpersecondsqr_.Factor);
		public static Acceleration FromInchPerSecondSqrs(double value) => new Acceleration(value * inchpersecondsqr_.Factor);
		public double GetValueInInchPerSecondSqrs() => Value_ / inchpersecondsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(Acceleration acceleration, bool throwOnFail=true)
    {
        bool fail = false;
        if (acceleration.HasMinValue && acceleration.Value_ < acceleration.MinValue)
        {
            fail = true;
        }

        if (acceleration.HasMaxValue && acceleration.Value_ > acceleration.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("Acceleration is outside its bounds.");
        }
        else if (fail)
        {
            return false;
