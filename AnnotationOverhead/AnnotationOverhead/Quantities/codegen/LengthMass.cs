...
#region units
	private static Unit_ centimeterkilogram_ = new Unit_("CentimeterKilogram", "cm kg", 1);
	private static Unit_ millimeterkilogram_ = new Unit_("MillimeterKilogram", "mm kg", 0.1);
	private static Unit_ meterkilogram_ = new Unit_("MeterKilogram", "m kg", 100);
	private static Unit_ inchkilogram_ = new Unit_("InchKilogram", "in kg", 2.56);
...
#region comparisons
    ...
    public bool Equals(LengthMass other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthMass FromCentimeterKilograms(double value, double minValue, double maxValue) => new LengthMass(value * centimeterkilogram_.Factor, minValue * centimeterkilogram_.Factor, maxValue * centimeterkilogram_.Factor);
		public static LengthMass FromCentimeterKilograms(double value) => new LengthMass(value * centimeterkilogram_.Factor);
		public double GetValueInCentimeterKilograms() => Value_ / centimeterkilogram_.Factor;
		public static LengthMass FromMillimeterKilograms(double value, double minValue, double maxValue) => new LengthMass(value * millimeterkilogram_.Factor, minValue * millimeterkilogram_.Factor, maxValue * millimeterkilogram_.Factor);
		public static LengthMass FromMillimeterKilograms(double value) => new LengthMass(value * millimeterkilogram_.Factor);
		public double GetValueInMillimeterKilograms() => Value_ / millimeterkilogram_.Factor;
		public static LengthMass FromMeterKilograms(double value, double minValue, double maxValue) => new LengthMass(value * meterkilogram_.Factor, minValue * meterkilogram_.Factor, maxValue * meterkilogram_.Factor);
		public static LengthMass FromMeterKilograms(double value) => new LengthMass(value * meterkilogram_.Factor);
		public double GetValueInMeterKilograms() => Value_ / meterkilogram_.Factor;
		public static LengthMass FromInchKilograms(double value, double minValue, double maxValue) => new LengthMass(value * inchkilogram_.Factor, minValue * inchkilogram_.Factor, maxValue * inchkilogram_.Factor);
		public static LengthMass FromInchKilograms(double value) => new LengthMass(value * inchkilogram_.Factor);
		public double GetValueInInchKilograms() => Value_ / inchkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthMass lengthmass, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthmass.HasMinValue && lengthmass.Value_ < lengthmass.MinValue)
        {
            fail = true;
        }

        if (lengthmass.HasMaxValue && lengthmass.Value_ > lengthmass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
