...
#region units
	private static Unit_ centimeterpersecond_ = new Unit_("CentimeterPerSecond", "cm/s", 1.0);
	private static Unit_ millimeterpersecond_ = new Unit_("MillimeterPerSecond", "mm/s", 0.1);
	private static Unit_ meterpersecond_ = new Unit_("MeterPerSecond", "m/s", 100.0);
	private static Unit_ inchpersecond_ = new Unit_("InchPerSecond", "in/s", 2.56);
...
#region comparisons
    ...
    public bool Equals(Speed other) => other is object && Equals((object)other);
...
#region conversions
		public static Speed FromCentimeterPerSeconds(double value, double minValue, double maxValue) => new Speed(value * centimeterpersecond_.Factor, minValue * centimeterpersecond_.Factor, maxValue * centimeterpersecond_.Factor);
		public static Speed FromCentimeterPerSeconds(double value) => new Speed(value * centimeterpersecond_.Factor);
		public double GetValueInCentimeterPerSeconds() => Value_ / centimeterpersecond_.Factor;
		public static Speed FromMillimeterPerSeconds(double value, double minValue, double maxValue) => new Speed(value * millimeterpersecond_.Factor, minValue * millimeterpersecond_.Factor, maxValue * millimeterpersecond_.Factor);
		public static Speed FromMillimeterPerSeconds(double value) => new Speed(value * millimeterpersecond_.Factor);
		public double GetValueInMillimeterPerSeconds() => Value_ / millimeterpersecond_.Factor;
		public static Speed FromMeterPerSeconds(double value, double minValue, double maxValue) => new Speed(value * meterpersecond_.Factor, minValue * meterpersecond_.Factor, maxValue * meterpersecond_.Factor);
		public static Speed FromMeterPerSeconds(double value) => new Speed(value * meterpersecond_.Factor);
		public double GetValueInMeterPerSeconds() => Value_ / meterpersecond_.Factor;
		public static Speed FromInchPerSeconds(double value, double minValue, double maxValue) => new Speed(value * inchpersecond_.Factor, minValue * inchpersecond_.Factor, maxValue * inchpersecond_.Factor);
		public static Speed FromInchPerSeconds(double value) => new Speed(value * inchpersecond_.Factor);
		public double GetValueInInchPerSeconds() => Value_ / inchpersecond_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(Speed speed, bool throwOnFail=true)
    {
        bool fail = false;
        if (speed.HasMinValue && speed.Value_ < speed.MinValue)
        {
            fail = true;
        }

        if (speed.HasMaxValue && speed.Value_ > speed.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("Speed is outside its bounds.");
        }
        else if (fail)
        {
            return false;
