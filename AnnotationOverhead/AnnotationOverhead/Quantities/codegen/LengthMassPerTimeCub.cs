...
#region units
	private static Unit_ centimeterkilogrampersecondcub_ = new Unit_("CentimeterKilogramPerSecondCub", "cm kg/s�", 1.0);
	private static Unit_ millimeterkilogrampersecondcub_ = new Unit_("MillimeterKilogramPerSecondCub", "mm kg/s�", 0.1);
	private static Unit_ meterkilogrampersecondcub_ = new Unit_("MeterKilogramPerSecondCub", "m kg/s�", 100.0);
	private static Unit_ inchkilogrampersecondcub_ = new Unit_("InchKilogramPerSecondCub", "in kg/s�", 2.56);
...
#region comparisons
    ...
    public bool Equals(LengthMassPerTimeCub other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthMassPerTimeCub FromCentimeterKilogramPerSecondCubs(double value, double minValue, double maxValue) => new LengthMassPerTimeCub(value * centimeterkilogrampersecondcub_.Factor, minValue * centimeterkilogrampersecondcub_.Factor, maxValue * centimeterkilogrampersecondcub_.Factor);
		public static LengthMassPerTimeCub FromCentimeterKilogramPerSecondCubs(double value) => new LengthMassPerTimeCub(value * centimeterkilogrampersecondcub_.Factor);
		public double GetValueInCentimeterKilogramPerSecondCubs() => Value_ / centimeterkilogrampersecondcub_.Factor;
		public static LengthMassPerTimeCub FromMillimeterKilogramPerSecondCubs(double value, double minValue, double maxValue) => new LengthMassPerTimeCub(value * millimeterkilogrampersecondcub_.Factor, minValue * millimeterkilogrampersecondcub_.Factor, maxValue * millimeterkilogrampersecondcub_.Factor);
		public static LengthMassPerTimeCub FromMillimeterKilogramPerSecondCubs(double value) => new LengthMassPerTimeCub(value * millimeterkilogrampersecondcub_.Factor);
		public double GetValueInMillimeterKilogramPerSecondCubs() => Value_ / millimeterkilogrampersecondcub_.Factor;
		public static LengthMassPerTimeCub FromMeterKilogramPerSecondCubs(double value, double minValue, double maxValue) => new LengthMassPerTimeCub(value * meterkilogrampersecondcub_.Factor, minValue * meterkilogrampersecondcub_.Factor, maxValue * meterkilogrampersecondcub_.Factor);
		public static LengthMassPerTimeCub FromMeterKilogramPerSecondCubs(double value) => new LengthMassPerTimeCub(value * meterkilogrampersecondcub_.Factor);
		public double GetValueInMeterKilogramPerSecondCubs() => Value_ / meterkilogrampersecondcub_.Factor;
		public static LengthMassPerTimeCub FromInchKilogramPerSecondCubs(double value, double minValue, double maxValue) => new LengthMassPerTimeCub(value * inchkilogrampersecondcub_.Factor, minValue * inchkilogrampersecondcub_.Factor, maxValue * inchkilogrampersecondcub_.Factor);
		public static LengthMassPerTimeCub FromInchKilogramPerSecondCubs(double value) => new LengthMassPerTimeCub(value * inchkilogrampersecondcub_.Factor);
		public double GetValueInInchKilogramPerSecondCubs() => Value_ / inchkilogrampersecondcub_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthMassPerTimeCub lengthmasspertimecub, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthmasspertimecub.HasMinValue && lengthmasspertimecub.Value_ < lengthmasspertimecub.MinValue)
        {
            fail = true;
        }

        if (lengthmasspertimecub.HasMaxValue && lengthmasspertimecub.Value_ > lengthmasspertimecub.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthMassPerTimeCub is outside its bounds.");
        }
        else if (fail)
        {
            return false;
