...
#region units
	private static Unit_ kilogrampersecondcentimetersqr_ = new Unit_("KilogramPerSecondCentimeterSqr", "kg/s cm²", 1.0);
	private static Unit_ kilogrampersecondmillimetersqr_ = new Unit_("KilogramPerSecondMillimeterSqr", "kg/s mm²", 99.99999999999999);
	private static Unit_ kilogrampersecondmetersqr_ = new Unit_("KilogramPerSecondMeterSqr", "kg/s m²", 0.0001);
	private static Unit_ kilogrampersecondinchsqr_ = new Unit_("KilogramPerSecondInchSqr", "kg/s in²", 0.152587890625);
...
#region comparisons
    ...
    public bool Equals(MassPerTimeLengthSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static MassPerTimeLengthSqr FromKilogramPerSecondCentimeterSqrs(double value, double minValue, double maxValue) => new MassPerTimeLengthSqr(value * kilogrampersecondcentimetersqr_.Factor, minValue * kilogrampersecondcentimetersqr_.Factor, maxValue * kilogrampersecondcentimetersqr_.Factor);
		public static MassPerTimeLengthSqr FromKilogramPerSecondCentimeterSqrs(double value) => new MassPerTimeLengthSqr(value * kilogrampersecondcentimetersqr_.Factor);
		public double GetValueInKilogramPerSecondCentimeterSqrs() => Value_ / kilogrampersecondcentimetersqr_.Factor;
		public static MassPerTimeLengthSqr FromKilogramPerSecondMillimeterSqrs(double value, double minValue, double maxValue) => new MassPerTimeLengthSqr(value * kilogrampersecondmillimetersqr_.Factor, minValue * kilogrampersecondmillimetersqr_.Factor, maxValue * kilogrampersecondmillimetersqr_.Factor);
		public static MassPerTimeLengthSqr FromKilogramPerSecondMillimeterSqrs(double value) => new MassPerTimeLengthSqr(value * kilogrampersecondmillimetersqr_.Factor);
		public double GetValueInKilogramPerSecondMillimeterSqrs() => Value_ / kilogrampersecondmillimetersqr_.Factor;
		public static MassPerTimeLengthSqr FromKilogramPerSecondMeterSqrs(double value, double minValue, double maxValue) => new MassPerTimeLengthSqr(value * kilogrampersecondmetersqr_.Factor, minValue * kilogrampersecondmetersqr_.Factor, maxValue * kilogrampersecondmetersqr_.Factor);
		public static MassPerTimeLengthSqr FromKilogramPerSecondMeterSqrs(double value) => new MassPerTimeLengthSqr(value * kilogrampersecondmetersqr_.Factor);
		public double GetValueInKilogramPerSecondMeterSqrs() => Value_ / kilogrampersecondmetersqr_.Factor;
		public static MassPerTimeLengthSqr FromKilogramPerSecondInchSqrs(double value, double minValue, double maxValue) => new MassPerTimeLengthSqr(value * kilogrampersecondinchsqr_.Factor, minValue * kilogrampersecondinchsqr_.Factor, maxValue * kilogrampersecondinchsqr_.Factor);
		public static MassPerTimeLengthSqr FromKilogramPerSecondInchSqrs(double value) => new MassPerTimeLengthSqr(value * kilogrampersecondinchsqr_.Factor);
		public double GetValueInKilogramPerSecondInchSqrs() => Value_ / kilogrampersecondinchsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(MassPerTimeLengthSqr masspertimelengthsqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (masspertimelengthsqr.HasMinValue && masspertimelengthsqr.Value_ < masspertimelengthsqr.MinValue)
        {
            fail = true;
        }

        if (masspertimelengthsqr.HasMaxValue && masspertimelengthsqr.Value_ > masspertimelengthsqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("MassPerTimeLengthSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
