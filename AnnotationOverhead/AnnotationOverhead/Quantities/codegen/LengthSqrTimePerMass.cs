...
#region units
	private static Unit_ centimetersqrsecondperkilogram_ = new Unit_("CentimeterSqrSecondPerKilogram", "cm� s/kg", 1.0);
	private static Unit_ millimetersqrsecondperkilogram_ = new Unit_("MillimeterSqrSecondPerKilogram", "mm� s/kg", 0.010000000000000002);
	private static Unit_ metersqrsecondperkilogram_ = new Unit_("MeterSqrSecondPerKilogram", "m� s/kg", 10000.0);
	private static Unit_ inchsqrsecondperkilogram_ = new Unit_("InchSqrSecondPerKilogram", "in� s/kg", 6.5536);
...
#region comparisons
    ...
    public bool Equals(LengthSqrTimePerMass other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthSqrTimePerMass FromCentimeterSqrSecondPerKilograms(double value, double minValue, double maxValue) => new LengthSqrTimePerMass(value * centimetersqrsecondperkilogram_.Factor, minValue * centimetersqrsecondperkilogram_.Factor, maxValue * centimetersqrsecondperkilogram_.Factor);
		public static LengthSqrTimePerMass FromCentimeterSqrSecondPerKilograms(double value) => new LengthSqrTimePerMass(value * centimetersqrsecondperkilogram_.Factor);
		public double GetValueInCentimeterSqrSecondPerKilograms() => Value_ / centimetersqrsecondperkilogram_.Factor;
		public static LengthSqrTimePerMass FromMillimeterSqrSecondPerKilograms(double value, double minValue, double maxValue) => new LengthSqrTimePerMass(value * millimetersqrsecondperkilogram_.Factor, minValue * millimetersqrsecondperkilogram_.Factor, maxValue * millimetersqrsecondperkilogram_.Factor);
		public static LengthSqrTimePerMass FromMillimeterSqrSecondPerKilograms(double value) => new LengthSqrTimePerMass(value * millimetersqrsecondperkilogram_.Factor);
		public double GetValueInMillimeterSqrSecondPerKilograms() => Value_ / millimetersqrsecondperkilogram_.Factor;
		public static LengthSqrTimePerMass FromMeterSqrSecondPerKilograms(double value, double minValue, double maxValue) => new LengthSqrTimePerMass(value * metersqrsecondperkilogram_.Factor, minValue * metersqrsecondperkilogram_.Factor, maxValue * metersqrsecondperkilogram_.Factor);
		public static LengthSqrTimePerMass FromMeterSqrSecondPerKilograms(double value) => new LengthSqrTimePerMass(value * metersqrsecondperkilogram_.Factor);
		public double GetValueInMeterSqrSecondPerKilograms() => Value_ / metersqrsecondperkilogram_.Factor;
		public static LengthSqrTimePerMass FromInchSqrSecondPerKilograms(double value, double minValue, double maxValue) => new LengthSqrTimePerMass(value * inchsqrsecondperkilogram_.Factor, minValue * inchsqrsecondperkilogram_.Factor, maxValue * inchsqrsecondperkilogram_.Factor);
		public static LengthSqrTimePerMass FromInchSqrSecondPerKilograms(double value) => new LengthSqrTimePerMass(value * inchsqrsecondperkilogram_.Factor);
		public double GetValueInInchSqrSecondPerKilograms() => Value_ / inchsqrsecondperkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthSqrTimePerMass lengthsqrtimepermass, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthsqrtimepermass.HasMinValue && lengthsqrtimepermass.Value_ < lengthsqrtimepermass.MinValue)
        {
            fail = true;
        }

        if (lengthsqrtimepermass.HasMaxValue && lengthsqrtimepermass.Value_ > lengthsqrtimepermass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthSqrTimePerMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
