...
#region units
	private static Unit_ secondperkilogramcentimetersqr_ = new Unit_("SecondPerKilogramCentimeterSqr", "s/kg cm²", 1.0);
	private static Unit_ secondperkilogrammillimetersqr_ = new Unit_("SecondPerKilogramMillimeterSqr", "s/kg mm²", 99.99999999999999);
	private static Unit_ secondperkilogrammetersqr_ = new Unit_("SecondPerKilogramMeterSqr", "s/kg m²", 0.0001);
	private static Unit_ secondperkilograminchsqr_ = new Unit_("SecondPerKilogramInchSqr", "s/kg in²", 0.152587890625);
...
#region comparisons
    ...
    public bool Equals(TimePerMassLengthSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static TimePerMassLengthSqr FromSecondPerKilogramCentimeterSqrs(double value, double minValue, double maxValue) => new TimePerMassLengthSqr(value * secondperkilogramcentimetersqr_.Factor, minValue * secondperkilogramcentimetersqr_.Factor, maxValue * secondperkilogramcentimetersqr_.Factor);
		public static TimePerMassLengthSqr FromSecondPerKilogramCentimeterSqrs(double value) => new TimePerMassLengthSqr(value * secondperkilogramcentimetersqr_.Factor);
		public double GetValueInSecondPerKilogramCentimeterSqrs() => Value_ / secondperkilogramcentimetersqr_.Factor;
		public static TimePerMassLengthSqr FromSecondPerKilogramMillimeterSqrs(double value, double minValue, double maxValue) => new TimePerMassLengthSqr(value * secondperkilogrammillimetersqr_.Factor, minValue * secondperkilogrammillimetersqr_.Factor, maxValue * secondperkilogrammillimetersqr_.Factor);
		public static TimePerMassLengthSqr FromSecondPerKilogramMillimeterSqrs(double value) => new TimePerMassLengthSqr(value * secondperkilogrammillimetersqr_.Factor);
		public double GetValueInSecondPerKilogramMillimeterSqrs() => Value_ / secondperkilogrammillimetersqr_.Factor;
		public static TimePerMassLengthSqr FromSecondPerKilogramMeterSqrs(double value, double minValue, double maxValue) => new TimePerMassLengthSqr(value * secondperkilogrammetersqr_.Factor, minValue * secondperkilogrammetersqr_.Factor, maxValue * secondperkilogrammetersqr_.Factor);
		public static TimePerMassLengthSqr FromSecondPerKilogramMeterSqrs(double value) => new TimePerMassLengthSqr(value * secondperkilogrammetersqr_.Factor);
		public double GetValueInSecondPerKilogramMeterSqrs() => Value_ / secondperkilogrammetersqr_.Factor;
		public static TimePerMassLengthSqr FromSecondPerKilogramInchSqrs(double value, double minValue, double maxValue) => new TimePerMassLengthSqr(value * secondperkilograminchsqr_.Factor, minValue * secondperkilograminchsqr_.Factor, maxValue * secondperkilograminchsqr_.Factor);
		public static TimePerMassLengthSqr FromSecondPerKilogramInchSqrs(double value) => new TimePerMassLengthSqr(value * secondperkilograminchsqr_.Factor);
		public double GetValueInSecondPerKilogramInchSqrs() => Value_ / secondperkilograminchsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimePerMassLengthSqr timepermasslengthsqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (timepermasslengthsqr.HasMinValue && timepermasslengthsqr.Value_ < timepermasslengthsqr.MinValue)
        {
            fail = true;
        }

        if (timepermasslengthsqr.HasMaxValue && timepermasslengthsqr.Value_ > timepermasslengthsqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimePerMassLengthSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
