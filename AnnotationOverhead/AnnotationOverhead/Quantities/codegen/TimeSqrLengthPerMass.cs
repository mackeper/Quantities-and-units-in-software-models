...
#region units
	private static Unit_ secondsqrcentimeterperkilogram_ = new Unit_("SecondSqrCentimeterPerKilogram", "s� cm/kg", 1.0);
	private static Unit_ secondsqrmillimeterperkilogram_ = new Unit_("SecondSqrMillimeterPerKilogram", "s� mm/kg", 0.1);
	private static Unit_ secondsqrmeterperkilogram_ = new Unit_("SecondSqrMeterPerKilogram", "s� m/kg", 100.0);
	private static Unit_ secondsqrinchperkilogram_ = new Unit_("SecondSqrInchPerKilogram", "s� in/kg", 2.56);
...
#region comparisons
    ...
    public bool Equals(TimeSqrLengthPerMass other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeSqrLengthPerMass FromSecondSqrCentimeterPerKilograms(double value, double minValue, double maxValue) => new TimeSqrLengthPerMass(value * secondsqrcentimeterperkilogram_.Factor, minValue * secondsqrcentimeterperkilogram_.Factor, maxValue * secondsqrcentimeterperkilogram_.Factor);
		public static TimeSqrLengthPerMass FromSecondSqrCentimeterPerKilograms(double value) => new TimeSqrLengthPerMass(value * secondsqrcentimeterperkilogram_.Factor);
		public double GetValueInSecondSqrCentimeterPerKilograms() => Value_ / secondsqrcentimeterperkilogram_.Factor;
		public static TimeSqrLengthPerMass FromSecondSqrMillimeterPerKilograms(double value, double minValue, double maxValue) => new TimeSqrLengthPerMass(value * secondsqrmillimeterperkilogram_.Factor, minValue * secondsqrmillimeterperkilogram_.Factor, maxValue * secondsqrmillimeterperkilogram_.Factor);
		public static TimeSqrLengthPerMass FromSecondSqrMillimeterPerKilograms(double value) => new TimeSqrLengthPerMass(value * secondsqrmillimeterperkilogram_.Factor);
		public double GetValueInSecondSqrMillimeterPerKilograms() => Value_ / secondsqrmillimeterperkilogram_.Factor;
		public static TimeSqrLengthPerMass FromSecondSqrMeterPerKilograms(double value, double minValue, double maxValue) => new TimeSqrLengthPerMass(value * secondsqrmeterperkilogram_.Factor, minValue * secondsqrmeterperkilogram_.Factor, maxValue * secondsqrmeterperkilogram_.Factor);
		public static TimeSqrLengthPerMass FromSecondSqrMeterPerKilograms(double value) => new TimeSqrLengthPerMass(value * secondsqrmeterperkilogram_.Factor);
		public double GetValueInSecondSqrMeterPerKilograms() => Value_ / secondsqrmeterperkilogram_.Factor;
		public static TimeSqrLengthPerMass FromSecondSqrInchPerKilograms(double value, double minValue, double maxValue) => new TimeSqrLengthPerMass(value * secondsqrinchperkilogram_.Factor, minValue * secondsqrinchperkilogram_.Factor, maxValue * secondsqrinchperkilogram_.Factor);
		public static TimeSqrLengthPerMass FromSecondSqrInchPerKilograms(double value) => new TimeSqrLengthPerMass(value * secondsqrinchperkilogram_.Factor);
		public double GetValueInSecondSqrInchPerKilograms() => Value_ / secondsqrinchperkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeSqrLengthPerMass timesqrlengthpermass, bool throwOnFail=true)
    {
        bool fail = false;
        if (timesqrlengthpermass.HasMinValue && timesqrlengthpermass.Value_ < timesqrlengthpermass.MinValue)
        {
            fail = true;
        }

        if (timesqrlengthpermass.HasMaxValue && timesqrlengthpermass.Value_ > timesqrlengthpermass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeSqrLengthPerMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
