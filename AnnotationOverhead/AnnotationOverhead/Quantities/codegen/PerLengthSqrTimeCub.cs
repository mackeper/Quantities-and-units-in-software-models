...
#region units
	private static Unit_ percentimetersqrsecondcub_ = new Unit_("PerCentimeterSqrSecondCub", "/cm² s³", 1.0);
	private static Unit_ permillimetersqrsecondcub_ = new Unit_("PerMillimeterSqrSecondCub", "/mm² s³", 0.010000000000000002);
	private static Unit_ permetersqrsecondcub_ = new Unit_("PerMeterSqrSecondCub", "/m² s³", 10000.0);
	private static Unit_ perinchsqrsecondcub_ = new Unit_("PerInchSqrSecondCub", "/in² s³", 6.5536);
...
#region comparisons
    ...
    public bool Equals(PerLengthSqrTimeCub other) => other is object && Equals((object)other);
...
#region conversions
		public static PerLengthSqrTimeCub FromPerCentimeterSqrSecondCubs(double value, double minValue, double maxValue) => new PerLengthSqrTimeCub(value * percentimetersqrsecondcub_.Factor, minValue * percentimetersqrsecondcub_.Factor, maxValue * percentimetersqrsecondcub_.Factor);
		public static PerLengthSqrTimeCub FromPerCentimeterSqrSecondCubs(double value) => new PerLengthSqrTimeCub(value * percentimetersqrsecondcub_.Factor);
		public double GetValueInPerCentimeterSqrSecondCubs() => Value_ / percentimetersqrsecondcub_.Factor;
		public static PerLengthSqrTimeCub FromPerMillimeterSqrSecondCubs(double value, double minValue, double maxValue) => new PerLengthSqrTimeCub(value * permillimetersqrsecondcub_.Factor, minValue * permillimetersqrsecondcub_.Factor, maxValue * permillimetersqrsecondcub_.Factor);
		public static PerLengthSqrTimeCub FromPerMillimeterSqrSecondCubs(double value) => new PerLengthSqrTimeCub(value * permillimetersqrsecondcub_.Factor);
		public double GetValueInPerMillimeterSqrSecondCubs() => Value_ / permillimetersqrsecondcub_.Factor;
		public static PerLengthSqrTimeCub FromPerMeterSqrSecondCubs(double value, double minValue, double maxValue) => new PerLengthSqrTimeCub(value * permetersqrsecondcub_.Factor, minValue * permetersqrsecondcub_.Factor, maxValue * permetersqrsecondcub_.Factor);
		public static PerLengthSqrTimeCub FromPerMeterSqrSecondCubs(double value) => new PerLengthSqrTimeCub(value * permetersqrsecondcub_.Factor);
		public double GetValueInPerMeterSqrSecondCubs() => Value_ / permetersqrsecondcub_.Factor;
		public static PerLengthSqrTimeCub FromPerInchSqrSecondCubs(double value, double minValue, double maxValue) => new PerLengthSqrTimeCub(value * perinchsqrsecondcub_.Factor, minValue * perinchsqrsecondcub_.Factor, maxValue * perinchsqrsecondcub_.Factor);
		public static PerLengthSqrTimeCub FromPerInchSqrSecondCubs(double value) => new PerLengthSqrTimeCub(value * perinchsqrsecondcub_.Factor);
		public double GetValueInPerInchSqrSecondCubs() => Value_ / perinchsqrsecondcub_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(PerLengthSqrTimeCub perlengthsqrtimecub, bool throwOnFail=true)
    {
        bool fail = false;
        if (perlengthsqrtimecub.HasMinValue && perlengthsqrtimecub.Value_ < perlengthsqrtimecub.MinValue)
        {
            fail = true;
        }

        if (perlengthsqrtimecub.HasMaxValue && perlengthsqrtimecub.Value_ > perlengthsqrtimecub.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("PerLengthSqrTimeCub is outside its bounds.");
        }
        else if (fail)
        {
            return false;
