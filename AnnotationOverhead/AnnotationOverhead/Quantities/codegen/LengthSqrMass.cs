...
#region units
	private static Unit_ centimetersqrkilogram_ = new Unit_("CentimeterSqrKilogram", "cm� kg", 1);
	private static Unit_ millimetersqrkilogram_ = new Unit_("MillimeterSqrKilogram", "mm� kg", 0.010000000000000002);
	private static Unit_ metersqrkilogram_ = new Unit_("MeterSqrKilogram", "m� kg", 10000);
	private static Unit_ inchsqrkilogram_ = new Unit_("InchSqrKilogram", "in� kg", 6.5536);
...
#region comparisons
    ...
    public bool Equals(LengthSqrMass other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthSqrMass FromCentimeterSqrKilograms(double value, double minValue, double maxValue) => new LengthSqrMass(value * centimetersqrkilogram_.Factor, minValue * centimetersqrkilogram_.Factor, maxValue * centimetersqrkilogram_.Factor);
		public static LengthSqrMass FromCentimeterSqrKilograms(double value) => new LengthSqrMass(value * centimetersqrkilogram_.Factor);
		public double GetValueInCentimeterSqrKilograms() => Value_ / centimetersqrkilogram_.Factor;
		public static LengthSqrMass FromMillimeterSqrKilograms(double value, double minValue, double maxValue) => new LengthSqrMass(value * millimetersqrkilogram_.Factor, minValue * millimetersqrkilogram_.Factor, maxValue * millimetersqrkilogram_.Factor);
		public static LengthSqrMass FromMillimeterSqrKilograms(double value) => new LengthSqrMass(value * millimetersqrkilogram_.Factor);
		public double GetValueInMillimeterSqrKilograms() => Value_ / millimetersqrkilogram_.Factor;
		public static LengthSqrMass FromMeterSqrKilograms(double value, double minValue, double maxValue) => new LengthSqrMass(value * metersqrkilogram_.Factor, minValue * metersqrkilogram_.Factor, maxValue * metersqrkilogram_.Factor);
		public static LengthSqrMass FromMeterSqrKilograms(double value) => new LengthSqrMass(value * metersqrkilogram_.Factor);
		public double GetValueInMeterSqrKilograms() => Value_ / metersqrkilogram_.Factor;
		public static LengthSqrMass FromInchSqrKilograms(double value, double minValue, double maxValue) => new LengthSqrMass(value * inchsqrkilogram_.Factor, minValue * inchsqrkilogram_.Factor, maxValue * inchsqrkilogram_.Factor);
		public static LengthSqrMass FromInchSqrKilograms(double value) => new LengthSqrMass(value * inchsqrkilogram_.Factor);
		public double GetValueInInchSqrKilograms() => Value_ / inchsqrkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthSqrMass lengthsqrmass, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthsqrmass.HasMinValue && lengthsqrmass.Value_ < lengthsqrmass.MinValue)
        {
            fail = true;
        }

        if (lengthsqrmass.HasMaxValue && lengthsqrmass.Value_ > lengthsqrmass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthSqrMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
