...
#region units
	private static Unit_ centimetercubpersecondcub_ = new Unit_("CentimeterCubPerSecondCub", "cm³/s³", 1.0);
	private static Unit_ millimetercubpersecondcub_ = new Unit_("MillimeterCubPerSecondCub", "mm³/s³", 0.0010000000000000002);
	private static Unit_ metercubpersecondcub_ = new Unit_("MeterCubPerSecondCub", "m³/s³", 1000000.0);
	private static Unit_ inchcubpersecondcub_ = new Unit_("InchCubPerSecondCub", "in³/s³", 16.777216000000003);
...
#region comparisons
    ...
    public bool Equals(LengthCubPerTimeCub other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthCubPerTimeCub FromCentimeterCubPerSecondCubs(double value, double minValue, double maxValue) => new LengthCubPerTimeCub(value * centimetercubpersecondcub_.Factor, minValue * centimetercubpersecondcub_.Factor, maxValue * centimetercubpersecondcub_.Factor);
		public static LengthCubPerTimeCub FromCentimeterCubPerSecondCubs(double value) => new LengthCubPerTimeCub(value * centimetercubpersecondcub_.Factor);
		public double GetValueInCentimeterCubPerSecondCubs() => Value_ / centimetercubpersecondcub_.Factor;
		public static LengthCubPerTimeCub FromMillimeterCubPerSecondCubs(double value, double minValue, double maxValue) => new LengthCubPerTimeCub(value * millimetercubpersecondcub_.Factor, minValue * millimetercubpersecondcub_.Factor, maxValue * millimetercubpersecondcub_.Factor);
		public static LengthCubPerTimeCub FromMillimeterCubPerSecondCubs(double value) => new LengthCubPerTimeCub(value * millimetercubpersecondcub_.Factor);
		public double GetValueInMillimeterCubPerSecondCubs() => Value_ / millimetercubpersecondcub_.Factor;
		public static LengthCubPerTimeCub FromMeterCubPerSecondCubs(double value, double minValue, double maxValue) => new LengthCubPerTimeCub(value * metercubpersecondcub_.Factor, minValue * metercubpersecondcub_.Factor, maxValue * metercubpersecondcub_.Factor);
		public static LengthCubPerTimeCub FromMeterCubPerSecondCubs(double value) => new LengthCubPerTimeCub(value * metercubpersecondcub_.Factor);
		public double GetValueInMeterCubPerSecondCubs() => Value_ / metercubpersecondcub_.Factor;
		public static LengthCubPerTimeCub FromInchCubPerSecondCubs(double value, double minValue, double maxValue) => new LengthCubPerTimeCub(value * inchcubpersecondcub_.Factor, minValue * inchcubpersecondcub_.Factor, maxValue * inchcubpersecondcub_.Factor);
		public static LengthCubPerTimeCub FromInchCubPerSecondCubs(double value) => new LengthCubPerTimeCub(value * inchcubpersecondcub_.Factor);
		public double GetValueInInchCubPerSecondCubs() => Value_ / inchcubpersecondcub_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthCubPerTimeCub lengthcubpertimecub, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthcubpertimecub.HasMinValue && lengthcubpertimecub.Value_ < lengthcubpertimecub.MinValue)
        {
            fail = true;
        }

        if (lengthcubpertimecub.HasMaxValue && lengthcubpertimecub.Value_ > lengthcubpertimecub.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthCubPerTimeCub is outside its bounds.");
        }
        else if (fail)
        {
            return false;
