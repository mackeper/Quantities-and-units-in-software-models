...
#region units
	private static Unit_ centimetercubsecond_ = new Unit_("CentimeterCubSecond", "cm³ s", 1);
	private static Unit_ millimetercubsecond_ = new Unit_("MillimeterCubSecond", "mm³ s", 0.0010000000000000002);
	private static Unit_ metercubsecond_ = new Unit_("MeterCubSecond", "m³ s", 1000000);
	private static Unit_ inchcubsecond_ = new Unit_("InchCubSecond", "in³ s", 16.777216000000003);
...
#region comparisons
    ...
    public bool Equals(LengthCubTime other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthCubTime FromCentimeterCubSeconds(double value, double minValue, double maxValue) => new LengthCubTime(value * centimetercubsecond_.Factor, minValue * centimetercubsecond_.Factor, maxValue * centimetercubsecond_.Factor);
		public static LengthCubTime FromCentimeterCubSeconds(double value) => new LengthCubTime(value * centimetercubsecond_.Factor);
		public double GetValueInCentimeterCubSeconds() => Value_ / centimetercubsecond_.Factor;
		public static LengthCubTime FromMillimeterCubSeconds(double value, double minValue, double maxValue) => new LengthCubTime(value * millimetercubsecond_.Factor, minValue * millimetercubsecond_.Factor, maxValue * millimetercubsecond_.Factor);
		public static LengthCubTime FromMillimeterCubSeconds(double value) => new LengthCubTime(value * millimetercubsecond_.Factor);
		public double GetValueInMillimeterCubSeconds() => Value_ / millimetercubsecond_.Factor;
		public static LengthCubTime FromMeterCubSeconds(double value, double minValue, double maxValue) => new LengthCubTime(value * metercubsecond_.Factor, minValue * metercubsecond_.Factor, maxValue * metercubsecond_.Factor);
		public static LengthCubTime FromMeterCubSeconds(double value) => new LengthCubTime(value * metercubsecond_.Factor);
		public double GetValueInMeterCubSeconds() => Value_ / metercubsecond_.Factor;
		public static LengthCubTime FromInchCubSeconds(double value, double minValue, double maxValue) => new LengthCubTime(value * inchcubsecond_.Factor, minValue * inchcubsecond_.Factor, maxValue * inchcubsecond_.Factor);
		public static LengthCubTime FromInchCubSeconds(double value) => new LengthCubTime(value * inchcubsecond_.Factor);
		public double GetValueInInchCubSeconds() => Value_ / inchcubsecond_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthCubTime lengthcubtime, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthcubtime.HasMinValue && lengthcubtime.Value_ < lengthcubtime.MinValue)
        {
            fail = true;
        }

        if (lengthcubtime.HasMaxValue && lengthcubtime.Value_ > lengthcubtime.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthCubTime is outside its bounds.");
        }
        else if (fail)
        {
            return false;
