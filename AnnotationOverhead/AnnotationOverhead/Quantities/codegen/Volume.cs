...
#region units
	private static Unit_ centimetercub_ = new Unit_("CentimeterCub", "cm�", 1);
	private static Unit_ millimetercub_ = new Unit_("MillimeterCub", "mm�", 0.0010000000000000002);
	private static Unit_ metercub_ = new Unit_("MeterCub", "m�", 1000000);
	private static Unit_ inchcub_ = new Unit_("InchCub", "in�", 16.777216000000003);
...
#region comparisons
    ...
    public bool Equals(Volume other) => other is object && Equals((object)other);
...
#region conversions
		public static Volume FromCentimeterCubs(double value, double minValue, double maxValue) => new Volume(value * centimetercub_.Factor, minValue * centimetercub_.Factor, maxValue * centimetercub_.Factor);
		public static Volume FromCentimeterCubs(double value) => new Volume(value * centimetercub_.Factor);
		public double GetValueInCentimeterCubs() => Value_ / centimetercub_.Factor;
		public static Volume FromMillimeterCubs(double value, double minValue, double maxValue) => new Volume(value * millimetercub_.Factor, minValue * millimetercub_.Factor, maxValue * millimetercub_.Factor);
		public static Volume FromMillimeterCubs(double value) => new Volume(value * millimetercub_.Factor);
		public double GetValueInMillimeterCubs() => Value_ / millimetercub_.Factor;
		public static Volume FromMeterCubs(double value, double minValue, double maxValue) => new Volume(value * metercub_.Factor, minValue * metercub_.Factor, maxValue * metercub_.Factor);
		public static Volume FromMeterCubs(double value) => new Volume(value * metercub_.Factor);
		public double GetValueInMeterCubs() => Value_ / metercub_.Factor;
		public static Volume FromInchCubs(double value, double minValue, double maxValue) => new Volume(value * inchcub_.Factor, minValue * inchcub_.Factor, maxValue * inchcub_.Factor);
		public static Volume FromInchCubs(double value) => new Volume(value * inchcub_.Factor);
		public double GetValueInInchCubs() => Value_ / inchcub_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(Volume volume, bool throwOnFail=true)
    {
        bool fail = false;
        if (volume.HasMinValue && volume.Value_ < volume.MinValue)
        {
            fail = true;
        }

        if (volume.HasMaxValue && volume.Value_ > volume.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("Volume is outside its bounds.");
        }
        else if (fail)
        {
            return false;
