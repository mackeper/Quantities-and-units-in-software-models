...
namespace RaySearch.CorePlatform.Framework
{
    ...
    private static void ImportDisplayUnitFromDatabase_()
    {
        if (!displayUnitIsImported_ && FakeDatabase.Units.ContainsKey("PerLengthMassTime"))
        {
            ...
            {
				      case "percentimetercubkilogramsecond": displayUnit_ = percentimetercubkilogramsecond_; break;
				      case "permillimetercubkilogramsecond": displayUnit_ = permillimetercubkilogramsecond_; break;
				      case "permetercubkilogramsecond": displayUnit_ = permetercubkilogramsecond_; break;
				      case "perinchcubkilogramsecond": displayUnit_ = perinchcubkilogramsecond_; break;
...
#region units
	private static Unit_ percentimetercubkilogramsecond_ = new Unit_("PerCentimeterCubKilogramSecond", "/cm³ kg s", 1.0);
	private static Unit_ permillimetercubkilogramsecond_ = new Unit_("PerMillimeterCubKilogramSecond", "/mm³ kg s", 0.1);
	private static Unit_ permetercubkilogramsecond_ = new Unit_("PerMeterCubKilogramSecond", "/m³ kg s", 100.0);
	private static Unit_ perinchcubkilogramsecond_ = new Unit_("PerInchCubKilogramSecond", "/in³ kg s", 2.56);
	private static Unit_ platformUnit_ = percentimetercubkilogramsecond_;
	private static Unit_ displayUnit_ = percentimetercubkilogramsecond_;
#endregion
...
#region comparisons
    ...
    public bool Equals(PerLengthMassTime other) => other is object && Equals((object)other);
...
#region conversions
		public static PerLengthMassTime FromPerCentimeterCubKilogramSeconds(double value, double minValue, double maxValue) => new PerLengthMassTime(value * percentimetercubkilogramsecond_.Factor, minValue * percentimetercubkilogramsecond_.Factor, maxValue * percentimetercubkilogramsecond_.Factor);
		public static PerLengthMassTime FromPerCentimeterCubKilogramSeconds(double value) => new PerLengthMassTime(value * percentimetercubkilogramsecond_.Factor);
		public double GetValueInPerCentimeterCubKilogramSeconds() => Value_ / percentimetercubkilogramsecond_.Factor;
		public static PerLengthMassTime FromPerMillimeterCubKilogramSeconds(double value, double minValue, double maxValue) => new PerLengthMassTime(value * permillimetercubkilogramsecond_.Factor, minValue * permillimetercubkilogramsecond_.Factor, maxValue * permillimetercubkilogramsecond_.Factor);
		public static PerLengthMassTime FromPerMillimeterCubKilogramSeconds(double value) => new PerLengthMassTime(value * permillimetercubkilogramsecond_.Factor);
		public double GetValueInPerMillimeterCubKilogramSeconds() => Value_ / permillimetercubkilogramsecond_.Factor;
		public static PerLengthMassTime FromPerMeterCubKilogramSeconds(double value, double minValue, double maxValue) => new PerLengthMassTime(value * permetercubkilogramsecond_.Factor, minValue * permetercubkilogramsecond_.Factor, maxValue * permetercubkilogramsecond_.Factor);
		public static PerLengthMassTime FromPerMeterCubKilogramSeconds(double value) => new PerLengthMassTime(value * permetercubkilogramsecond_.Factor);
		public double GetValueInPerMeterCubKilogramSeconds() => Value_ / permetercubkilogramsecond_.Factor;
		public static PerLengthMassTime FromPerInchCubKilogramSeconds(double value, double minValue, double maxValue) => new PerLengthMassTime(value * perinchcubkilogramsecond_.Factor, minValue * perinchcubkilogramsecond_.Factor, maxValue * perinchcubkilogramsecond_.Factor);
		public static PerLengthMassTime FromPerInchCubKilogramSeconds(double value) => new PerLengthMassTime(value * perinchcubkilogramsecond_.Factor);
		public double GetValueInPerInchCubKilogramSeconds() => Value_ / perinchcubkilogramsecond_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(PerLengthMassTime perlengthmasstime, bool throwOnFail=true)
    {
        bool fail = false;
        if (perlengthmasstime.HasMinValue && perlengthmasstime.Value_ < perlengthmasstime.MinValue)
        {
            fail = true;
        }

        if (perlengthmasstime.HasMaxValue && perlengthmasstime.Value_ > perlengthmasstime.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("PerLengthMassTime is outside its bounds.");
        }
        else if (fail)
        {
            return false;
