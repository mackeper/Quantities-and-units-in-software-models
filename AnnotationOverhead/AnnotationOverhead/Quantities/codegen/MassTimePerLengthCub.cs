...
#region units
	private static Unit_ kilogramsecondpercentimetercub_ = new Unit_("KilogramSecondPerCentimeterCub", "kg s/cm�", 1.0);
	private static Unit_ kilogramsecondpermillimetercub_ = new Unit_("KilogramSecondPerMillimeterCub", "kg s/mm�", 999.9999999999998);
	private static Unit_ kilogramsecondpermetercub_ = new Unit_("KilogramSecondPerMeterCub", "kg s/m�", 1e-06);
	private static Unit_ kilogramsecondperinchcub_ = new Unit_("KilogramSecondPerInchCub", "kg s/in�", 0.05960464477539062);
...
#region comparisons
    ...
    public bool Equals(MassTimePerLengthCub other) => other is object && Equals((object)other);
...
#region conversions
		public static MassTimePerLengthCub FromKilogramSecondPerCentimeterCubs(double value, double minValue, double maxValue) => new MassTimePerLengthCub(value * kilogramsecondpercentimetercub_.Factor, minValue * kilogramsecondpercentimetercub_.Factor, maxValue * kilogramsecondpercentimetercub_.Factor);
		public static MassTimePerLengthCub FromKilogramSecondPerCentimeterCubs(double value) => new MassTimePerLengthCub(value * kilogramsecondpercentimetercub_.Factor);
		public double GetValueInKilogramSecondPerCentimeterCubs() => Value_ / kilogramsecondpercentimetercub_.Factor;
		public static MassTimePerLengthCub FromKilogramSecondPerMillimeterCubs(double value, double minValue, double maxValue) => new MassTimePerLengthCub(value * kilogramsecondpermillimetercub_.Factor, minValue * kilogramsecondpermillimetercub_.Factor, maxValue * kilogramsecondpermillimetercub_.Factor);
		public static MassTimePerLengthCub FromKilogramSecondPerMillimeterCubs(double value) => new MassTimePerLengthCub(value * kilogramsecondpermillimetercub_.Factor);
		public double GetValueInKilogramSecondPerMillimeterCubs() => Value_ / kilogramsecondpermillimetercub_.Factor;
		public static MassTimePerLengthCub FromKilogramSecondPerMeterCubs(double value, double minValue, double maxValue) => new MassTimePerLengthCub(value * kilogramsecondpermetercub_.Factor, minValue * kilogramsecondpermetercub_.Factor, maxValue * kilogramsecondpermetercub_.Factor);
		public static MassTimePerLengthCub FromKilogramSecondPerMeterCubs(double value) => new MassTimePerLengthCub(value * kilogramsecondpermetercub_.Factor);
		public double GetValueInKilogramSecondPerMeterCubs() => Value_ / kilogramsecondpermetercub_.Factor;
		public static MassTimePerLengthCub FromKilogramSecondPerInchCubs(double value, double minValue, double maxValue) => new MassTimePerLengthCub(value * kilogramsecondperinchcub_.Factor, minValue * kilogramsecondperinchcub_.Factor, maxValue * kilogramsecondperinchcub_.Factor);
		public static MassTimePerLengthCub FromKilogramSecondPerInchCubs(double value) => new MassTimePerLengthCub(value * kilogramsecondperinchcub_.Factor);
		public double GetValueInKilogramSecondPerInchCubs() => Value_ / kilogramsecondperinchcub_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(MassTimePerLengthCub masstimeperlengthcub, bool throwOnFail=true)
    {
        bool fail = false;
        if (masstimeperlengthcub.HasMinValue && masstimeperlengthcub.Value_ < masstimeperlengthcub.MinValue)
        {
            fail = true;
        }

        if (masstimeperlengthcub.HasMaxValue && masstimeperlengthcub.Value_ > masstimeperlengthcub.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("MassTimePerLengthCub is outside its bounds.");
        }
        else if (fail)
        {
            return false;
