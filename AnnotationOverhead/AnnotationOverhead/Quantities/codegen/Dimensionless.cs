...
#region units
	private static Unit_ _ = new Unit_("", "", 1);
...
#region comparisons
    ...
    public bool Equals(Dimensionless other) => other is object && Equals((object)other);
...
#region conversions
		public static Dimensionless Froms(double value, double minValue, double maxValue) => new Dimensionless(value * _.Factor, minValue * _.Factor, maxValue * _.Factor);
		public static Dimensionless Froms(double value) => new Dimensionless(value * _.Factor);
		public double GetValueIns() => Value_ / _.Factor;
...
#region rules
    ...
    public static bool ValidateRules(Dimensionless dimensionless, bool throwOnFail=true)
    {
        bool fail = false;
        if (dimensionless.HasMinValue && dimensionless.Value_ < dimensionless.MinValue)
        {
            fail = true;
        }

        if (dimensionless.HasMaxValue && dimensionless.Value_ > dimensionless.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("Dimensionless is outside its bounds.");
        }
        else if (fail)
        {
            return false;
