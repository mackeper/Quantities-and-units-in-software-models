...
#region units
	private static Unit_ secondperkilogramcentimetercub_ = new Unit_("SecondPerKilogramCentimeterCub", "s/kg cm�", 1.0);
	private static Unit_ secondperkilogrammillimetercub_ = new Unit_("SecondPerKilogramMillimeterCub", "s/kg mm�", 999.9999999999998);
	private static Unit_ secondperkilogrammetercub_ = new Unit_("SecondPerKilogramMeterCub", "s/kg m�", 1e-06);
	private static Unit_ secondperkilograminchcub_ = new Unit_("SecondPerKilogramInchCub", "s/kg in�", 0.05960464477539062);
...
#region comparisons
    ...
    public bool Equals(TimePerMassLengthCub other) => other is object && Equals((object)other);
...
#region conversions
		public static TimePerMassLengthCub FromSecondPerKilogramCentimeterCubs(double value, double minValue, double maxValue) => new TimePerMassLengthCub(value * secondperkilogramcentimetercub_.Factor, minValue * secondperkilogramcentimetercub_.Factor, maxValue * secondperkilogramcentimetercub_.Factor);
		public static TimePerMassLengthCub FromSecondPerKilogramCentimeterCubs(double value) => new TimePerMassLengthCub(value * secondperkilogramcentimetercub_.Factor);
		public double GetValueInSecondPerKilogramCentimeterCubs() => Value_ / secondperkilogramcentimetercub_.Factor;
		public static TimePerMassLengthCub FromSecondPerKilogramMillimeterCubs(double value, double minValue, double maxValue) => new TimePerMassLengthCub(value * secondperkilogrammillimetercub_.Factor, minValue * secondperkilogrammillimetercub_.Factor, maxValue * secondperkilogrammillimetercub_.Factor);
		public static TimePerMassLengthCub FromSecondPerKilogramMillimeterCubs(double value) => new TimePerMassLengthCub(value * secondperkilogrammillimetercub_.Factor);
		public double GetValueInSecondPerKilogramMillimeterCubs() => Value_ / secondperkilogrammillimetercub_.Factor;
		public static TimePerMassLengthCub FromSecondPerKilogramMeterCubs(double value, double minValue, double maxValue) => new TimePerMassLengthCub(value * secondperkilogrammetercub_.Factor, minValue * secondperkilogrammetercub_.Factor, maxValue * secondperkilogrammetercub_.Factor);
		public static TimePerMassLengthCub FromSecondPerKilogramMeterCubs(double value) => new TimePerMassLengthCub(value * secondperkilogrammetercub_.Factor);
		public double GetValueInSecondPerKilogramMeterCubs() => Value_ / secondperkilogrammetercub_.Factor;
		public static TimePerMassLengthCub FromSecondPerKilogramInchCubs(double value, double minValue, double maxValue) => new TimePerMassLengthCub(value * secondperkilograminchcub_.Factor, minValue * secondperkilograminchcub_.Factor, maxValue * secondperkilograminchcub_.Factor);
		public static TimePerMassLengthCub FromSecondPerKilogramInchCubs(double value) => new TimePerMassLengthCub(value * secondperkilograminchcub_.Factor);
		public double GetValueInSecondPerKilogramInchCubs() => Value_ / secondperkilograminchcub_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimePerMassLengthCub timepermasslengthcub, bool throwOnFail=true)
    {
        bool fail = false;
        if (timepermasslengthcub.HasMinValue && timepermasslengthcub.Value_ < timepermasslengthcub.MinValue)
        {
            fail = true;
        }

        if (timepermasslengthcub.HasMaxValue && timepermasslengthcub.Value_ > timepermasslengthcub.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimePerMassLengthCub is outside its bounds.");
        }
        else if (fail)
        {
            return false;
