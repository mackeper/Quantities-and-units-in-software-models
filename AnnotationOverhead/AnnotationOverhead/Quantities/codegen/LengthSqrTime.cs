...
#region units
	private static Unit_ centimetersqrsecond_ = new Unit_("CentimeterSqrSecond", "cm� s", 1);
	private static Unit_ millimetersqrsecond_ = new Unit_("MillimeterSqrSecond", "mm� s", 0.010000000000000002);
	private static Unit_ metersqrsecond_ = new Unit_("MeterSqrSecond", "m� s", 10000);
	private static Unit_ inchsqrsecond_ = new Unit_("InchSqrSecond", "in� s", 6.5536);
...
#region comparisons
    ...
    public bool Equals(LengthSqrTime other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthSqrTime FromCentimeterSqrSeconds(double value, double minValue, double maxValue) => new LengthSqrTime(value * centimetersqrsecond_.Factor, minValue * centimetersqrsecond_.Factor, maxValue * centimetersqrsecond_.Factor);
		public static LengthSqrTime FromCentimeterSqrSeconds(double value) => new LengthSqrTime(value * centimetersqrsecond_.Factor);
		public double GetValueInCentimeterSqrSeconds() => Value_ / centimetersqrsecond_.Factor;
		public static LengthSqrTime FromMillimeterSqrSeconds(double value, double minValue, double maxValue) => new LengthSqrTime(value * millimetersqrsecond_.Factor, minValue * millimetersqrsecond_.Factor, maxValue * millimetersqrsecond_.Factor);
		public static LengthSqrTime FromMillimeterSqrSeconds(double value) => new LengthSqrTime(value * millimetersqrsecond_.Factor);
		public double GetValueInMillimeterSqrSeconds() => Value_ / millimetersqrsecond_.Factor;
		public static LengthSqrTime FromMeterSqrSeconds(double value, double minValue, double maxValue) => new LengthSqrTime(value * metersqrsecond_.Factor, minValue * metersqrsecond_.Factor, maxValue * metersqrsecond_.Factor);
		public static LengthSqrTime FromMeterSqrSeconds(double value) => new LengthSqrTime(value * metersqrsecond_.Factor);
		public double GetValueInMeterSqrSeconds() => Value_ / metersqrsecond_.Factor;
		public static LengthSqrTime FromInchSqrSeconds(double value, double minValue, double maxValue) => new LengthSqrTime(value * inchsqrsecond_.Factor, minValue * inchsqrsecond_.Factor, maxValue * inchsqrsecond_.Factor);
		public static LengthSqrTime FromInchSqrSeconds(double value) => new LengthSqrTime(value * inchsqrsecond_.Factor);
		public double GetValueInInchSqrSeconds() => Value_ / inchsqrsecond_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthSqrTime lengthsqrtime, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthsqrtime.HasMinValue && lengthsqrtime.Value_ < lengthsqrtime.MinValue)
        {
            fail = true;
        }

        if (lengthsqrtime.HasMaxValue && lengthsqrtime.Value_ > lengthsqrtime.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthSqrTime is outside its bounds.");
        }
        else if (fail)
        {
            return false;
