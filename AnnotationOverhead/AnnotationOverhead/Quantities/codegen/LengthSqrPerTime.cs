...
#region units
	private static Unit_ centimetersqrpersecond_ = new Unit_("CentimeterSqrPerSecond", "cm²/s", 1.0);
	private static Unit_ millimetersqrpersecond_ = new Unit_("MillimeterSqrPerSecond", "mm²/s", 0.010000000000000002);
	private static Unit_ metersqrpersecond_ = new Unit_("MeterSqrPerSecond", "m²/s", 10000.0);
	private static Unit_ inchsqrpersecond_ = new Unit_("InchSqrPerSecond", "in²/s", 6.5536);
...
#region comparisons
    ...
    public bool Equals(LengthSqrPerTime other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthSqrPerTime FromCentimeterSqrPerSeconds(double value, double minValue, double maxValue) => new LengthSqrPerTime(value * centimetersqrpersecond_.Factor, minValue * centimetersqrpersecond_.Factor, maxValue * centimetersqrpersecond_.Factor);
		public static LengthSqrPerTime FromCentimeterSqrPerSeconds(double value) => new LengthSqrPerTime(value * centimetersqrpersecond_.Factor);
		public double GetValueInCentimeterSqrPerSeconds() => Value_ / centimetersqrpersecond_.Factor;
		public static LengthSqrPerTime FromMillimeterSqrPerSeconds(double value, double minValue, double maxValue) => new LengthSqrPerTime(value * millimetersqrpersecond_.Factor, minValue * millimetersqrpersecond_.Factor, maxValue * millimetersqrpersecond_.Factor);
		public static LengthSqrPerTime FromMillimeterSqrPerSeconds(double value) => new LengthSqrPerTime(value * millimetersqrpersecond_.Factor);
		public double GetValueInMillimeterSqrPerSeconds() => Value_ / millimetersqrpersecond_.Factor;
		public static LengthSqrPerTime FromMeterSqrPerSeconds(double value, double minValue, double maxValue) => new LengthSqrPerTime(value * metersqrpersecond_.Factor, minValue * metersqrpersecond_.Factor, maxValue * metersqrpersecond_.Factor);
		public static LengthSqrPerTime FromMeterSqrPerSeconds(double value) => new LengthSqrPerTime(value * metersqrpersecond_.Factor);
		public double GetValueInMeterSqrPerSeconds() => Value_ / metersqrpersecond_.Factor;
		public static LengthSqrPerTime FromInchSqrPerSeconds(double value, double minValue, double maxValue) => new LengthSqrPerTime(value * inchsqrpersecond_.Factor, minValue * inchsqrpersecond_.Factor, maxValue * inchsqrpersecond_.Factor);
		public static LengthSqrPerTime FromInchSqrPerSeconds(double value) => new LengthSqrPerTime(value * inchsqrpersecond_.Factor);
		public double GetValueInInchSqrPerSeconds() => Value_ / inchsqrpersecond_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthSqrPerTime lengthsqrpertime, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthsqrpertime.HasMinValue && lengthsqrpertime.Value_ < lengthsqrpertime.MinValue)
        {
            fail = true;
        }

        if (lengthsqrpertime.HasMaxValue && lengthsqrpertime.Value_ > lengthsqrpertime.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthSqrPerTime is outside its bounds.");
        }
        else if (fail)
        {
            return false;
