...
#region units
	private static Unit_ centimetersqrkilogrampersecondsqr_ = new Unit_("CentimeterSqrKilogramPerSecondSqr", "cm² kg/s²", 1.0);
	private static Unit_ millimetersqrkilogrampersecondsqr_ = new Unit_("MillimeterSqrKilogramPerSecondSqr", "mm² kg/s²", 0.010000000000000002);
	private static Unit_ metersqrkilogrampersecondsqr_ = new Unit_("MeterSqrKilogramPerSecondSqr", "m² kg/s²", 10000.0);
	private static Unit_ inchsqrkilogrampersecondsqr_ = new Unit_("InchSqrKilogramPerSecondSqr", "in² kg/s²", 6.5536);
...
#region comparisons
    ...
    public bool Equals(LengthSqrMassPerTimeSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthSqrMassPerTimeSqr FromCentimeterSqrKilogramPerSecondSqrs(double value, double minValue, double maxValue) => new LengthSqrMassPerTimeSqr(value * centimetersqrkilogrampersecondsqr_.Factor, minValue * centimetersqrkilogrampersecondsqr_.Factor, maxValue * centimetersqrkilogrampersecondsqr_.Factor);
		public static LengthSqrMassPerTimeSqr FromCentimeterSqrKilogramPerSecondSqrs(double value) => new LengthSqrMassPerTimeSqr(value * centimetersqrkilogrampersecondsqr_.Factor);
		public double GetValueInCentimeterSqrKilogramPerSecondSqrs() => Value_ / centimetersqrkilogrampersecondsqr_.Factor;
		public static LengthSqrMassPerTimeSqr FromMillimeterSqrKilogramPerSecondSqrs(double value, double minValue, double maxValue) => new LengthSqrMassPerTimeSqr(value * millimetersqrkilogrampersecondsqr_.Factor, minValue * millimetersqrkilogrampersecondsqr_.Factor, maxValue * millimetersqrkilogrampersecondsqr_.Factor);
		public static LengthSqrMassPerTimeSqr FromMillimeterSqrKilogramPerSecondSqrs(double value) => new LengthSqrMassPerTimeSqr(value * millimetersqrkilogrampersecondsqr_.Factor);
		public double GetValueInMillimeterSqrKilogramPerSecondSqrs() => Value_ / millimetersqrkilogrampersecondsqr_.Factor;
		public static LengthSqrMassPerTimeSqr FromMeterSqrKilogramPerSecondSqrs(double value, double minValue, double maxValue) => new LengthSqrMassPerTimeSqr(value * metersqrkilogrampersecondsqr_.Factor, minValue * metersqrkilogrampersecondsqr_.Factor, maxValue * metersqrkilogrampersecondsqr_.Factor);
		public static LengthSqrMassPerTimeSqr FromMeterSqrKilogramPerSecondSqrs(double value) => new LengthSqrMassPerTimeSqr(value * metersqrkilogrampersecondsqr_.Factor);
		public double GetValueInMeterSqrKilogramPerSecondSqrs() => Value_ / metersqrkilogrampersecondsqr_.Factor;
		public static LengthSqrMassPerTimeSqr FromInchSqrKilogramPerSecondSqrs(double value, double minValue, double maxValue) => new LengthSqrMassPerTimeSqr(value * inchsqrkilogrampersecondsqr_.Factor, minValue * inchsqrkilogrampersecondsqr_.Factor, maxValue * inchsqrkilogrampersecondsqr_.Factor);
		public static LengthSqrMassPerTimeSqr FromInchSqrKilogramPerSecondSqrs(double value) => new LengthSqrMassPerTimeSqr(value * inchsqrkilogrampersecondsqr_.Factor);
		public double GetValueInInchSqrKilogramPerSecondSqrs() => Value_ / inchsqrkilogrampersecondsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthSqrMassPerTimeSqr lengthsqrmasspertimesqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthsqrmasspertimesqr.HasMinValue && lengthsqrmasspertimesqr.Value_ < lengthsqrmasspertimesqr.MinValue)
        {
            fail = true;
        }

        if (lengthsqrmasspertimesqr.HasMaxValue && lengthsqrmasspertimesqr.Value_ > lengthsqrmasspertimesqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthSqrMassPerTimeSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
