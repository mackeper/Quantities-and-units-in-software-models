...
#region units
	private static Unit_ centimetersqrpersecondcub_ = new Unit_("CentimeterSqrPerSecondCub", "cm²/s³", 1.0);
	private static Unit_ millimetersqrpersecondcub_ = new Unit_("MillimeterSqrPerSecondCub", "mm²/s³", 0.010000000000000002);
	private static Unit_ metersqrpersecondcub_ = new Unit_("MeterSqrPerSecondCub", "m²/s³", 10000.0);
	private static Unit_ inchsqrpersecondcub_ = new Unit_("InchSqrPerSecondCub", "in²/s³", 6.5536);
...
#region comparisons
    ...
    public bool Equals(LengthSqrPerTimeCub other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthSqrPerTimeCub FromCentimeterSqrPerSecondCubs(double value, double minValue, double maxValue) => new LengthSqrPerTimeCub(value * centimetersqrpersecondcub_.Factor, minValue * centimetersqrpersecondcub_.Factor, maxValue * centimetersqrpersecondcub_.Factor);
		public static LengthSqrPerTimeCub FromCentimeterSqrPerSecondCubs(double value) => new LengthSqrPerTimeCub(value * centimetersqrpersecondcub_.Factor);
		public double GetValueInCentimeterSqrPerSecondCubs() => Value_ / centimetersqrpersecondcub_.Factor;
		public static LengthSqrPerTimeCub FromMillimeterSqrPerSecondCubs(double value, double minValue, double maxValue) => new LengthSqrPerTimeCub(value * millimetersqrpersecondcub_.Factor, minValue * millimetersqrpersecondcub_.Factor, maxValue * millimetersqrpersecondcub_.Factor);
		public static LengthSqrPerTimeCub FromMillimeterSqrPerSecondCubs(double value) => new LengthSqrPerTimeCub(value * millimetersqrpersecondcub_.Factor);
		public double GetValueInMillimeterSqrPerSecondCubs() => Value_ / millimetersqrpersecondcub_.Factor;
		public static LengthSqrPerTimeCub FromMeterSqrPerSecondCubs(double value, double minValue, double maxValue) => new LengthSqrPerTimeCub(value * metersqrpersecondcub_.Factor, minValue * metersqrpersecondcub_.Factor, maxValue * metersqrpersecondcub_.Factor);
		public static LengthSqrPerTimeCub FromMeterSqrPerSecondCubs(double value) => new LengthSqrPerTimeCub(value * metersqrpersecondcub_.Factor);
		public double GetValueInMeterSqrPerSecondCubs() => Value_ / metersqrpersecondcub_.Factor;
		public static LengthSqrPerTimeCub FromInchSqrPerSecondCubs(double value, double minValue, double maxValue) => new LengthSqrPerTimeCub(value * inchsqrpersecondcub_.Factor, minValue * inchsqrpersecondcub_.Factor, maxValue * inchsqrpersecondcub_.Factor);
		public static LengthSqrPerTimeCub FromInchSqrPerSecondCubs(double value) => new LengthSqrPerTimeCub(value * inchsqrpersecondcub_.Factor);
		public double GetValueInInchSqrPerSecondCubs() => Value_ / inchsqrpersecondcub_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthSqrPerTimeCub lengthsqrpertimecub, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthsqrpertimecub.HasMinValue && lengthsqrpertimecub.Value_ < lengthsqrpertimecub.MinValue)
        {
            fail = true;
        }

        if (lengthsqrpertimecub.HasMaxValue && lengthsqrpertimecub.Value_ > lengthsqrpertimecub.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthSqrPerTimeCub is outside its bounds.");
        }
        else if (fail)
        {
            return false;
