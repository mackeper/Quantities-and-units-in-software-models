...
#region units
	private static Unit_ kilogrampercentimetersqrsecondsqr_ = new Unit_("KilogramPerCentimeterSqrSecondSqr", "kg/cm² s²", 1.0);
	private static Unit_ kilogrampermillimetersqrsecondsqr_ = new Unit_("KilogramPerMillimeterSqrSecondSqr", "kg/mm² s²", 99.99999999999999);
	private static Unit_ kilogrampermetersqrsecondsqr_ = new Unit_("KilogramPerMeterSqrSecondSqr", "kg/m² s²", 0.0001);
	private static Unit_ kilogramperinchsqrsecondsqr_ = new Unit_("KilogramPerInchSqrSecondSqr", "kg/in² s²", 0.152587890625);
...
#region comparisons
    ...
    public bool Equals(MassPerLengthSqrTimeSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static MassPerLengthSqrTimeSqr FromKilogramPerCentimeterSqrSecondSqrs(double value, double minValue, double maxValue) => new MassPerLengthSqrTimeSqr(value * kilogrampercentimetersqrsecondsqr_.Factor, minValue * kilogrampercentimetersqrsecondsqr_.Factor, maxValue * kilogrampercentimetersqrsecondsqr_.Factor);
		public static MassPerLengthSqrTimeSqr FromKilogramPerCentimeterSqrSecondSqrs(double value) => new MassPerLengthSqrTimeSqr(value * kilogrampercentimetersqrsecondsqr_.Factor);
		public double GetValueInKilogramPerCentimeterSqrSecondSqrs() => Value_ / kilogrampercentimetersqrsecondsqr_.Factor;
		public static MassPerLengthSqrTimeSqr FromKilogramPerMillimeterSqrSecondSqrs(double value, double minValue, double maxValue) => new MassPerLengthSqrTimeSqr(value * kilogrampermillimetersqrsecondsqr_.Factor, minValue * kilogrampermillimetersqrsecondsqr_.Factor, maxValue * kilogrampermillimetersqrsecondsqr_.Factor);
		public static MassPerLengthSqrTimeSqr FromKilogramPerMillimeterSqrSecondSqrs(double value) => new MassPerLengthSqrTimeSqr(value * kilogrampermillimetersqrsecondsqr_.Factor);
		public double GetValueInKilogramPerMillimeterSqrSecondSqrs() => Value_ / kilogrampermillimetersqrsecondsqr_.Factor;
		public static MassPerLengthSqrTimeSqr FromKilogramPerMeterSqrSecondSqrs(double value, double minValue, double maxValue) => new MassPerLengthSqrTimeSqr(value * kilogrampermetersqrsecondsqr_.Factor, minValue * kilogrampermetersqrsecondsqr_.Factor, maxValue * kilogrampermetersqrsecondsqr_.Factor);
		public static MassPerLengthSqrTimeSqr FromKilogramPerMeterSqrSecondSqrs(double value) => new MassPerLengthSqrTimeSqr(value * kilogrampermetersqrsecondsqr_.Factor);
		public double GetValueInKilogramPerMeterSqrSecondSqrs() => Value_ / kilogrampermetersqrsecondsqr_.Factor;
		public static MassPerLengthSqrTimeSqr FromKilogramPerInchSqrSecondSqrs(double value, double minValue, double maxValue) => new MassPerLengthSqrTimeSqr(value * kilogramperinchsqrsecondsqr_.Factor, minValue * kilogramperinchsqrsecondsqr_.Factor, maxValue * kilogramperinchsqrsecondsqr_.Factor);
		public static MassPerLengthSqrTimeSqr FromKilogramPerInchSqrSecondSqrs(double value) => new MassPerLengthSqrTimeSqr(value * kilogramperinchsqrsecondsqr_.Factor);
		public double GetValueInKilogramPerInchSqrSecondSqrs() => Value_ / kilogramperinchsqrsecondsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(MassPerLengthSqrTimeSqr massperlengthsqrtimesqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (massperlengthsqrtimesqr.HasMinValue && massperlengthsqrtimesqr.Value_ < massperlengthsqrtimesqr.MinValue)
        {
            fail = true;
        }

        if (massperlengthsqrtimesqr.HasMaxValue && massperlengthsqrtimesqr.Value_ > massperlengthsqrtimesqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("MassPerLengthSqrTimeSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
