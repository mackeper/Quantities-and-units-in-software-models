...
namespace RaySearch.CorePlatform.Framework
{
    ...
    private static void ImportDisplayUnitFromDatabase_()
    {
        if (!displayUnitIsImported_ && FakeDatabase.Units.ContainsKey("PerLengthMass"))
        {
            ...
            {
				      case "percentimetercubkilogram": displayUnit_ = percentimetercubkilogram_; break;
				      case "permillimetercubkilogram": displayUnit_ = permillimetercubkilogram_; break;
				      case "permetercubkilogram": displayUnit_ = permetercubkilogram_; break;
				      case "perinchcubkilogram": displayUnit_ = perinchcubkilogram_; break;
...
#region units
	private static Unit_ percentimetercubkilogram_ = new Unit_("PerCentimeterCubKilogram", "/cm³ kg", 1.0);
	private static Unit_ permillimetercubkilogram_ = new Unit_("PerMillimeterCubKilogram", "/mm³ kg", 0.1);
	private static Unit_ permetercubkilogram_ = new Unit_("PerMeterCubKilogram", "/m³ kg", 100.0);
	private static Unit_ perinchcubkilogram_ = new Unit_("PerInchCubKilogram", "/in³ kg", 2.56);
	private static Unit_ platformUnit_ = percentimetercubkilogram_;
	private static Unit_ displayUnit_ = percentimetercubkilogram_;
#endregion
...
#region comparisons
    ...
    public bool Equals(PerLengthMass other) => other is object && Equals((object)other);
...
#region conversions
		public static PerLengthMass FromPerCentimeterCubKilograms(double value, double minValue, double maxValue) => new PerLengthMass(value * percentimetercubkilogram_.Factor, minValue * percentimetercubkilogram_.Factor, maxValue * percentimetercubkilogram_.Factor);
		public static PerLengthMass FromPerCentimeterCubKilograms(double value) => new PerLengthMass(value * percentimetercubkilogram_.Factor);
		public double GetValueInPerCentimeterCubKilograms() => Value_ / percentimetercubkilogram_.Factor;
		public static PerLengthMass FromPerMillimeterCubKilograms(double value, double minValue, double maxValue) => new PerLengthMass(value * permillimetercubkilogram_.Factor, minValue * permillimetercubkilogram_.Factor, maxValue * permillimetercubkilogram_.Factor);
		public static PerLengthMass FromPerMillimeterCubKilograms(double value) => new PerLengthMass(value * permillimetercubkilogram_.Factor);
		public double GetValueInPerMillimeterCubKilograms() => Value_ / permillimetercubkilogram_.Factor;
		public static PerLengthMass FromPerMeterCubKilograms(double value, double minValue, double maxValue) => new PerLengthMass(value * permetercubkilogram_.Factor, minValue * permetercubkilogram_.Factor, maxValue * permetercubkilogram_.Factor);
		public static PerLengthMass FromPerMeterCubKilograms(double value) => new PerLengthMass(value * permetercubkilogram_.Factor);
		public double GetValueInPerMeterCubKilograms() => Value_ / permetercubkilogram_.Factor;
		public static PerLengthMass FromPerInchCubKilograms(double value, double minValue, double maxValue) => new PerLengthMass(value * perinchcubkilogram_.Factor, minValue * perinchcubkilogram_.Factor, maxValue * perinchcubkilogram_.Factor);
		public static PerLengthMass FromPerInchCubKilograms(double value) => new PerLengthMass(value * perinchcubkilogram_.Factor);
		public double GetValueInPerInchCubKilograms() => Value_ / perinchcubkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(PerLengthMass perlengthmass, bool throwOnFail=true)
    {
        bool fail = false;
        if (perlengthmass.HasMinValue && perlengthmass.Value_ < perlengthmass.MinValue)
        {
            fail = true;
        }

        if (perlengthmass.HasMaxValue && perlengthmass.Value_ > perlengthmass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("PerLengthMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
