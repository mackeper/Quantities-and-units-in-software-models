...
#region units
	private static Unit_ percentimetersqrsecondsqr_ = new Unit_("PerCentimeterSqrSecondSqr", "/cm² s²", 1.0);
	private static Unit_ permillimetersqrsecondsqr_ = new Unit_("PerMillimeterSqrSecondSqr", "/mm² s²", 0.010000000000000002);
	private static Unit_ permetersqrsecondsqr_ = new Unit_("PerMeterSqrSecondSqr", "/m² s²", 10000.0);
	private static Unit_ perinchsqrsecondsqr_ = new Unit_("PerInchSqrSecondSqr", "/in² s²", 6.5536);
...
#region comparisons
    ...
    public bool Equals(PerLengthSqrTimeSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static PerLengthSqrTimeSqr FromPerCentimeterSqrSecondSqrs(double value, double minValue, double maxValue) => new PerLengthSqrTimeSqr(value * percentimetersqrsecondsqr_.Factor, minValue * percentimetersqrsecondsqr_.Factor, maxValue * percentimetersqrsecondsqr_.Factor);
		public static PerLengthSqrTimeSqr FromPerCentimeterSqrSecondSqrs(double value) => new PerLengthSqrTimeSqr(value * percentimetersqrsecondsqr_.Factor);
		public double GetValueInPerCentimeterSqrSecondSqrs() => Value_ / percentimetersqrsecondsqr_.Factor;
		public static PerLengthSqrTimeSqr FromPerMillimeterSqrSecondSqrs(double value, double minValue, double maxValue) => new PerLengthSqrTimeSqr(value * permillimetersqrsecondsqr_.Factor, minValue * permillimetersqrsecondsqr_.Factor, maxValue * permillimetersqrsecondsqr_.Factor);
		public static PerLengthSqrTimeSqr FromPerMillimeterSqrSecondSqrs(double value) => new PerLengthSqrTimeSqr(value * permillimetersqrsecondsqr_.Factor);
		public double GetValueInPerMillimeterSqrSecondSqrs() => Value_ / permillimetersqrsecondsqr_.Factor;
		public static PerLengthSqrTimeSqr FromPerMeterSqrSecondSqrs(double value, double minValue, double maxValue) => new PerLengthSqrTimeSqr(value * permetersqrsecondsqr_.Factor, minValue * permetersqrsecondsqr_.Factor, maxValue * permetersqrsecondsqr_.Factor);
		public static PerLengthSqrTimeSqr FromPerMeterSqrSecondSqrs(double value) => new PerLengthSqrTimeSqr(value * permetersqrsecondsqr_.Factor);
		public double GetValueInPerMeterSqrSecondSqrs() => Value_ / permetersqrsecondsqr_.Factor;
		public static PerLengthSqrTimeSqr FromPerInchSqrSecondSqrs(double value, double minValue, double maxValue) => new PerLengthSqrTimeSqr(value * perinchsqrsecondsqr_.Factor, minValue * perinchsqrsecondsqr_.Factor, maxValue * perinchsqrsecondsqr_.Factor);
		public static PerLengthSqrTimeSqr FromPerInchSqrSecondSqrs(double value) => new PerLengthSqrTimeSqr(value * perinchsqrsecondsqr_.Factor);
		public double GetValueInPerInchSqrSecondSqrs() => Value_ / perinchsqrsecondsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(PerLengthSqrTimeSqr perlengthsqrtimesqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (perlengthsqrtimesqr.HasMinValue && perlengthsqrtimesqr.Value_ < perlengthsqrtimesqr.MinValue)
        {
            fail = true;
        }

        if (perlengthsqrtimesqr.HasMaxValue && perlengthsqrtimesqr.Value_ > perlengthsqrtimesqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("PerLengthSqrTimeSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
