...
#region units
	private static Unit_ centimeterperkilogramsecond_ = new Unit_("CentimeterPerKilogramSecond", "cm/kg s", 1.0);
	private static Unit_ millimeterperkilogramsecond_ = new Unit_("MillimeterPerKilogramSecond", "mm/kg s", 0.1);
	private static Unit_ meterperkilogramsecond_ = new Unit_("MeterPerKilogramSecond", "m/kg s", 100.0);
	private static Unit_ inchperkilogramsecond_ = new Unit_("InchPerKilogramSecond", "in/kg s", 2.56);
...
#region comparisons
    ...
    public bool Equals(LengthPerMassTime other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthPerMassTime FromCentimeterPerKilogramSeconds(double value, double minValue, double maxValue) => new LengthPerMassTime(value * centimeterperkilogramsecond_.Factor, minValue * centimeterperkilogramsecond_.Factor, maxValue * centimeterperkilogramsecond_.Factor);
		public static LengthPerMassTime FromCentimeterPerKilogramSeconds(double value) => new LengthPerMassTime(value * centimeterperkilogramsecond_.Factor);
		public double GetValueInCentimeterPerKilogramSeconds() => Value_ / centimeterperkilogramsecond_.Factor;
		public static LengthPerMassTime FromMillimeterPerKilogramSeconds(double value, double minValue, double maxValue) => new LengthPerMassTime(value * millimeterperkilogramsecond_.Factor, minValue * millimeterperkilogramsecond_.Factor, maxValue * millimeterperkilogramsecond_.Factor);
		public static LengthPerMassTime FromMillimeterPerKilogramSeconds(double value) => new LengthPerMassTime(value * millimeterperkilogramsecond_.Factor);
		public double GetValueInMillimeterPerKilogramSeconds() => Value_ / millimeterperkilogramsecond_.Factor;
		public static LengthPerMassTime FromMeterPerKilogramSeconds(double value, double minValue, double maxValue) => new LengthPerMassTime(value * meterperkilogramsecond_.Factor, minValue * meterperkilogramsecond_.Factor, maxValue * meterperkilogramsecond_.Factor);
		public static LengthPerMassTime FromMeterPerKilogramSeconds(double value) => new LengthPerMassTime(value * meterperkilogramsecond_.Factor);
		public double GetValueInMeterPerKilogramSeconds() => Value_ / meterperkilogramsecond_.Factor;
		public static LengthPerMassTime FromInchPerKilogramSeconds(double value, double minValue, double maxValue) => new LengthPerMassTime(value * inchperkilogramsecond_.Factor, minValue * inchperkilogramsecond_.Factor, maxValue * inchperkilogramsecond_.Factor);
		public static LengthPerMassTime FromInchPerKilogramSeconds(double value) => new LengthPerMassTime(value * inchperkilogramsecond_.Factor);
		public double GetValueInInchPerKilogramSeconds() => Value_ / inchperkilogramsecond_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthPerMassTime lengthpermasstime, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthpermasstime.HasMinValue && lengthpermasstime.Value_ < lengthpermasstime.MinValue)
        {
            fail = true;
        }

        if (lengthpermasstime.HasMaxValue && lengthpermasstime.Value_ > lengthpermasstime.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthPerMassTime is outside its bounds.");
        }
        else if (fail)
        {
            return false;
