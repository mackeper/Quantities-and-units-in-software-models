...
#region units
	private static Unit_ centimetercubperkilogramsecond_ = new Unit_("CentimeterCubPerKilogramSecond", "cm³/kg s", 1.0);
	private static Unit_ millimetercubperkilogramsecond_ = new Unit_("MillimeterCubPerKilogramSecond", "mm³/kg s", 0.0010000000000000002);
	private static Unit_ metercubperkilogramsecond_ = new Unit_("MeterCubPerKilogramSecond", "m³/kg s", 1000000.0);
	private static Unit_ inchcubperkilogramsecond_ = new Unit_("InchCubPerKilogramSecond", "in³/kg s", 16.777216000000003);
...
#region comparisons
    ...
    public bool Equals(LengthCubPerMassTime other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthCubPerMassTime FromCentimeterCubPerKilogramSeconds(double value, double minValue, double maxValue) => new LengthCubPerMassTime(value * centimetercubperkilogramsecond_.Factor, minValue * centimetercubperkilogramsecond_.Factor, maxValue * centimetercubperkilogramsecond_.Factor);
		public static LengthCubPerMassTime FromCentimeterCubPerKilogramSeconds(double value) => new LengthCubPerMassTime(value * centimetercubperkilogramsecond_.Factor);
		public double GetValueInCentimeterCubPerKilogramSeconds() => Value_ / centimetercubperkilogramsecond_.Factor;
		public static LengthCubPerMassTime FromMillimeterCubPerKilogramSeconds(double value, double minValue, double maxValue) => new LengthCubPerMassTime(value * millimetercubperkilogramsecond_.Factor, minValue * millimetercubperkilogramsecond_.Factor, maxValue * millimetercubperkilogramsecond_.Factor);
		public static LengthCubPerMassTime FromMillimeterCubPerKilogramSeconds(double value) => new LengthCubPerMassTime(value * millimetercubperkilogramsecond_.Factor);
		public double GetValueInMillimeterCubPerKilogramSeconds() => Value_ / millimetercubperkilogramsecond_.Factor;
		public static LengthCubPerMassTime FromMeterCubPerKilogramSeconds(double value, double minValue, double maxValue) => new LengthCubPerMassTime(value * metercubperkilogramsecond_.Factor, minValue * metercubperkilogramsecond_.Factor, maxValue * metercubperkilogramsecond_.Factor);
		public static LengthCubPerMassTime FromMeterCubPerKilogramSeconds(double value) => new LengthCubPerMassTime(value * metercubperkilogramsecond_.Factor);
		public double GetValueInMeterCubPerKilogramSeconds() => Value_ / metercubperkilogramsecond_.Factor;
		public static LengthCubPerMassTime FromInchCubPerKilogramSeconds(double value, double minValue, double maxValue) => new LengthCubPerMassTime(value * inchcubperkilogramsecond_.Factor, minValue * inchcubperkilogramsecond_.Factor, maxValue * inchcubperkilogramsecond_.Factor);
		public static LengthCubPerMassTime FromInchCubPerKilogramSeconds(double value) => new LengthCubPerMassTime(value * inchcubperkilogramsecond_.Factor);
		public double GetValueInInchCubPerKilogramSeconds() => Value_ / inchcubperkilogramsecond_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthCubPerMassTime lengthcubpermasstime, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthcubpermasstime.HasMinValue && lengthcubpermasstime.Value_ < lengthcubpermasstime.MinValue)
        {
            fail = true;
        }

        if (lengthcubpermasstime.HasMaxValue && lengthcubpermasstime.Value_ > lengthcubpermasstime.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthCubPerMassTime is outside its bounds.");
        }
        else if (fail)
        {
            return false;
