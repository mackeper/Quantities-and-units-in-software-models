...
#region units
	private static Unit_ centimetersqrsecondsqrperkilogram_ = new Unit_("CentimeterSqrSecondSqrPerKilogram", "cm² s²/kg", 1.0);
	private static Unit_ millimetersqrsecondsqrperkilogram_ = new Unit_("MillimeterSqrSecondSqrPerKilogram", "mm² s²/kg", 0.010000000000000002);
	private static Unit_ metersqrsecondsqrperkilogram_ = new Unit_("MeterSqrSecondSqrPerKilogram", "m² s²/kg", 10000.0);
	private static Unit_ inchsqrsecondsqrperkilogram_ = new Unit_("InchSqrSecondSqrPerKilogram", "in² s²/kg", 6.5536);
...
#region comparisons
    ...
    public bool Equals(LengthSqrTimeSqrPerMass other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthSqrTimeSqrPerMass FromCentimeterSqrSecondSqrPerKilograms(double value, double minValue, double maxValue) => new LengthSqrTimeSqrPerMass(value * centimetersqrsecondsqrperkilogram_.Factor, minValue * centimetersqrsecondsqrperkilogram_.Factor, maxValue * centimetersqrsecondsqrperkilogram_.Factor);
		public static LengthSqrTimeSqrPerMass FromCentimeterSqrSecondSqrPerKilograms(double value) => new LengthSqrTimeSqrPerMass(value * centimetersqrsecondsqrperkilogram_.Factor);
		public double GetValueInCentimeterSqrSecondSqrPerKilograms() => Value_ / centimetersqrsecondsqrperkilogram_.Factor;
		public static LengthSqrTimeSqrPerMass FromMillimeterSqrSecondSqrPerKilograms(double value, double minValue, double maxValue) => new LengthSqrTimeSqrPerMass(value * millimetersqrsecondsqrperkilogram_.Factor, minValue * millimetersqrsecondsqrperkilogram_.Factor, maxValue * millimetersqrsecondsqrperkilogram_.Factor);
		public static LengthSqrTimeSqrPerMass FromMillimeterSqrSecondSqrPerKilograms(double value) => new LengthSqrTimeSqrPerMass(value * millimetersqrsecondsqrperkilogram_.Factor);
		public double GetValueInMillimeterSqrSecondSqrPerKilograms() => Value_ / millimetersqrsecondsqrperkilogram_.Factor;
		public static LengthSqrTimeSqrPerMass FromMeterSqrSecondSqrPerKilograms(double value, double minValue, double maxValue) => new LengthSqrTimeSqrPerMass(value * metersqrsecondsqrperkilogram_.Factor, minValue * metersqrsecondsqrperkilogram_.Factor, maxValue * metersqrsecondsqrperkilogram_.Factor);
		public static LengthSqrTimeSqrPerMass FromMeterSqrSecondSqrPerKilograms(double value) => new LengthSqrTimeSqrPerMass(value * metersqrsecondsqrperkilogram_.Factor);
		public double GetValueInMeterSqrSecondSqrPerKilograms() => Value_ / metersqrsecondsqrperkilogram_.Factor;
		public static LengthSqrTimeSqrPerMass FromInchSqrSecondSqrPerKilograms(double value, double minValue, double maxValue) => new LengthSqrTimeSqrPerMass(value * inchsqrsecondsqrperkilogram_.Factor, minValue * inchsqrsecondsqrperkilogram_.Factor, maxValue * inchsqrsecondsqrperkilogram_.Factor);
		public static LengthSqrTimeSqrPerMass FromInchSqrSecondSqrPerKilograms(double value) => new LengthSqrTimeSqrPerMass(value * inchsqrsecondsqrperkilogram_.Factor);
		public double GetValueInInchSqrSecondSqrPerKilograms() => Value_ / inchsqrsecondsqrperkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthSqrTimeSqrPerMass lengthsqrtimesqrpermass, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthsqrtimesqrpermass.HasMinValue && lengthsqrtimesqrpermass.Value_ < lengthsqrtimesqrpermass.MinValue)
        {
            fail = true;
        }

        if (lengthsqrtimesqrpermass.HasMaxValue && lengthsqrtimesqrpermass.Value_ > lengthsqrtimesqrpermass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthSqrTimeSqrPerMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
