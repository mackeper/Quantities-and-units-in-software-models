...
#region units
	private static Unit_ secondcubcentimeterperkilogram_ = new Unit_("SecondCubCentimeterPerKilogram", "s³ cm/kg", 1.0);
	private static Unit_ secondcubmillimeterperkilogram_ = new Unit_("SecondCubMillimeterPerKilogram", "s³ mm/kg", 0.1);
	private static Unit_ secondcubmeterperkilogram_ = new Unit_("SecondCubMeterPerKilogram", "s³ m/kg", 100.0);
	private static Unit_ secondcubinchperkilogram_ = new Unit_("SecondCubInchPerKilogram", "s³ in/kg", 2.56);
...
#region comparisons
    ...
    public bool Equals(TimeCubLengthPerMass other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeCubLengthPerMass FromSecondCubCentimeterPerKilograms(double value, double minValue, double maxValue) => new TimeCubLengthPerMass(value * secondcubcentimeterperkilogram_.Factor, minValue * secondcubcentimeterperkilogram_.Factor, maxValue * secondcubcentimeterperkilogram_.Factor);
		public static TimeCubLengthPerMass FromSecondCubCentimeterPerKilograms(double value) => new TimeCubLengthPerMass(value * secondcubcentimeterperkilogram_.Factor);
		public double GetValueInSecondCubCentimeterPerKilograms() => Value_ / secondcubcentimeterperkilogram_.Factor;
		public static TimeCubLengthPerMass FromSecondCubMillimeterPerKilograms(double value, double minValue, double maxValue) => new TimeCubLengthPerMass(value * secondcubmillimeterperkilogram_.Factor, minValue * secondcubmillimeterperkilogram_.Factor, maxValue * secondcubmillimeterperkilogram_.Factor);
		public static TimeCubLengthPerMass FromSecondCubMillimeterPerKilograms(double value) => new TimeCubLengthPerMass(value * secondcubmillimeterperkilogram_.Factor);
		public double GetValueInSecondCubMillimeterPerKilograms() => Value_ / secondcubmillimeterperkilogram_.Factor;
		public static TimeCubLengthPerMass FromSecondCubMeterPerKilograms(double value, double minValue, double maxValue) => new TimeCubLengthPerMass(value * secondcubmeterperkilogram_.Factor, minValue * secondcubmeterperkilogram_.Factor, maxValue * secondcubmeterperkilogram_.Factor);
		public static TimeCubLengthPerMass FromSecondCubMeterPerKilograms(double value) => new TimeCubLengthPerMass(value * secondcubmeterperkilogram_.Factor);
		public double GetValueInSecondCubMeterPerKilograms() => Value_ / secondcubmeterperkilogram_.Factor;
		public static TimeCubLengthPerMass FromSecondCubInchPerKilograms(double value, double minValue, double maxValue) => new TimeCubLengthPerMass(value * secondcubinchperkilogram_.Factor, minValue * secondcubinchperkilogram_.Factor, maxValue * secondcubinchperkilogram_.Factor);
		public static TimeCubLengthPerMass FromSecondCubInchPerKilograms(double value) => new TimeCubLengthPerMass(value * secondcubinchperkilogram_.Factor);
		public double GetValueInSecondCubInchPerKilograms() => Value_ / secondcubinchperkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeCubLengthPerMass timecublengthpermass, bool throwOnFail=true)
    {
        bool fail = false;
        if (timecublengthpermass.HasMinValue && timecublengthpermass.Value_ < timecublengthpermass.MinValue)
        {
            fail = true;
        }

        if (timecublengthpermass.HasMaxValue && timecublengthpermass.Value_ > timecublengthpermass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeCubLengthPerMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
