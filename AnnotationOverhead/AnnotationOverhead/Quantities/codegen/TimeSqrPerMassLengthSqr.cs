...
#region units
	private static Unit_ secondsqrperkilogramcentimetersqr_ = new Unit_("SecondSqrPerKilogramCentimeterSqr", "s²/kg cm²", 1.0);
	private static Unit_ secondsqrperkilogrammillimetersqr_ = new Unit_("SecondSqrPerKilogramMillimeterSqr", "s²/kg mm²", 99.99999999999999);
	private static Unit_ secondsqrperkilogrammetersqr_ = new Unit_("SecondSqrPerKilogramMeterSqr", "s²/kg m²", 0.0001);
	private static Unit_ secondsqrperkilograminchsqr_ = new Unit_("SecondSqrPerKilogramInchSqr", "s²/kg in²", 0.152587890625);
...
#region comparisons
    ...
    public bool Equals(TimeSqrPerMassLengthSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeSqrPerMassLengthSqr FromSecondSqrPerKilogramCentimeterSqrs(double value, double minValue, double maxValue) => new TimeSqrPerMassLengthSqr(value * secondsqrperkilogramcentimetersqr_.Factor, minValue * secondsqrperkilogramcentimetersqr_.Factor, maxValue * secondsqrperkilogramcentimetersqr_.Factor);
		public static TimeSqrPerMassLengthSqr FromSecondSqrPerKilogramCentimeterSqrs(double value) => new TimeSqrPerMassLengthSqr(value * secondsqrperkilogramcentimetersqr_.Factor);
		public double GetValueInSecondSqrPerKilogramCentimeterSqrs() => Value_ / secondsqrperkilogramcentimetersqr_.Factor;
		public static TimeSqrPerMassLengthSqr FromSecondSqrPerKilogramMillimeterSqrs(double value, double minValue, double maxValue) => new TimeSqrPerMassLengthSqr(value * secondsqrperkilogrammillimetersqr_.Factor, minValue * secondsqrperkilogrammillimetersqr_.Factor, maxValue * secondsqrperkilogrammillimetersqr_.Factor);
		public static TimeSqrPerMassLengthSqr FromSecondSqrPerKilogramMillimeterSqrs(double value) => new TimeSqrPerMassLengthSqr(value * secondsqrperkilogrammillimetersqr_.Factor);
		public double GetValueInSecondSqrPerKilogramMillimeterSqrs() => Value_ / secondsqrperkilogrammillimetersqr_.Factor;
		public static TimeSqrPerMassLengthSqr FromSecondSqrPerKilogramMeterSqrs(double value, double minValue, double maxValue) => new TimeSqrPerMassLengthSqr(value * secondsqrperkilogrammetersqr_.Factor, minValue * secondsqrperkilogrammetersqr_.Factor, maxValue * secondsqrperkilogrammetersqr_.Factor);
		public static TimeSqrPerMassLengthSqr FromSecondSqrPerKilogramMeterSqrs(double value) => new TimeSqrPerMassLengthSqr(value * secondsqrperkilogrammetersqr_.Factor);
		public double GetValueInSecondSqrPerKilogramMeterSqrs() => Value_ / secondsqrperkilogrammetersqr_.Factor;
		public static TimeSqrPerMassLengthSqr FromSecondSqrPerKilogramInchSqrs(double value, double minValue, double maxValue) => new TimeSqrPerMassLengthSqr(value * secondsqrperkilograminchsqr_.Factor, minValue * secondsqrperkilograminchsqr_.Factor, maxValue * secondsqrperkilograminchsqr_.Factor);
		public static TimeSqrPerMassLengthSqr FromSecondSqrPerKilogramInchSqrs(double value) => new TimeSqrPerMassLengthSqr(value * secondsqrperkilograminchsqr_.Factor);
		public double GetValueInSecondSqrPerKilogramInchSqrs() => Value_ / secondsqrperkilograminchsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeSqrPerMassLengthSqr timesqrpermasslengthsqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (timesqrpermasslengthsqr.HasMinValue && timesqrpermasslengthsqr.Value_ < timesqrpermasslengthsqr.MinValue)
        {
            fail = true;
        }

        if (timesqrpermasslengthsqr.HasMaxValue && timesqrpermasslengthsqr.Value_ > timesqrpermasslengthsqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeSqrPerMassLengthSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
