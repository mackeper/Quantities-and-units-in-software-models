...
#region units
	private static Unit_ centimetercubsecondsqr_ = new Unit_("CentimeterCubSecondSqr", "cm³ s²", 1);
	private static Unit_ millimetercubsecondsqr_ = new Unit_("MillimeterCubSecondSqr", "mm³ s²", 0.0010000000000000002);
	private static Unit_ metercubsecondsqr_ = new Unit_("MeterCubSecondSqr", "m³ s²", 1000000);
	private static Unit_ inchcubsecondsqr_ = new Unit_("InchCubSecondSqr", "in³ s²", 16.777216000000003);
...
#region comparisons
    ...
    public bool Equals(LengthCubTimeSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthCubTimeSqr FromCentimeterCubSecondSqrs(double value, double minValue, double maxValue) => new LengthCubTimeSqr(value * centimetercubsecondsqr_.Factor, minValue * centimetercubsecondsqr_.Factor, maxValue * centimetercubsecondsqr_.Factor);
		public static LengthCubTimeSqr FromCentimeterCubSecondSqrs(double value) => new LengthCubTimeSqr(value * centimetercubsecondsqr_.Factor);
		public double GetValueInCentimeterCubSecondSqrs() => Value_ / centimetercubsecondsqr_.Factor;
		public static LengthCubTimeSqr FromMillimeterCubSecondSqrs(double value, double minValue, double maxValue) => new LengthCubTimeSqr(value * millimetercubsecondsqr_.Factor, minValue * millimetercubsecondsqr_.Factor, maxValue * millimetercubsecondsqr_.Factor);
		public static LengthCubTimeSqr FromMillimeterCubSecondSqrs(double value) => new LengthCubTimeSqr(value * millimetercubsecondsqr_.Factor);
		public double GetValueInMillimeterCubSecondSqrs() => Value_ / millimetercubsecondsqr_.Factor;
		public static LengthCubTimeSqr FromMeterCubSecondSqrs(double value, double minValue, double maxValue) => new LengthCubTimeSqr(value * metercubsecondsqr_.Factor, minValue * metercubsecondsqr_.Factor, maxValue * metercubsecondsqr_.Factor);
		public static LengthCubTimeSqr FromMeterCubSecondSqrs(double value) => new LengthCubTimeSqr(value * metercubsecondsqr_.Factor);
		public double GetValueInMeterCubSecondSqrs() => Value_ / metercubsecondsqr_.Factor;
		public static LengthCubTimeSqr FromInchCubSecondSqrs(double value, double minValue, double maxValue) => new LengthCubTimeSqr(value * inchcubsecondsqr_.Factor, minValue * inchcubsecondsqr_.Factor, maxValue * inchcubsecondsqr_.Factor);
		public static LengthCubTimeSqr FromInchCubSecondSqrs(double value) => new LengthCubTimeSqr(value * inchcubsecondsqr_.Factor);
		public double GetValueInInchCubSecondSqrs() => Value_ / inchcubsecondsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthCubTimeSqr lengthcubtimesqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthcubtimesqr.HasMinValue && lengthcubtimesqr.Value_ < lengthcubtimesqr.MinValue)
        {
            fail = true;
        }

        if (lengthcubtimesqr.HasMaxValue && lengthcubtimesqr.Value_ > lengthcubtimesqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthCubTimeSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
