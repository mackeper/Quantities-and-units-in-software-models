...
#region units
	private static Unit_ secondsqrpercentimeter_ = new Unit_("SecondSqrPerCentimeter", "s²/cm", 1.0);
	private static Unit_ secondsqrpermillimeter_ = new Unit_("SecondSqrPerMillimeter", "s²/mm", 10.0);
	private static Unit_ secondsqrpermeter_ = new Unit_("SecondSqrPerMeter", "s²/m", 0.01);
	private static Unit_ secondsqrperinch_ = new Unit_("SecondSqrPerInch", "s²/in", 0.390625);
...
#region comparisons
    ...
    public bool Equals(TimeSqrPerLength other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeSqrPerLength FromSecondSqrPerCentimeters(double value, double minValue, double maxValue) => new TimeSqrPerLength(value * secondsqrpercentimeter_.Factor, minValue * secondsqrpercentimeter_.Factor, maxValue * secondsqrpercentimeter_.Factor);
		public static TimeSqrPerLength FromSecondSqrPerCentimeters(double value) => new TimeSqrPerLength(value * secondsqrpercentimeter_.Factor);
		public double GetValueInSecondSqrPerCentimeters() => Value_ / secondsqrpercentimeter_.Factor;
		public static TimeSqrPerLength FromSecondSqrPerMillimeters(double value, double minValue, double maxValue) => new TimeSqrPerLength(value * secondsqrpermillimeter_.Factor, minValue * secondsqrpermillimeter_.Factor, maxValue * secondsqrpermillimeter_.Factor);
		public static TimeSqrPerLength FromSecondSqrPerMillimeters(double value) => new TimeSqrPerLength(value * secondsqrpermillimeter_.Factor);
		public double GetValueInSecondSqrPerMillimeters() => Value_ / secondsqrpermillimeter_.Factor;
		public static TimeSqrPerLength FromSecondSqrPerMeters(double value, double minValue, double maxValue) => new TimeSqrPerLength(value * secondsqrpermeter_.Factor, minValue * secondsqrpermeter_.Factor, maxValue * secondsqrpermeter_.Factor);
		public static TimeSqrPerLength FromSecondSqrPerMeters(double value) => new TimeSqrPerLength(value * secondsqrpermeter_.Factor);
		public double GetValueInSecondSqrPerMeters() => Value_ / secondsqrpermeter_.Factor;
		public static TimeSqrPerLength FromSecondSqrPerInchs(double value, double minValue, double maxValue) => new TimeSqrPerLength(value * secondsqrperinch_.Factor, minValue * secondsqrperinch_.Factor, maxValue * secondsqrperinch_.Factor);
		public static TimeSqrPerLength FromSecondSqrPerInchs(double value) => new TimeSqrPerLength(value * secondsqrperinch_.Factor);
		public double GetValueInSecondSqrPerInchs() => Value_ / secondsqrperinch_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeSqrPerLength timesqrperlength, bool throwOnFail=true)
    {
        bool fail = false;
        if (timesqrperlength.HasMinValue && timesqrperlength.Value_ < timesqrperlength.MinValue)
        {
            fail = true;
        }

        if (timesqrperlength.HasMaxValue && timesqrperlength.Value_ > timesqrperlength.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeSqrPerLength is outside its bounds.");
        }
        else if (fail)
        {
            return false;
