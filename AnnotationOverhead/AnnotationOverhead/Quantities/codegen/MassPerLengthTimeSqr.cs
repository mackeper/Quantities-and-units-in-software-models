...
#region units
	private static Unit_ kilogrampercentimetersecondsqr_ = new Unit_("KilogramPerCentimeterSecondSqr", "kg/cm s²", 1.0);
	private static Unit_ kilogrampermillimetersecondsqr_ = new Unit_("KilogramPerMillimeterSecondSqr", "kg/mm s²", 10.0);
	private static Unit_ kilogrampermetersecondsqr_ = new Unit_("KilogramPerMeterSecondSqr", "kg/m s²", 0.01);
	private static Unit_ kilogramperinchsecondsqr_ = new Unit_("KilogramPerInchSecondSqr", "kg/in s²", 0.390625);
...
#region comparisons
    ...
    public bool Equals(MassPerLengthTimeSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static MassPerLengthTimeSqr FromKilogramPerCentimeterSecondSqrs(double value, double minValue, double maxValue) => new MassPerLengthTimeSqr(value * kilogrampercentimetersecondsqr_.Factor, minValue * kilogrampercentimetersecondsqr_.Factor, maxValue * kilogrampercentimetersecondsqr_.Factor);
		public static MassPerLengthTimeSqr FromKilogramPerCentimeterSecondSqrs(double value) => new MassPerLengthTimeSqr(value * kilogrampercentimetersecondsqr_.Factor);
		public double GetValueInKilogramPerCentimeterSecondSqrs() => Value_ / kilogrampercentimetersecondsqr_.Factor;
		public static MassPerLengthTimeSqr FromKilogramPerMillimeterSecondSqrs(double value, double minValue, double maxValue) => new MassPerLengthTimeSqr(value * kilogrampermillimetersecondsqr_.Factor, minValue * kilogrampermillimetersecondsqr_.Factor, maxValue * kilogrampermillimetersecondsqr_.Factor);
		public static MassPerLengthTimeSqr FromKilogramPerMillimeterSecondSqrs(double value) => new MassPerLengthTimeSqr(value * kilogrampermillimetersecondsqr_.Factor);
		public double GetValueInKilogramPerMillimeterSecondSqrs() => Value_ / kilogrampermillimetersecondsqr_.Factor;
		public static MassPerLengthTimeSqr FromKilogramPerMeterSecondSqrs(double value, double minValue, double maxValue) => new MassPerLengthTimeSqr(value * kilogrampermetersecondsqr_.Factor, minValue * kilogrampermetersecondsqr_.Factor, maxValue * kilogrampermetersecondsqr_.Factor);
		public static MassPerLengthTimeSqr FromKilogramPerMeterSecondSqrs(double value) => new MassPerLengthTimeSqr(value * kilogrampermetersecondsqr_.Factor);
		public double GetValueInKilogramPerMeterSecondSqrs() => Value_ / kilogrampermetersecondsqr_.Factor;
		public static MassPerLengthTimeSqr FromKilogramPerInchSecondSqrs(double value, double minValue, double maxValue) => new MassPerLengthTimeSqr(value * kilogramperinchsecondsqr_.Factor, minValue * kilogramperinchsecondsqr_.Factor, maxValue * kilogramperinchsecondsqr_.Factor);
		public static MassPerLengthTimeSqr FromKilogramPerInchSecondSqrs(double value) => new MassPerLengthTimeSqr(value * kilogramperinchsecondsqr_.Factor);
		public double GetValueInKilogramPerInchSecondSqrs() => Value_ / kilogramperinchsecondsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(MassPerLengthTimeSqr massperlengthtimesqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (massperlengthtimesqr.HasMinValue && massperlengthtimesqr.Value_ < massperlengthtimesqr.MinValue)
        {
            fail = true;
        }

        if (massperlengthtimesqr.HasMaxValue && massperlengthtimesqr.Value_ > massperlengthtimesqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("MassPerLengthTimeSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
