...
#region units
	private static Unit_ secondsqrpercentimetercub_ = new Unit_("SecondSqrPerCentimeterCub", "s²/cm³", 1.0);
	private static Unit_ secondsqrpermillimetercub_ = new Unit_("SecondSqrPerMillimeterCub", "s²/mm³", 999.9999999999998);
	private static Unit_ secondsqrpermetercub_ = new Unit_("SecondSqrPerMeterCub", "s²/m³", 1e-06);
	private static Unit_ secondsqrperinchcub_ = new Unit_("SecondSqrPerInchCub", "s²/in³", 0.05960464477539062);
...
#region comparisons
    ...
    public bool Equals(TimeSqrPerLengthCub other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeSqrPerLengthCub FromSecondSqrPerCentimeterCubs(double value, double minValue, double maxValue) => new TimeSqrPerLengthCub(value * secondsqrpercentimetercub_.Factor, minValue * secondsqrpercentimetercub_.Factor, maxValue * secondsqrpercentimetercub_.Factor);
		public static TimeSqrPerLengthCub FromSecondSqrPerCentimeterCubs(double value) => new TimeSqrPerLengthCub(value * secondsqrpercentimetercub_.Factor);
		public double GetValueInSecondSqrPerCentimeterCubs() => Value_ / secondsqrpercentimetercub_.Factor;
		public static TimeSqrPerLengthCub FromSecondSqrPerMillimeterCubs(double value, double minValue, double maxValue) => new TimeSqrPerLengthCub(value * secondsqrpermillimetercub_.Factor, minValue * secondsqrpermillimetercub_.Factor, maxValue * secondsqrpermillimetercub_.Factor);
		public static TimeSqrPerLengthCub FromSecondSqrPerMillimeterCubs(double value) => new TimeSqrPerLengthCub(value * secondsqrpermillimetercub_.Factor);
		public double GetValueInSecondSqrPerMillimeterCubs() => Value_ / secondsqrpermillimetercub_.Factor;
		public static TimeSqrPerLengthCub FromSecondSqrPerMeterCubs(double value, double minValue, double maxValue) => new TimeSqrPerLengthCub(value * secondsqrpermetercub_.Factor, minValue * secondsqrpermetercub_.Factor, maxValue * secondsqrpermetercub_.Factor);
		public static TimeSqrPerLengthCub FromSecondSqrPerMeterCubs(double value) => new TimeSqrPerLengthCub(value * secondsqrpermetercub_.Factor);
		public double GetValueInSecondSqrPerMeterCubs() => Value_ / secondsqrpermetercub_.Factor;
		public static TimeSqrPerLengthCub FromSecondSqrPerInchCubs(double value, double minValue, double maxValue) => new TimeSqrPerLengthCub(value * secondsqrperinchcub_.Factor, minValue * secondsqrperinchcub_.Factor, maxValue * secondsqrperinchcub_.Factor);
		public static TimeSqrPerLengthCub FromSecondSqrPerInchCubs(double value) => new TimeSqrPerLengthCub(value * secondsqrperinchcub_.Factor);
		public double GetValueInSecondSqrPerInchCubs() => Value_ / secondsqrperinchcub_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeSqrPerLengthCub timesqrperlengthcub, bool throwOnFail=true)
    {
        bool fail = false;
        if (timesqrperlengthcub.HasMinValue && timesqrperlengthcub.Value_ < timesqrperlengthcub.MinValue)
        {
            fail = true;
        }

        if (timesqrperlengthcub.HasMaxValue && timesqrperlengthcub.Value_ > timesqrperlengthcub.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeSqrPerLengthCub is outside its bounds.");
        }
        else if (fail)
        {
            return false;
