...
#region units
	private static Unit_ centimeterperkilogramsecondcub_ = new Unit_("CentimeterPerKilogramSecondCub", "cm/kg s�", 1.0);
	private static Unit_ millimeterperkilogramsecondcub_ = new Unit_("MillimeterPerKilogramSecondCub", "mm/kg s�", 0.1);
	private static Unit_ meterperkilogramsecondcub_ = new Unit_("MeterPerKilogramSecondCub", "m/kg s�", 100.0);
	private static Unit_ inchperkilogramsecondcub_ = new Unit_("InchPerKilogramSecondCub", "in/kg s�", 2.56);
...
#region comparisons
    ...
    public bool Equals(LengthPerMassTimeCub other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthPerMassTimeCub FromCentimeterPerKilogramSecondCubs(double value, double minValue, double maxValue) => new LengthPerMassTimeCub(value * centimeterperkilogramsecondcub_.Factor, minValue * centimeterperkilogramsecondcub_.Factor, maxValue * centimeterperkilogramsecondcub_.Factor);
		public static LengthPerMassTimeCub FromCentimeterPerKilogramSecondCubs(double value) => new LengthPerMassTimeCub(value * centimeterperkilogramsecondcub_.Factor);
		public double GetValueInCentimeterPerKilogramSecondCubs() => Value_ / centimeterperkilogramsecondcub_.Factor;
		public static LengthPerMassTimeCub FromMillimeterPerKilogramSecondCubs(double value, double minValue, double maxValue) => new LengthPerMassTimeCub(value * millimeterperkilogramsecondcub_.Factor, minValue * millimeterperkilogramsecondcub_.Factor, maxValue * millimeterperkilogramsecondcub_.Factor);
		public static LengthPerMassTimeCub FromMillimeterPerKilogramSecondCubs(double value) => new LengthPerMassTimeCub(value * millimeterperkilogramsecondcub_.Factor);
		public double GetValueInMillimeterPerKilogramSecondCubs() => Value_ / millimeterperkilogramsecondcub_.Factor;
		public static LengthPerMassTimeCub FromMeterPerKilogramSecondCubs(double value, double minValue, double maxValue) => new LengthPerMassTimeCub(value * meterperkilogramsecondcub_.Factor, minValue * meterperkilogramsecondcub_.Factor, maxValue * meterperkilogramsecondcub_.Factor);
		public static LengthPerMassTimeCub FromMeterPerKilogramSecondCubs(double value) => new LengthPerMassTimeCub(value * meterperkilogramsecondcub_.Factor);
		public double GetValueInMeterPerKilogramSecondCubs() => Value_ / meterperkilogramsecondcub_.Factor;
		public static LengthPerMassTimeCub FromInchPerKilogramSecondCubs(double value, double minValue, double maxValue) => new LengthPerMassTimeCub(value * inchperkilogramsecondcub_.Factor, minValue * inchperkilogramsecondcub_.Factor, maxValue * inchperkilogramsecondcub_.Factor);
		public static LengthPerMassTimeCub FromInchPerKilogramSecondCubs(double value) => new LengthPerMassTimeCub(value * inchperkilogramsecondcub_.Factor);
		public double GetValueInInchPerKilogramSecondCubs() => Value_ / inchperkilogramsecondcub_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthPerMassTimeCub lengthpermasstimecub, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthpermasstimecub.HasMinValue && lengthpermasstimecub.Value_ < lengthpermasstimecub.MinValue)
        {
            fail = true;
        }

        if (lengthpermasstimecub.HasMaxValue && lengthpermasstimecub.Value_ > lengthpermasstimecub.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthPerMassTimeCub is outside its bounds.");
        }
        else if (fail)
        {
            return false;
