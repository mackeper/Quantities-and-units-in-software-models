...
#region units
	private static Unit_ secondsqrcentimeter_ = new Unit_("SecondSqrCentimeter", "s� cm", 1);
	private static Unit_ secondsqrmillimeter_ = new Unit_("SecondSqrMillimeter", "s� mm", 0.1);
	private static Unit_ secondsqrmeter_ = new Unit_("SecondSqrMeter", "s� m", 100);
	private static Unit_ secondsqrinch_ = new Unit_("SecondSqrInch", "s� in", 2.56);
...
#region comparisons
    ...
    public bool Equals(TimeSqrLength other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeSqrLength FromSecondSqrCentimeters(double value, double minValue, double maxValue) => new TimeSqrLength(value * secondsqrcentimeter_.Factor, minValue * secondsqrcentimeter_.Factor, maxValue * secondsqrcentimeter_.Factor);
		public static TimeSqrLength FromSecondSqrCentimeters(double value) => new TimeSqrLength(value * secondsqrcentimeter_.Factor);
		public double GetValueInSecondSqrCentimeters() => Value_ / secondsqrcentimeter_.Factor;
		public static TimeSqrLength FromSecondSqrMillimeters(double value, double minValue, double maxValue) => new TimeSqrLength(value * secondsqrmillimeter_.Factor, minValue * secondsqrmillimeter_.Factor, maxValue * secondsqrmillimeter_.Factor);
		public static TimeSqrLength FromSecondSqrMillimeters(double value) => new TimeSqrLength(value * secondsqrmillimeter_.Factor);
		public double GetValueInSecondSqrMillimeters() => Value_ / secondsqrmillimeter_.Factor;
		public static TimeSqrLength FromSecondSqrMeters(double value, double minValue, double maxValue) => new TimeSqrLength(value * secondsqrmeter_.Factor, minValue * secondsqrmeter_.Factor, maxValue * secondsqrmeter_.Factor);
		public static TimeSqrLength FromSecondSqrMeters(double value) => new TimeSqrLength(value * secondsqrmeter_.Factor);
		public double GetValueInSecondSqrMeters() => Value_ / secondsqrmeter_.Factor;
		public static TimeSqrLength FromSecondSqrInchs(double value, double minValue, double maxValue) => new TimeSqrLength(value * secondsqrinch_.Factor, minValue * secondsqrinch_.Factor, maxValue * secondsqrinch_.Factor);
		public static TimeSqrLength FromSecondSqrInchs(double value) => new TimeSqrLength(value * secondsqrinch_.Factor);
		public double GetValueInSecondSqrInchs() => Value_ / secondsqrinch_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeSqrLength timesqrlength, bool throwOnFail=true)
    {
        bool fail = false;
        if (timesqrlength.HasMinValue && timesqrlength.Value_ < timesqrlength.MinValue)
        {
            fail = true;
        }

        if (timesqrlength.HasMaxValue && timesqrlength.Value_ > timesqrlength.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeSqrLength is outside its bounds.");
        }
        else if (fail)
        {
            return false;
