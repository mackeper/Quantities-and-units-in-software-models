...
#region units
	private static Unit_ centimeterkilogramsecond_ = new Unit_("CentimeterKilogramSecond", "cm kg s", 1);
	private static Unit_ millimeterkilogramsecond_ = new Unit_("MillimeterKilogramSecond", "mm kg s", 0.1);
	private static Unit_ meterkilogramsecond_ = new Unit_("MeterKilogramSecond", "m kg s", 100);
	private static Unit_ inchkilogramsecond_ = new Unit_("InchKilogramSecond", "in kg s", 2.56);
...
#region comparisons
    ...
    public bool Equals(LengthMassTime other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthMassTime FromCentimeterKilogramSeconds(double value, double minValue, double maxValue) => new LengthMassTime(value * centimeterkilogramsecond_.Factor, minValue * centimeterkilogramsecond_.Factor, maxValue * centimeterkilogramsecond_.Factor);
		public static LengthMassTime FromCentimeterKilogramSeconds(double value) => new LengthMassTime(value * centimeterkilogramsecond_.Factor);
		public double GetValueInCentimeterKilogramSeconds() => Value_ / centimeterkilogramsecond_.Factor;
		public static LengthMassTime FromMillimeterKilogramSeconds(double value, double minValue, double maxValue) => new LengthMassTime(value * millimeterkilogramsecond_.Factor, minValue * millimeterkilogramsecond_.Factor, maxValue * millimeterkilogramsecond_.Factor);
		public static LengthMassTime FromMillimeterKilogramSeconds(double value) => new LengthMassTime(value * millimeterkilogramsecond_.Factor);
		public double GetValueInMillimeterKilogramSeconds() => Value_ / millimeterkilogramsecond_.Factor;
		public static LengthMassTime FromMeterKilogramSeconds(double value, double minValue, double maxValue) => new LengthMassTime(value * meterkilogramsecond_.Factor, minValue * meterkilogramsecond_.Factor, maxValue * meterkilogramsecond_.Factor);
		public static LengthMassTime FromMeterKilogramSeconds(double value) => new LengthMassTime(value * meterkilogramsecond_.Factor);
		public double GetValueInMeterKilogramSeconds() => Value_ / meterkilogramsecond_.Factor;
		public static LengthMassTime FromInchKilogramSeconds(double value, double minValue, double maxValue) => new LengthMassTime(value * inchkilogramsecond_.Factor, minValue * inchkilogramsecond_.Factor, maxValue * inchkilogramsecond_.Factor);
		public static LengthMassTime FromInchKilogramSeconds(double value) => new LengthMassTime(value * inchkilogramsecond_.Factor);
		public double GetValueInInchKilogramSeconds() => Value_ / inchkilogramsecond_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthMassTime lengthmasstime, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthmasstime.HasMinValue && lengthmasstime.Value_ < lengthmasstime.MinValue)
        {
            fail = true;
        }

        if (lengthmasstime.HasMaxValue && lengthmasstime.Value_ > lengthmasstime.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthMassTime is outside its bounds.");
        }
        else if (fail)
        {
            return false;
