...
#region units
	private static Unit_ secondcubkilogrampercentimeter_ = new Unit_("SecondCubKilogramPerCentimeter", "s³ kg/cm", 1.0);
	private static Unit_ secondcubkilogrampermillimeter_ = new Unit_("SecondCubKilogramPerMillimeter", "s³ kg/mm", 10.0);
	private static Unit_ secondcubkilogrampermeter_ = new Unit_("SecondCubKilogramPerMeter", "s³ kg/m", 0.01);
	private static Unit_ secondcubkilogramperinch_ = new Unit_("SecondCubKilogramPerInch", "s³ kg/in", 0.390625);
...
#region comparisons
    ...
    public bool Equals(TimeCubMassPerLength other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeCubMassPerLength FromSecondCubKilogramPerCentimeters(double value, double minValue, double maxValue) => new TimeCubMassPerLength(value * secondcubkilogrampercentimeter_.Factor, minValue * secondcubkilogrampercentimeter_.Factor, maxValue * secondcubkilogrampercentimeter_.Factor);
		public static TimeCubMassPerLength FromSecondCubKilogramPerCentimeters(double value) => new TimeCubMassPerLength(value * secondcubkilogrampercentimeter_.Factor);
		public double GetValueInSecondCubKilogramPerCentimeters() => Value_ / secondcubkilogrampercentimeter_.Factor;
		public static TimeCubMassPerLength FromSecondCubKilogramPerMillimeters(double value, double minValue, double maxValue) => new TimeCubMassPerLength(value * secondcubkilogrampermillimeter_.Factor, minValue * secondcubkilogrampermillimeter_.Factor, maxValue * secondcubkilogrampermillimeter_.Factor);
		public static TimeCubMassPerLength FromSecondCubKilogramPerMillimeters(double value) => new TimeCubMassPerLength(value * secondcubkilogrampermillimeter_.Factor);
		public double GetValueInSecondCubKilogramPerMillimeters() => Value_ / secondcubkilogrampermillimeter_.Factor;
		public static TimeCubMassPerLength FromSecondCubKilogramPerMeters(double value, double minValue, double maxValue) => new TimeCubMassPerLength(value * secondcubkilogrampermeter_.Factor, minValue * secondcubkilogrampermeter_.Factor, maxValue * secondcubkilogrampermeter_.Factor);
		public static TimeCubMassPerLength FromSecondCubKilogramPerMeters(double value) => new TimeCubMassPerLength(value * secondcubkilogrampermeter_.Factor);
		public double GetValueInSecondCubKilogramPerMeters() => Value_ / secondcubkilogrampermeter_.Factor;
		public static TimeCubMassPerLength FromSecondCubKilogramPerInchs(double value, double minValue, double maxValue) => new TimeCubMassPerLength(value * secondcubkilogramperinch_.Factor, minValue * secondcubkilogramperinch_.Factor, maxValue * secondcubkilogramperinch_.Factor);
		public static TimeCubMassPerLength FromSecondCubKilogramPerInchs(double value) => new TimeCubMassPerLength(value * secondcubkilogramperinch_.Factor);
		public double GetValueInSecondCubKilogramPerInchs() => Value_ / secondcubkilogramperinch_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeCubMassPerLength timecubmassperlength, bool throwOnFail=true)
    {
        bool fail = false;
        if (timecubmassperlength.HasMinValue && timecubmassperlength.Value_ < timecubmassperlength.MinValue)
        {
            fail = true;
        }

        if (timecubmassperlength.HasMaxValue && timecubmassperlength.Value_ > timecubmassperlength.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeCubMassPerLength is outside its bounds.");
        }
        else if (fail)
        {
            return false;
