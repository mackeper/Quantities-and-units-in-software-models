...
#region units
	private static Unit_ secondcubcentimeterkilogram_ = new Unit_("SecondCubCentimeterKilogram", "s³ cm kg", 1);
	private static Unit_ secondcubmillimeterkilogram_ = new Unit_("SecondCubMillimeterKilogram", "s³ mm kg", 0.1);
	private static Unit_ secondcubmeterkilogram_ = new Unit_("SecondCubMeterKilogram", "s³ m kg", 100);
	private static Unit_ secondcubinchkilogram_ = new Unit_("SecondCubInchKilogram", "s³ in kg", 2.56);
...
#region comparisons
    ...
    public bool Equals(TimeCubLengthMass other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeCubLengthMass FromSecondCubCentimeterKilograms(double value, double minValue, double maxValue) => new TimeCubLengthMass(value * secondcubcentimeterkilogram_.Factor, minValue * secondcubcentimeterkilogram_.Factor, maxValue * secondcubcentimeterkilogram_.Factor);
		public static TimeCubLengthMass FromSecondCubCentimeterKilograms(double value) => new TimeCubLengthMass(value * secondcubcentimeterkilogram_.Factor);
		public double GetValueInSecondCubCentimeterKilograms() => Value_ / secondcubcentimeterkilogram_.Factor;
		public static TimeCubLengthMass FromSecondCubMillimeterKilograms(double value, double minValue, double maxValue) => new TimeCubLengthMass(value * secondcubmillimeterkilogram_.Factor, minValue * secondcubmillimeterkilogram_.Factor, maxValue * secondcubmillimeterkilogram_.Factor);
		public static TimeCubLengthMass FromSecondCubMillimeterKilograms(double value) => new TimeCubLengthMass(value * secondcubmillimeterkilogram_.Factor);
		public double GetValueInSecondCubMillimeterKilograms() => Value_ / secondcubmillimeterkilogram_.Factor;
		public static TimeCubLengthMass FromSecondCubMeterKilograms(double value, double minValue, double maxValue) => new TimeCubLengthMass(value * secondcubmeterkilogram_.Factor, minValue * secondcubmeterkilogram_.Factor, maxValue * secondcubmeterkilogram_.Factor);
		public static TimeCubLengthMass FromSecondCubMeterKilograms(double value) => new TimeCubLengthMass(value * secondcubmeterkilogram_.Factor);
		public double GetValueInSecondCubMeterKilograms() => Value_ / secondcubmeterkilogram_.Factor;
		public static TimeCubLengthMass FromSecondCubInchKilograms(double value, double minValue, double maxValue) => new TimeCubLengthMass(value * secondcubinchkilogram_.Factor, minValue * secondcubinchkilogram_.Factor, maxValue * secondcubinchkilogram_.Factor);
		public static TimeCubLengthMass FromSecondCubInchKilograms(double value) => new TimeCubLengthMass(value * secondcubinchkilogram_.Factor);
		public double GetValueInSecondCubInchKilograms() => Value_ / secondcubinchkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeCubLengthMass timecublengthmass, bool throwOnFail=true)
    {
        bool fail = false;
        if (timecublengthmass.HasMinValue && timecublengthmass.Value_ < timecublengthmass.MinValue)
        {
            fail = true;
        }

        if (timecublengthmass.HasMaxValue && timecublengthmass.Value_ > timecublengthmass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeCubLengthMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
