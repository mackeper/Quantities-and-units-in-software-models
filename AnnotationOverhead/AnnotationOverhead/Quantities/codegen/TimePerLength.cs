...
#region units
	private static Unit_ secondpercentimeter_ = new Unit_("SecondPerCentimeter", "s/cm", 1.0);
	private static Unit_ secondpermillimeter_ = new Unit_("SecondPerMillimeter", "s/mm", 10.0);
	private static Unit_ secondpermeter_ = new Unit_("SecondPerMeter", "s/m", 0.01);
	private static Unit_ secondperinch_ = new Unit_("SecondPerInch", "s/in", 0.390625);
...
#region comparisons
    ...
    public bool Equals(TimePerLength other) => other is object && Equals((object)other);
...
#region conversions
		public static TimePerLength FromSecondPerCentimeters(double value, double minValue, double maxValue) => new TimePerLength(value * secondpercentimeter_.Factor, minValue * secondpercentimeter_.Factor, maxValue * secondpercentimeter_.Factor);
		public static TimePerLength FromSecondPerCentimeters(double value) => new TimePerLength(value * secondpercentimeter_.Factor);
		public double GetValueInSecondPerCentimeters() => Value_ / secondpercentimeter_.Factor;
		public static TimePerLength FromSecondPerMillimeters(double value, double minValue, double maxValue) => new TimePerLength(value * secondpermillimeter_.Factor, minValue * secondpermillimeter_.Factor, maxValue * secondpermillimeter_.Factor);
		public static TimePerLength FromSecondPerMillimeters(double value) => new TimePerLength(value * secondpermillimeter_.Factor);
		public double GetValueInSecondPerMillimeters() => Value_ / secondpermillimeter_.Factor;
		public static TimePerLength FromSecondPerMeters(double value, double minValue, double maxValue) => new TimePerLength(value * secondpermeter_.Factor, minValue * secondpermeter_.Factor, maxValue * secondpermeter_.Factor);
		public static TimePerLength FromSecondPerMeters(double value) => new TimePerLength(value * secondpermeter_.Factor);
		public double GetValueInSecondPerMeters() => Value_ / secondpermeter_.Factor;
		public static TimePerLength FromSecondPerInchs(double value, double minValue, double maxValue) => new TimePerLength(value * secondperinch_.Factor, minValue * secondperinch_.Factor, maxValue * secondperinch_.Factor);
		public static TimePerLength FromSecondPerInchs(double value) => new TimePerLength(value * secondperinch_.Factor);
		public double GetValueInSecondPerInchs() => Value_ / secondperinch_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimePerLength timeperlength, bool throwOnFail=true)
    {
        bool fail = false;
        if (timeperlength.HasMinValue && timeperlength.Value_ < timeperlength.MinValue)
        {
            fail = true;
        }

        if (timeperlength.HasMaxValue && timeperlength.Value_ > timeperlength.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimePerLength is outside its bounds.");
        }
        else if (fail)
        {
            return false;
