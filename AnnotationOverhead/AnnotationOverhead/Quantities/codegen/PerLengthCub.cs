...
#region units
	private static Unit_ percentimeter_ = new Unit_("PerCentimeter", "/cm", 1.0);
	private static Unit_ permillimeter_ = new Unit_("PerMillimeter", "/mm", 0.001);
	private static Unit_ permeter_ = new Unit_("PerMeter", "/m", 1000000.0);
	private static Unit_ perinch_ = new Unit_("PerInch", "/in", 16.777216000000003);
...
#region comparisons
    ...
    public bool Equals(PerLengthCub other) => other is object && Equals((object)other);
...
#region conversions
		public static PerLengthCub FromPerCentimeters(double value, double minValue, double maxValue) => new PerLengthCub(value * percentimeter_.Factor, minValue * percentimeter_.Factor, maxValue * percentimeter_.Factor);
		public static PerLengthCub FromPerCentimeters(double value) => new PerLengthCub(value * percentimeter_.Factor);
		public double GetValueInPerCentimeters() => Value_ / percentimeter_.Factor;
		public static PerLengthCub FromPerMillimeters(double value, double minValue, double maxValue) => new PerLengthCub(value * permillimeter_.Factor, minValue * permillimeter_.Factor, maxValue * permillimeter_.Factor);
		public static PerLengthCub FromPerMillimeters(double value) => new PerLengthCub(value * permillimeter_.Factor);
		public double GetValueInPerMillimeters() => Value_ / permillimeter_.Factor;
		public static PerLengthCub FromPerMeters(double value, double minValue, double maxValue) => new PerLengthCub(value * permeter_.Factor, minValue * permeter_.Factor, maxValue * permeter_.Factor);
		public static PerLengthCub FromPerMeters(double value) => new PerLengthCub(value * permeter_.Factor);
		public double GetValueInPerMeters() => Value_ / permeter_.Factor;
		public static PerLengthCub FromPerInchs(double value, double minValue, double maxValue) => new PerLengthCub(value * perinch_.Factor, minValue * perinch_.Factor, maxValue * perinch_.Factor);
		public static PerLengthCub FromPerInchs(double value) => new PerLengthCub(value * perinch_.Factor);
		public double GetValueInPerInchs() => Value_ / perinch_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(PerLengthCub perlengthcub, bool throwOnFail=true)
    {
        bool fail = false;
        if (perlengthcub.HasMinValue && perlengthcub.Value_ < perlengthcub.MinValue)
        {
            fail = true;
        }

        if (perlengthcub.HasMaxValue && perlengthcub.Value_ > perlengthcub.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("PerLengthCub is outside its bounds.");
        }
        else if (fail)
        {
            return false;
