...
namespace RaySearch.CorePlatform.Framework
{
    ...
    private static void ImportDisplayUnitFromDatabase_()
    {
        if (!displayUnitIsImported_ && FakeDatabase.Units.ContainsKey("PerLengthTime"))
        {
            ...
            {
				      case "percentimetercubsecond": displayUnit_ = percentimetercubsecond_; break;
				      case "permillimetercubsecond": displayUnit_ = permillimetercubsecond_; break;
				      case "permetercubsecond": displayUnit_ = permetercubsecond_; break;
				      case "perinchcubsecond": displayUnit_ = perinchcubsecond_; break;
...
#region units
	private static Unit_ percentimetercubsecond_ = new Unit_("PerCentimeterCubSecond", "/cm³ s", 1.0);
	private static Unit_ permillimetercubsecond_ = new Unit_("PerMillimeterCubSecond", "/mm³ s", 0.1);
	private static Unit_ permetercubsecond_ = new Unit_("PerMeterCubSecond", "/m³ s", 100.0);
	private static Unit_ perinchcubsecond_ = new Unit_("PerInchCubSecond", "/in³ s", 2.56);
	private static Unit_ platformUnit_ = percentimetercubsecond_;
	private static Unit_ displayUnit_ = percentimetercubsecond_;
#endregion
...
#region comparisons
    ...
    public bool Equals(PerLengthTime other) => other is object && Equals((object)other);
...
#region conversions
		public static PerLengthTime FromPerCentimeterCubSeconds(double value, double minValue, double maxValue) => new PerLengthTime(value * percentimetercubsecond_.Factor, minValue * percentimetercubsecond_.Factor, maxValue * percentimetercubsecond_.Factor);
		public static PerLengthTime FromPerCentimeterCubSeconds(double value) => new PerLengthTime(value * percentimetercubsecond_.Factor);
		public double GetValueInPerCentimeterCubSeconds() => Value_ / percentimetercubsecond_.Factor;
		public static PerLengthTime FromPerMillimeterCubSeconds(double value, double minValue, double maxValue) => new PerLengthTime(value * permillimetercubsecond_.Factor, minValue * permillimetercubsecond_.Factor, maxValue * permillimetercubsecond_.Factor);
		public static PerLengthTime FromPerMillimeterCubSeconds(double value) => new PerLengthTime(value * permillimetercubsecond_.Factor);
		public double GetValueInPerMillimeterCubSeconds() => Value_ / permillimetercubsecond_.Factor;
		public static PerLengthTime FromPerMeterCubSeconds(double value, double minValue, double maxValue) => new PerLengthTime(value * permetercubsecond_.Factor, minValue * permetercubsecond_.Factor, maxValue * permetercubsecond_.Factor);
		public static PerLengthTime FromPerMeterCubSeconds(double value) => new PerLengthTime(value * permetercubsecond_.Factor);
		public double GetValueInPerMeterCubSeconds() => Value_ / permetercubsecond_.Factor;
		public static PerLengthTime FromPerInchCubSeconds(double value, double minValue, double maxValue) => new PerLengthTime(value * perinchcubsecond_.Factor, minValue * perinchcubsecond_.Factor, maxValue * perinchcubsecond_.Factor);
		public static PerLengthTime FromPerInchCubSeconds(double value) => new PerLengthTime(value * perinchcubsecond_.Factor);
		public double GetValueInPerInchCubSeconds() => Value_ / perinchcubsecond_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(PerLengthTime perlengthtime, bool throwOnFail=true)
    {
        bool fail = false;
        if (perlengthtime.HasMinValue && perlengthtime.Value_ < perlengthtime.MinValue)
        {
            fail = true;
        }

        if (perlengthtime.HasMaxValue && perlengthtime.Value_ > perlengthtime.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("PerLengthTime is outside its bounds.");
        }
        else if (fail)
        {
            return false;
