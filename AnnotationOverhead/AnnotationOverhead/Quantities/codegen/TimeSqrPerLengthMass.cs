...
#region units
	private static Unit_ secondsqrpercentimeterkilogram_ = new Unit_("SecondSqrPerCentimeterKilogram", "s²/cm kg", 1.0);
	private static Unit_ secondsqrpermillimeterkilogram_ = new Unit_("SecondSqrPerMillimeterKilogram", "s²/mm kg", 10.0);
	private static Unit_ secondsqrpermeterkilogram_ = new Unit_("SecondSqrPerMeterKilogram", "s²/m kg", 0.01);
	private static Unit_ secondsqrperinchkilogram_ = new Unit_("SecondSqrPerInchKilogram", "s²/in kg", 0.390625);
...
#region comparisons
    ...
    public bool Equals(TimeSqrPerLengthMass other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeSqrPerLengthMass FromSecondSqrPerCentimeterKilograms(double value, double minValue, double maxValue) => new TimeSqrPerLengthMass(value * secondsqrpercentimeterkilogram_.Factor, minValue * secondsqrpercentimeterkilogram_.Factor, maxValue * secondsqrpercentimeterkilogram_.Factor);
		public static TimeSqrPerLengthMass FromSecondSqrPerCentimeterKilograms(double value) => new TimeSqrPerLengthMass(value * secondsqrpercentimeterkilogram_.Factor);
		public double GetValueInSecondSqrPerCentimeterKilograms() => Value_ / secondsqrpercentimeterkilogram_.Factor;
		public static TimeSqrPerLengthMass FromSecondSqrPerMillimeterKilograms(double value, double minValue, double maxValue) => new TimeSqrPerLengthMass(value * secondsqrpermillimeterkilogram_.Factor, minValue * secondsqrpermillimeterkilogram_.Factor, maxValue * secondsqrpermillimeterkilogram_.Factor);
		public static TimeSqrPerLengthMass FromSecondSqrPerMillimeterKilograms(double value) => new TimeSqrPerLengthMass(value * secondsqrpermillimeterkilogram_.Factor);
		public double GetValueInSecondSqrPerMillimeterKilograms() => Value_ / secondsqrpermillimeterkilogram_.Factor;
		public static TimeSqrPerLengthMass FromSecondSqrPerMeterKilograms(double value, double minValue, double maxValue) => new TimeSqrPerLengthMass(value * secondsqrpermeterkilogram_.Factor, minValue * secondsqrpermeterkilogram_.Factor, maxValue * secondsqrpermeterkilogram_.Factor);
		public static TimeSqrPerLengthMass FromSecondSqrPerMeterKilograms(double value) => new TimeSqrPerLengthMass(value * secondsqrpermeterkilogram_.Factor);
		public double GetValueInSecondSqrPerMeterKilograms() => Value_ / secondsqrpermeterkilogram_.Factor;
		public static TimeSqrPerLengthMass FromSecondSqrPerInchKilograms(double value, double minValue, double maxValue) => new TimeSqrPerLengthMass(value * secondsqrperinchkilogram_.Factor, minValue * secondsqrperinchkilogram_.Factor, maxValue * secondsqrperinchkilogram_.Factor);
		public static TimeSqrPerLengthMass FromSecondSqrPerInchKilograms(double value) => new TimeSqrPerLengthMass(value * secondsqrperinchkilogram_.Factor);
		public double GetValueInSecondSqrPerInchKilograms() => Value_ / secondsqrperinchkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeSqrPerLengthMass timesqrperlengthmass, bool throwOnFail=true)
    {
        bool fail = false;
        if (timesqrperlengthmass.HasMinValue && timesqrperlengthmass.Value_ < timesqrperlengthmass.MinValue)
        {
            fail = true;
        }

        if (timesqrperlengthmass.HasMaxValue && timesqrperlengthmass.Value_ > timesqrperlengthmass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeSqrPerLengthMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
