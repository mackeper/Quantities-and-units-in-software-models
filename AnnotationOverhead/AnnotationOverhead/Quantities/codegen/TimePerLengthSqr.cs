...
#region units
	private static Unit_ secondpercentimetersqr_ = new Unit_("SecondPerCentimeterSqr", "s/cm²", 1.0);
	private static Unit_ secondpermillimetersqr_ = new Unit_("SecondPerMillimeterSqr", "s/mm²", 99.99999999999999);
	private static Unit_ secondpermetersqr_ = new Unit_("SecondPerMeterSqr", "s/m²", 0.0001);
	private static Unit_ secondperinchsqr_ = new Unit_("SecondPerInchSqr", "s/in²", 0.152587890625);
...
#region comparisons
    ...
    public bool Equals(TimePerLengthSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static TimePerLengthSqr FromSecondPerCentimeterSqrs(double value, double minValue, double maxValue) => new TimePerLengthSqr(value * secondpercentimetersqr_.Factor, minValue * secondpercentimetersqr_.Factor, maxValue * secondpercentimetersqr_.Factor);
		public static TimePerLengthSqr FromSecondPerCentimeterSqrs(double value) => new TimePerLengthSqr(value * secondpercentimetersqr_.Factor);
		public double GetValueInSecondPerCentimeterSqrs() => Value_ / secondpercentimetersqr_.Factor;
		public static TimePerLengthSqr FromSecondPerMillimeterSqrs(double value, double minValue, double maxValue) => new TimePerLengthSqr(value * secondpermillimetersqr_.Factor, minValue * secondpermillimetersqr_.Factor, maxValue * secondpermillimetersqr_.Factor);
		public static TimePerLengthSqr FromSecondPerMillimeterSqrs(double value) => new TimePerLengthSqr(value * secondpermillimetersqr_.Factor);
		public double GetValueInSecondPerMillimeterSqrs() => Value_ / secondpermillimetersqr_.Factor;
		public static TimePerLengthSqr FromSecondPerMeterSqrs(double value, double minValue, double maxValue) => new TimePerLengthSqr(value * secondpermetersqr_.Factor, minValue * secondpermetersqr_.Factor, maxValue * secondpermetersqr_.Factor);
		public static TimePerLengthSqr FromSecondPerMeterSqrs(double value) => new TimePerLengthSqr(value * secondpermetersqr_.Factor);
		public double GetValueInSecondPerMeterSqrs() => Value_ / secondpermetersqr_.Factor;
		public static TimePerLengthSqr FromSecondPerInchSqrs(double value, double minValue, double maxValue) => new TimePerLengthSqr(value * secondperinchsqr_.Factor, minValue * secondperinchsqr_.Factor, maxValue * secondperinchsqr_.Factor);
		public static TimePerLengthSqr FromSecondPerInchSqrs(double value) => new TimePerLengthSqr(value * secondperinchsqr_.Factor);
		public double GetValueInSecondPerInchSqrs() => Value_ / secondperinchsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimePerLengthSqr timeperlengthsqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (timeperlengthsqr.HasMinValue && timeperlengthsqr.Value_ < timeperlengthsqr.MinValue)
        {
            fail = true;
        }

        if (timeperlengthsqr.HasMaxValue && timeperlengthsqr.Value_ > timeperlengthsqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimePerLengthSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
