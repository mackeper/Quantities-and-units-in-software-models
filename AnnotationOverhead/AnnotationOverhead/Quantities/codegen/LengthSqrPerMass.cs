...
#region units
	private static Unit_ centimetersqrperkilogram_ = new Unit_("CentimeterSqrPerKilogram", "cm²/kg", 1.0);
	private static Unit_ millimetersqrperkilogram_ = new Unit_("MillimeterSqrPerKilogram", "mm²/kg", 0.010000000000000002);
	private static Unit_ metersqrperkilogram_ = new Unit_("MeterSqrPerKilogram", "m²/kg", 10000.0);
	private static Unit_ inchsqrperkilogram_ = new Unit_("InchSqrPerKilogram", "in²/kg", 6.5536);
...
#region comparisons
    ...
    public bool Equals(LengthSqrPerMass other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthSqrPerMass FromCentimeterSqrPerKilograms(double value, double minValue, double maxValue) => new LengthSqrPerMass(value * centimetersqrperkilogram_.Factor, minValue * centimetersqrperkilogram_.Factor, maxValue * centimetersqrperkilogram_.Factor);
		public static LengthSqrPerMass FromCentimeterSqrPerKilograms(double value) => new LengthSqrPerMass(value * centimetersqrperkilogram_.Factor);
		public double GetValueInCentimeterSqrPerKilograms() => Value_ / centimetersqrperkilogram_.Factor;
		public static LengthSqrPerMass FromMillimeterSqrPerKilograms(double value, double minValue, double maxValue) => new LengthSqrPerMass(value * millimetersqrperkilogram_.Factor, minValue * millimetersqrperkilogram_.Factor, maxValue * millimetersqrperkilogram_.Factor);
		public static LengthSqrPerMass FromMillimeterSqrPerKilograms(double value) => new LengthSqrPerMass(value * millimetersqrperkilogram_.Factor);
		public double GetValueInMillimeterSqrPerKilograms() => Value_ / millimetersqrperkilogram_.Factor;
		public static LengthSqrPerMass FromMeterSqrPerKilograms(double value, double minValue, double maxValue) => new LengthSqrPerMass(value * metersqrperkilogram_.Factor, minValue * metersqrperkilogram_.Factor, maxValue * metersqrperkilogram_.Factor);
		public static LengthSqrPerMass FromMeterSqrPerKilograms(double value) => new LengthSqrPerMass(value * metersqrperkilogram_.Factor);
		public double GetValueInMeterSqrPerKilograms() => Value_ / metersqrperkilogram_.Factor;
		public static LengthSqrPerMass FromInchSqrPerKilograms(double value, double minValue, double maxValue) => new LengthSqrPerMass(value * inchsqrperkilogram_.Factor, minValue * inchsqrperkilogram_.Factor, maxValue * inchsqrperkilogram_.Factor);
		public static LengthSqrPerMass FromInchSqrPerKilograms(double value) => new LengthSqrPerMass(value * inchsqrperkilogram_.Factor);
		public double GetValueInInchSqrPerKilograms() => Value_ / inchsqrperkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthSqrPerMass lengthsqrpermass, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthsqrpermass.HasMinValue && lengthsqrpermass.Value_ < lengthsqrpermass.MinValue)
        {
            fail = true;
        }

        if (lengthsqrpermass.HasMaxValue && lengthsqrpermass.Value_ > lengthsqrpermass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthSqrPerMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
