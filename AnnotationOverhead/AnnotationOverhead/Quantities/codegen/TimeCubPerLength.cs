...
#region units
	private static Unit_ secondcubpercentimeter_ = new Unit_("SecondCubPerCentimeter", "s³/cm", 1.0);
	private static Unit_ secondcubpermillimeter_ = new Unit_("SecondCubPerMillimeter", "s³/mm", 10.0);
	private static Unit_ secondcubpermeter_ = new Unit_("SecondCubPerMeter", "s³/m", 0.01);
	private static Unit_ secondcubperinch_ = new Unit_("SecondCubPerInch", "s³/in", 0.390625);
...
#region comparisons
    ...
    public bool Equals(TimeCubPerLength other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeCubPerLength FromSecondCubPerCentimeters(double value, double minValue, double maxValue) => new TimeCubPerLength(value * secondcubpercentimeter_.Factor, minValue * secondcubpercentimeter_.Factor, maxValue * secondcubpercentimeter_.Factor);
		public static TimeCubPerLength FromSecondCubPerCentimeters(double value) => new TimeCubPerLength(value * secondcubpercentimeter_.Factor);
		public double GetValueInSecondCubPerCentimeters() => Value_ / secondcubpercentimeter_.Factor;
		public static TimeCubPerLength FromSecondCubPerMillimeters(double value, double minValue, double maxValue) => new TimeCubPerLength(value * secondcubpermillimeter_.Factor, minValue * secondcubpermillimeter_.Factor, maxValue * secondcubpermillimeter_.Factor);
		public static TimeCubPerLength FromSecondCubPerMillimeters(double value) => new TimeCubPerLength(value * secondcubpermillimeter_.Factor);
		public double GetValueInSecondCubPerMillimeters() => Value_ / secondcubpermillimeter_.Factor;
		public static TimeCubPerLength FromSecondCubPerMeters(double value, double minValue, double maxValue) => new TimeCubPerLength(value * secondcubpermeter_.Factor, minValue * secondcubpermeter_.Factor, maxValue * secondcubpermeter_.Factor);
		public static TimeCubPerLength FromSecondCubPerMeters(double value) => new TimeCubPerLength(value * secondcubpermeter_.Factor);
		public double GetValueInSecondCubPerMeters() => Value_ / secondcubpermeter_.Factor;
		public static TimeCubPerLength FromSecondCubPerInchs(double value, double minValue, double maxValue) => new TimeCubPerLength(value * secondcubperinch_.Factor, minValue * secondcubperinch_.Factor, maxValue * secondcubperinch_.Factor);
		public static TimeCubPerLength FromSecondCubPerInchs(double value) => new TimeCubPerLength(value * secondcubperinch_.Factor);
		public double GetValueInSecondCubPerInchs() => Value_ / secondcubperinch_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeCubPerLength timecubperlength, bool throwOnFail=true)
    {
        bool fail = false;
        if (timecubperlength.HasMinValue && timecubperlength.Value_ < timecubperlength.MinValue)
        {
            fail = true;
        }

        if (timecubperlength.HasMaxValue && timecubperlength.Value_ > timecubperlength.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeCubPerLength is outside its bounds.");
        }
        else if (fail)
        {
            return false;
