...
#region units
	private static Unit_ centimeterpersecondcub_ = new Unit_("CentimeterPerSecondCub", "cm/s�", 1.0);
	private static Unit_ millimeterpersecondcub_ = new Unit_("MillimeterPerSecondCub", "mm/s�", 0.1);
	private static Unit_ meterpersecondcub_ = new Unit_("MeterPerSecondCub", "m/s�", 100.0);
	private static Unit_ inchpersecondcub_ = new Unit_("InchPerSecondCub", "in/s�", 2.56);
...
#region comparisons
    ...
    public bool Equals(LengthPerTimeCub other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthPerTimeCub FromCentimeterPerSecondCubs(double value, double minValue, double maxValue) => new LengthPerTimeCub(value * centimeterpersecondcub_.Factor, minValue * centimeterpersecondcub_.Factor, maxValue * centimeterpersecondcub_.Factor);
		public static LengthPerTimeCub FromCentimeterPerSecondCubs(double value) => new LengthPerTimeCub(value * centimeterpersecondcub_.Factor);
		public double GetValueInCentimeterPerSecondCubs() => Value_ / centimeterpersecondcub_.Factor;
		public static LengthPerTimeCub FromMillimeterPerSecondCubs(double value, double minValue, double maxValue) => new LengthPerTimeCub(value * millimeterpersecondcub_.Factor, minValue * millimeterpersecondcub_.Factor, maxValue * millimeterpersecondcub_.Factor);
		public static LengthPerTimeCub FromMillimeterPerSecondCubs(double value) => new LengthPerTimeCub(value * millimeterpersecondcub_.Factor);
		public double GetValueInMillimeterPerSecondCubs() => Value_ / millimeterpersecondcub_.Factor;
		public static LengthPerTimeCub FromMeterPerSecondCubs(double value, double minValue, double maxValue) => new LengthPerTimeCub(value * meterpersecondcub_.Factor, minValue * meterpersecondcub_.Factor, maxValue * meterpersecondcub_.Factor);
		public static LengthPerTimeCub FromMeterPerSecondCubs(double value) => new LengthPerTimeCub(value * meterpersecondcub_.Factor);
		public double GetValueInMeterPerSecondCubs() => Value_ / meterpersecondcub_.Factor;
		public static LengthPerTimeCub FromInchPerSecondCubs(double value, double minValue, double maxValue) => new LengthPerTimeCub(value * inchpersecondcub_.Factor, minValue * inchpersecondcub_.Factor, maxValue * inchpersecondcub_.Factor);
		public static LengthPerTimeCub FromInchPerSecondCubs(double value) => new LengthPerTimeCub(value * inchpersecondcub_.Factor);
		public double GetValueInInchPerSecondCubs() => Value_ / inchpersecondcub_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthPerTimeCub lengthpertimecub, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthpertimecub.HasMinValue && lengthpertimecub.Value_ < lengthpertimecub.MinValue)
        {
            fail = true;
        }

        if (lengthpertimecub.HasMaxValue && lengthpertimecub.Value_ > lengthpertimecub.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthPerTimeCub is outside its bounds.");
        }
        else if (fail)
        {
            return false;
