...
#region units
	private static Unit_ centimeterkilogrampersecondsqr_ = new Unit_("CentimeterKilogramPerSecondSqr", "cm kg/s²", 1.0);
	private static Unit_ millimeterkilogrampersecondsqr_ = new Unit_("MillimeterKilogramPerSecondSqr", "mm kg/s²", 0.1);
	private static Unit_ meterkilogrampersecondsqr_ = new Unit_("MeterKilogramPerSecondSqr", "m kg/s²", 100.0);
	private static Unit_ inchkilogrampersecondsqr_ = new Unit_("InchKilogramPerSecondSqr", "in kg/s²", 2.56);
	private static Unit_ newton_ = new Unit_("Newton", "N", 1);
...
#region comparisons
    ...
    public bool Equals(Force other) => other is object && Equals((object)other);
...
#region conversions
		public static Force FromCentimeterKilogramPerSecondSqrs(double value, double minValue, double maxValue) => new Force(value * centimeterkilogrampersecondsqr_.Factor, minValue * centimeterkilogrampersecondsqr_.Factor, maxValue * centimeterkilogrampersecondsqr_.Factor);
		public static Force FromCentimeterKilogramPerSecondSqrs(double value) => new Force(value * centimeterkilogrampersecondsqr_.Factor);
		public double GetValueInCentimeterKilogramPerSecondSqrs() => Value_ / centimeterkilogrampersecondsqr_.Factor;
		public static Force FromMillimeterKilogramPerSecondSqrs(double value, double minValue, double maxValue) => new Force(value * millimeterkilogrampersecondsqr_.Factor, minValue * millimeterkilogrampersecondsqr_.Factor, maxValue * millimeterkilogrampersecondsqr_.Factor);
		public static Force FromMillimeterKilogramPerSecondSqrs(double value) => new Force(value * millimeterkilogrampersecondsqr_.Factor);
		public double GetValueInMillimeterKilogramPerSecondSqrs() => Value_ / millimeterkilogrampersecondsqr_.Factor;
		public static Force FromMeterKilogramPerSecondSqrs(double value, double minValue, double maxValue) => new Force(value * meterkilogrampersecondsqr_.Factor, minValue * meterkilogrampersecondsqr_.Factor, maxValue * meterkilogrampersecondsqr_.Factor);
		public static Force FromMeterKilogramPerSecondSqrs(double value) => new Force(value * meterkilogrampersecondsqr_.Factor);
		public double GetValueInMeterKilogramPerSecondSqrs() => Value_ / meterkilogrampersecondsqr_.Factor;
		public static Force FromInchKilogramPerSecondSqrs(double value, double minValue, double maxValue) => new Force(value * inchkilogrampersecondsqr_.Factor, minValue * inchkilogrampersecondsqr_.Factor, maxValue * inchkilogrampersecondsqr_.Factor);
		public static Force FromInchKilogramPerSecondSqrs(double value) => new Force(value * inchkilogrampersecondsqr_.Factor);
		public double GetValueInInchKilogramPerSecondSqrs() => Value_ / inchkilogrampersecondsqr_.Factor;
		public static Force FromNewtons(double value, double minValue, double maxValue) => new Force(value * newton_.Factor, minValue * newton_.Factor, maxValue * newton_.Factor);
		public static Force FromNewtons(double value) => new Force(value * newton_.Factor);
		public double GetValueInNewtons() => Value_ / newton_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(Force force, bool throwOnFail=true)
    {
        bool fail = false;
        if (force.HasMinValue && force.Value_ < force.MinValue)
        {
            fail = true;
        }

        if (force.HasMaxValue && force.Value_ > force.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("Force is outside its bounds.");
        }
        else if (fail)
        {
            return false;
