...
#region units
	private static Unit_ secondcubpercentimetersqr_ = new Unit_("SecondCubPerCentimeterSqr", "s³/cm²", 1.0);
	private static Unit_ secondcubpermillimetersqr_ = new Unit_("SecondCubPerMillimeterSqr", "s³/mm²", 99.99999999999999);
	private static Unit_ secondcubpermetersqr_ = new Unit_("SecondCubPerMeterSqr", "s³/m²", 0.0001);
	private static Unit_ secondcubperinchsqr_ = new Unit_("SecondCubPerInchSqr", "s³/in²", 0.152587890625);
...
#region comparisons
    ...
    public bool Equals(TimeCubPerLengthSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeCubPerLengthSqr FromSecondCubPerCentimeterSqrs(double value, double minValue, double maxValue) => new TimeCubPerLengthSqr(value * secondcubpercentimetersqr_.Factor, minValue * secondcubpercentimetersqr_.Factor, maxValue * secondcubpercentimetersqr_.Factor);
		public static TimeCubPerLengthSqr FromSecondCubPerCentimeterSqrs(double value) => new TimeCubPerLengthSqr(value * secondcubpercentimetersqr_.Factor);
		public double GetValueInSecondCubPerCentimeterSqrs() => Value_ / secondcubpercentimetersqr_.Factor;
		public static TimeCubPerLengthSqr FromSecondCubPerMillimeterSqrs(double value, double minValue, double maxValue) => new TimeCubPerLengthSqr(value * secondcubpermillimetersqr_.Factor, minValue * secondcubpermillimetersqr_.Factor, maxValue * secondcubpermillimetersqr_.Factor);
		public static TimeCubPerLengthSqr FromSecondCubPerMillimeterSqrs(double value) => new TimeCubPerLengthSqr(value * secondcubpermillimetersqr_.Factor);
		public double GetValueInSecondCubPerMillimeterSqrs() => Value_ / secondcubpermillimetersqr_.Factor;
		public static TimeCubPerLengthSqr FromSecondCubPerMeterSqrs(double value, double minValue, double maxValue) => new TimeCubPerLengthSqr(value * secondcubpermetersqr_.Factor, minValue * secondcubpermetersqr_.Factor, maxValue * secondcubpermetersqr_.Factor);
		public static TimeCubPerLengthSqr FromSecondCubPerMeterSqrs(double value) => new TimeCubPerLengthSqr(value * secondcubpermetersqr_.Factor);
		public double GetValueInSecondCubPerMeterSqrs() => Value_ / secondcubpermetersqr_.Factor;
		public static TimeCubPerLengthSqr FromSecondCubPerInchSqrs(double value, double minValue, double maxValue) => new TimeCubPerLengthSqr(value * secondcubperinchsqr_.Factor, minValue * secondcubperinchsqr_.Factor, maxValue * secondcubperinchsqr_.Factor);
		public static TimeCubPerLengthSqr FromSecondCubPerInchSqrs(double value) => new TimeCubPerLengthSqr(value * secondcubperinchsqr_.Factor);
		public double GetValueInSecondCubPerInchSqrs() => Value_ / secondcubperinchsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeCubPerLengthSqr timecubperlengthsqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (timecubperlengthsqr.HasMinValue && timecubperlengthsqr.Value_ < timecubperlengthsqr.MinValue)
        {
            fail = true;
        }

        if (timecubperlengthsqr.HasMaxValue && timecubperlengthsqr.Value_ > timecubperlengthsqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeCubPerLengthSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
