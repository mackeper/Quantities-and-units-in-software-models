...
#region units
	private static Unit_ centimeterperkilogramsecondsqr_ = new Unit_("CentimeterPerKilogramSecondSqr", "cm/kg s²", 1.0);
	private static Unit_ millimeterperkilogramsecondsqr_ = new Unit_("MillimeterPerKilogramSecondSqr", "mm/kg s²", 0.1);
	private static Unit_ meterperkilogramsecondsqr_ = new Unit_("MeterPerKilogramSecondSqr", "m/kg s²", 100.0);
	private static Unit_ inchperkilogramsecondsqr_ = new Unit_("InchPerKilogramSecondSqr", "in/kg s²", 2.56);
...
#region comparisons
    ...
    public bool Equals(LengthPerMassTimeSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthPerMassTimeSqr FromCentimeterPerKilogramSecondSqrs(double value, double minValue, double maxValue) => new LengthPerMassTimeSqr(value * centimeterperkilogramsecondsqr_.Factor, minValue * centimeterperkilogramsecondsqr_.Factor, maxValue * centimeterperkilogramsecondsqr_.Factor);
		public static LengthPerMassTimeSqr FromCentimeterPerKilogramSecondSqrs(double value) => new LengthPerMassTimeSqr(value * centimeterperkilogramsecondsqr_.Factor);
		public double GetValueInCentimeterPerKilogramSecondSqrs() => Value_ / centimeterperkilogramsecondsqr_.Factor;
		public static LengthPerMassTimeSqr FromMillimeterPerKilogramSecondSqrs(double value, double minValue, double maxValue) => new LengthPerMassTimeSqr(value * millimeterperkilogramsecondsqr_.Factor, minValue * millimeterperkilogramsecondsqr_.Factor, maxValue * millimeterperkilogramsecondsqr_.Factor);
		public static LengthPerMassTimeSqr FromMillimeterPerKilogramSecondSqrs(double value) => new LengthPerMassTimeSqr(value * millimeterperkilogramsecondsqr_.Factor);
		public double GetValueInMillimeterPerKilogramSecondSqrs() => Value_ / millimeterperkilogramsecondsqr_.Factor;
		public static LengthPerMassTimeSqr FromMeterPerKilogramSecondSqrs(double value, double minValue, double maxValue) => new LengthPerMassTimeSqr(value * meterperkilogramsecondsqr_.Factor, minValue * meterperkilogramsecondsqr_.Factor, maxValue * meterperkilogramsecondsqr_.Factor);
		public static LengthPerMassTimeSqr FromMeterPerKilogramSecondSqrs(double value) => new LengthPerMassTimeSqr(value * meterperkilogramsecondsqr_.Factor);
		public double GetValueInMeterPerKilogramSecondSqrs() => Value_ / meterperkilogramsecondsqr_.Factor;
		public static LengthPerMassTimeSqr FromInchPerKilogramSecondSqrs(double value, double minValue, double maxValue) => new LengthPerMassTimeSqr(value * inchperkilogramsecondsqr_.Factor, minValue * inchperkilogramsecondsqr_.Factor, maxValue * inchperkilogramsecondsqr_.Factor);
		public static LengthPerMassTimeSqr FromInchPerKilogramSecondSqrs(double value) => new LengthPerMassTimeSqr(value * inchperkilogramsecondsqr_.Factor);
		public double GetValueInInchPerKilogramSecondSqrs() => Value_ / inchperkilogramsecondsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthPerMassTimeSqr lengthpermasstimesqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthpermasstimesqr.HasMinValue && lengthpermasstimesqr.Value_ < lengthpermasstimesqr.MinValue)
        {
            fail = true;
        }

        if (lengthpermasstimesqr.HasMaxValue && lengthpermasstimesqr.Value_ > lengthpermasstimesqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthPerMassTimeSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
