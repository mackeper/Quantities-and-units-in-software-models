...
#region units
	private static Unit_ centimetersqrperkilogramsecondsqr_ = new Unit_("CentimeterSqrPerKilogramSecondSqr", "cm²/kg s²", 1.0);
	private static Unit_ millimetersqrperkilogramsecondsqr_ = new Unit_("MillimeterSqrPerKilogramSecondSqr", "mm²/kg s²", 0.010000000000000002);
	private static Unit_ metersqrperkilogramsecondsqr_ = new Unit_("MeterSqrPerKilogramSecondSqr", "m²/kg s²", 10000.0);
	private static Unit_ inchsqrperkilogramsecondsqr_ = new Unit_("InchSqrPerKilogramSecondSqr", "in²/kg s²", 6.5536);
...
#region comparisons
    ...
    public bool Equals(LengthSqrPerMassTimeSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthSqrPerMassTimeSqr FromCentimeterSqrPerKilogramSecondSqrs(double value, double minValue, double maxValue) => new LengthSqrPerMassTimeSqr(value * centimetersqrperkilogramsecondsqr_.Factor, minValue * centimetersqrperkilogramsecondsqr_.Factor, maxValue * centimetersqrperkilogramsecondsqr_.Factor);
		public static LengthSqrPerMassTimeSqr FromCentimeterSqrPerKilogramSecondSqrs(double value) => new LengthSqrPerMassTimeSqr(value * centimetersqrperkilogramsecondsqr_.Factor);
		public double GetValueInCentimeterSqrPerKilogramSecondSqrs() => Value_ / centimetersqrperkilogramsecondsqr_.Factor;
		public static LengthSqrPerMassTimeSqr FromMillimeterSqrPerKilogramSecondSqrs(double value, double minValue, double maxValue) => new LengthSqrPerMassTimeSqr(value * millimetersqrperkilogramsecondsqr_.Factor, minValue * millimetersqrperkilogramsecondsqr_.Factor, maxValue * millimetersqrperkilogramsecondsqr_.Factor);
		public static LengthSqrPerMassTimeSqr FromMillimeterSqrPerKilogramSecondSqrs(double value) => new LengthSqrPerMassTimeSqr(value * millimetersqrperkilogramsecondsqr_.Factor);
		public double GetValueInMillimeterSqrPerKilogramSecondSqrs() => Value_ / millimetersqrperkilogramsecondsqr_.Factor;
		public static LengthSqrPerMassTimeSqr FromMeterSqrPerKilogramSecondSqrs(double value, double minValue, double maxValue) => new LengthSqrPerMassTimeSqr(value * metersqrperkilogramsecondsqr_.Factor, minValue * metersqrperkilogramsecondsqr_.Factor, maxValue * metersqrperkilogramsecondsqr_.Factor);
		public static LengthSqrPerMassTimeSqr FromMeterSqrPerKilogramSecondSqrs(double value) => new LengthSqrPerMassTimeSqr(value * metersqrperkilogramsecondsqr_.Factor);
		public double GetValueInMeterSqrPerKilogramSecondSqrs() => Value_ / metersqrperkilogramsecondsqr_.Factor;
		public static LengthSqrPerMassTimeSqr FromInchSqrPerKilogramSecondSqrs(double value, double minValue, double maxValue) => new LengthSqrPerMassTimeSqr(value * inchsqrperkilogramsecondsqr_.Factor, minValue * inchsqrperkilogramsecondsqr_.Factor, maxValue * inchsqrperkilogramsecondsqr_.Factor);
		public static LengthSqrPerMassTimeSqr FromInchSqrPerKilogramSecondSqrs(double value) => new LengthSqrPerMassTimeSqr(value * inchsqrperkilogramsecondsqr_.Factor);
		public double GetValueInInchSqrPerKilogramSecondSqrs() => Value_ / inchsqrperkilogramsecondsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthSqrPerMassTimeSqr lengthsqrpermasstimesqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthsqrpermasstimesqr.HasMinValue && lengthsqrpermasstimesqr.Value_ < lengthsqrpermasstimesqr.MinValue)
        {
            fail = true;
        }

        if (lengthsqrpermasstimesqr.HasMaxValue && lengthsqrpermasstimesqr.Value_ > lengthsqrpermasstimesqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthSqrPerMassTimeSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
