...
#region units
	private static Unit_ secondpercentimetercub_ = new Unit_("SecondPerCentimeterCub", "s/cm�", 1.0);
	private static Unit_ secondpermillimetercub_ = new Unit_("SecondPerMillimeterCub", "s/mm�", 999.9999999999998);
	private static Unit_ secondpermetercub_ = new Unit_("SecondPerMeterCub", "s/m�", 1e-06);
	private static Unit_ secondperinchcub_ = new Unit_("SecondPerInchCub", "s/in�", 0.05960464477539062);
...
#region comparisons
    ...
    public bool Equals(TimePerLengthCub other) => other is object && Equals((object)other);
...
#region conversions
		public static TimePerLengthCub FromSecondPerCentimeterCubs(double value, double minValue, double maxValue) => new TimePerLengthCub(value * secondpercentimetercub_.Factor, minValue * secondpercentimetercub_.Factor, maxValue * secondpercentimetercub_.Factor);
		public static TimePerLengthCub FromSecondPerCentimeterCubs(double value) => new TimePerLengthCub(value * secondpercentimetercub_.Factor);
		public double GetValueInSecondPerCentimeterCubs() => Value_ / secondpercentimetercub_.Factor;
		public static TimePerLengthCub FromSecondPerMillimeterCubs(double value, double minValue, double maxValue) => new TimePerLengthCub(value * secondpermillimetercub_.Factor, minValue * secondpermillimetercub_.Factor, maxValue * secondpermillimetercub_.Factor);
		public static TimePerLengthCub FromSecondPerMillimeterCubs(double value) => new TimePerLengthCub(value * secondpermillimetercub_.Factor);
		public double GetValueInSecondPerMillimeterCubs() => Value_ / secondpermillimetercub_.Factor;
		public static TimePerLengthCub FromSecondPerMeterCubs(double value, double minValue, double maxValue) => new TimePerLengthCub(value * secondpermetercub_.Factor, minValue * secondpermetercub_.Factor, maxValue * secondpermetercub_.Factor);
		public static TimePerLengthCub FromSecondPerMeterCubs(double value) => new TimePerLengthCub(value * secondpermetercub_.Factor);
		public double GetValueInSecondPerMeterCubs() => Value_ / secondpermetercub_.Factor;
		public static TimePerLengthCub FromSecondPerInchCubs(double value, double minValue, double maxValue) => new TimePerLengthCub(value * secondperinchcub_.Factor, minValue * secondperinchcub_.Factor, maxValue * secondperinchcub_.Factor);
		public static TimePerLengthCub FromSecondPerInchCubs(double value) => new TimePerLengthCub(value * secondperinchcub_.Factor);
		public double GetValueInSecondPerInchCubs() => Value_ / secondperinchcub_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimePerLengthCub timeperlengthcub, bool throwOnFail=true)
    {
        bool fail = false;
        if (timeperlengthcub.HasMinValue && timeperlengthcub.Value_ < timeperlengthcub.MinValue)
        {
            fail = true;
        }

        if (timeperlengthcub.HasMaxValue && timeperlengthcub.Value_ > timeperlengthcub.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimePerLengthCub is outside its bounds.");
        }
        else if (fail)
        {
            return false;
