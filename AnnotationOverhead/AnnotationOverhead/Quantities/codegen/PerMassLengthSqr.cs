...
namespace RaySearch.CorePlatform.Framework
{
    ...
    private static void ImportDisplayUnitFromDatabase_()
    {
        if (!displayUnitIsImported_ && FakeDatabase.Units.ContainsKey("PerMassLengthSqr"))
        {
            ...
            {
				      case "perkilogramcubcentimetersqr": displayUnit_ = perkilogramcubcentimetersqr_; break;
				      case "perkilogramcubmillimetersqr": displayUnit_ = perkilogramcubmillimetersqr_; break;
				      case "perkilogramcubmetersqr": displayUnit_ = perkilogramcubmetersqr_; break;
				      case "perkilogramcubinchsqr": displayUnit_ = perkilogramcubinchsqr_; break;
...
#region units
	private static Unit_ perkilogramcubcentimetersqr_ = new Unit_("PerKilogramCubCentimeterSqr", "/kg³ cm²", 1.0);
	private static Unit_ perkilogramcubmillimetersqr_ = new Unit_("PerKilogramCubMillimeterSqr", "/kg³ mm²", 99.99999999999999);
	private static Unit_ perkilogramcubmetersqr_ = new Unit_("PerKilogramCubMeterSqr", "/kg³ m²", 0.0001);
	private static Unit_ perkilogramcubinchsqr_ = new Unit_("PerKilogramCubInchSqr", "/kg³ in²", 0.152587890625);
	private static Unit_ platformUnit_ = perkilogramcubcentimetersqr_;
	private static Unit_ displayUnit_ = perkilogramcubcentimetersqr_;
#endregion
...
#region comparisons
    ...
    public bool Equals(PerMassLengthSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static PerMassLengthSqr FromPerKilogramCubCentimeterSqrs(double value, double minValue, double maxValue) => new PerMassLengthSqr(value * perkilogramcubcentimetersqr_.Factor, minValue * perkilogramcubcentimetersqr_.Factor, maxValue * perkilogramcubcentimetersqr_.Factor);
		public static PerMassLengthSqr FromPerKilogramCubCentimeterSqrs(double value) => new PerMassLengthSqr(value * perkilogramcubcentimetersqr_.Factor);
		public double GetValueInPerKilogramCubCentimeterSqrs() => Value_ / perkilogramcubcentimetersqr_.Factor;
		public static PerMassLengthSqr FromPerKilogramCubMillimeterSqrs(double value, double minValue, double maxValue) => new PerMassLengthSqr(value * perkilogramcubmillimetersqr_.Factor, minValue * perkilogramcubmillimetersqr_.Factor, maxValue * perkilogramcubmillimetersqr_.Factor);
		public static PerMassLengthSqr FromPerKilogramCubMillimeterSqrs(double value) => new PerMassLengthSqr(value * perkilogramcubmillimetersqr_.Factor);
		public double GetValueInPerKilogramCubMillimeterSqrs() => Value_ / perkilogramcubmillimetersqr_.Factor;
		public static PerMassLengthSqr FromPerKilogramCubMeterSqrs(double value, double minValue, double maxValue) => new PerMassLengthSqr(value * perkilogramcubmetersqr_.Factor, minValue * perkilogramcubmetersqr_.Factor, maxValue * perkilogramcubmetersqr_.Factor);
		public static PerMassLengthSqr FromPerKilogramCubMeterSqrs(double value) => new PerMassLengthSqr(value * perkilogramcubmetersqr_.Factor);
		public double GetValueInPerKilogramCubMeterSqrs() => Value_ / perkilogramcubmetersqr_.Factor;
		public static PerMassLengthSqr FromPerKilogramCubInchSqrs(double value, double minValue, double maxValue) => new PerMassLengthSqr(value * perkilogramcubinchsqr_.Factor, minValue * perkilogramcubinchsqr_.Factor, maxValue * perkilogramcubinchsqr_.Factor);
		public static PerMassLengthSqr FromPerKilogramCubInchSqrs(double value) => new PerMassLengthSqr(value * perkilogramcubinchsqr_.Factor);
		public double GetValueInPerKilogramCubInchSqrs() => Value_ / perkilogramcubinchsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(PerMassLengthSqr permasslengthsqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (permasslengthsqr.HasMinValue && permasslengthsqr.Value_ < permasslengthsqr.MinValue)
        {
            fail = true;
        }

        if (permasslengthsqr.HasMaxValue && permasslengthsqr.Value_ > permasslengthsqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("PerMassLengthSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
