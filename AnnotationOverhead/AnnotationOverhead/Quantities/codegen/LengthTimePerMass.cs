...
#region units
	private static Unit_ centimetersecondperkilogram_ = new Unit_("CentimeterSecondPerKilogram", "cm s/kg", 1.0);
	private static Unit_ millimetersecondperkilogram_ = new Unit_("MillimeterSecondPerKilogram", "mm s/kg", 0.1);
	private static Unit_ metersecondperkilogram_ = new Unit_("MeterSecondPerKilogram", "m s/kg", 100.0);
	private static Unit_ inchsecondperkilogram_ = new Unit_("InchSecondPerKilogram", "in s/kg", 2.56);
...
#region comparisons
    ...
    public bool Equals(LengthTimePerMass other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthTimePerMass FromCentimeterSecondPerKilograms(double value, double minValue, double maxValue) => new LengthTimePerMass(value * centimetersecondperkilogram_.Factor, minValue * centimetersecondperkilogram_.Factor, maxValue * centimetersecondperkilogram_.Factor);
		public static LengthTimePerMass FromCentimeterSecondPerKilograms(double value) => new LengthTimePerMass(value * centimetersecondperkilogram_.Factor);
		public double GetValueInCentimeterSecondPerKilograms() => Value_ / centimetersecondperkilogram_.Factor;
		public static LengthTimePerMass FromMillimeterSecondPerKilograms(double value, double minValue, double maxValue) => new LengthTimePerMass(value * millimetersecondperkilogram_.Factor, minValue * millimetersecondperkilogram_.Factor, maxValue * millimetersecondperkilogram_.Factor);
		public static LengthTimePerMass FromMillimeterSecondPerKilograms(double value) => new LengthTimePerMass(value * millimetersecondperkilogram_.Factor);
		public double GetValueInMillimeterSecondPerKilograms() => Value_ / millimetersecondperkilogram_.Factor;
		public static LengthTimePerMass FromMeterSecondPerKilograms(double value, double minValue, double maxValue) => new LengthTimePerMass(value * metersecondperkilogram_.Factor, minValue * metersecondperkilogram_.Factor, maxValue * metersecondperkilogram_.Factor);
		public static LengthTimePerMass FromMeterSecondPerKilograms(double value) => new LengthTimePerMass(value * metersecondperkilogram_.Factor);
		public double GetValueInMeterSecondPerKilograms() => Value_ / metersecondperkilogram_.Factor;
		public static LengthTimePerMass FromInchSecondPerKilograms(double value, double minValue, double maxValue) => new LengthTimePerMass(value * inchsecondperkilogram_.Factor, minValue * inchsecondperkilogram_.Factor, maxValue * inchsecondperkilogram_.Factor);
		public static LengthTimePerMass FromInchSecondPerKilograms(double value) => new LengthTimePerMass(value * inchsecondperkilogram_.Factor);
		public double GetValueInInchSecondPerKilograms() => Value_ / inchsecondperkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthTimePerMass lengthtimepermass, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthtimepermass.HasMinValue && lengthtimepermass.Value_ < lengthtimepermass.MinValue)
        {
            fail = true;
        }

        if (lengthtimepermass.HasMaxValue && lengthtimepermass.Value_ > lengthtimepermass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthTimePerMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
