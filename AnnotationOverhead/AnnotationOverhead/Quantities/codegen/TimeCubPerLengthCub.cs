...
#region units
	private static Unit_ secondcubpercentimetercub_ = new Unit_("SecondCubPerCentimeterCub", "s³/cm³", 1.0);
	private static Unit_ secondcubpermillimetercub_ = new Unit_("SecondCubPerMillimeterCub", "s³/mm³", 999.9999999999998);
	private static Unit_ secondcubpermetercub_ = new Unit_("SecondCubPerMeterCub", "s³/m³", 1e-06);
	private static Unit_ secondcubperinchcub_ = new Unit_("SecondCubPerInchCub", "s³/in³", 0.05960464477539062);
...
#region comparisons
    ...
    public bool Equals(TimeCubPerLengthCub other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeCubPerLengthCub FromSecondCubPerCentimeterCubs(double value, double minValue, double maxValue) => new TimeCubPerLengthCub(value * secondcubpercentimetercub_.Factor, minValue * secondcubpercentimetercub_.Factor, maxValue * secondcubpercentimetercub_.Factor);
		public static TimeCubPerLengthCub FromSecondCubPerCentimeterCubs(double value) => new TimeCubPerLengthCub(value * secondcubpercentimetercub_.Factor);
		public double GetValueInSecondCubPerCentimeterCubs() => Value_ / secondcubpercentimetercub_.Factor;
		public static TimeCubPerLengthCub FromSecondCubPerMillimeterCubs(double value, double minValue, double maxValue) => new TimeCubPerLengthCub(value * secondcubpermillimetercub_.Factor, minValue * secondcubpermillimetercub_.Factor, maxValue * secondcubpermillimetercub_.Factor);
		public static TimeCubPerLengthCub FromSecondCubPerMillimeterCubs(double value) => new TimeCubPerLengthCub(value * secondcubpermillimetercub_.Factor);
		public double GetValueInSecondCubPerMillimeterCubs() => Value_ / secondcubpermillimetercub_.Factor;
		public static TimeCubPerLengthCub FromSecondCubPerMeterCubs(double value, double minValue, double maxValue) => new TimeCubPerLengthCub(value * secondcubpermetercub_.Factor, minValue * secondcubpermetercub_.Factor, maxValue * secondcubpermetercub_.Factor);
		public static TimeCubPerLengthCub FromSecondCubPerMeterCubs(double value) => new TimeCubPerLengthCub(value * secondcubpermetercub_.Factor);
		public double GetValueInSecondCubPerMeterCubs() => Value_ / secondcubpermetercub_.Factor;
		public static TimeCubPerLengthCub FromSecondCubPerInchCubs(double value, double minValue, double maxValue) => new TimeCubPerLengthCub(value * secondcubperinchcub_.Factor, minValue * secondcubperinchcub_.Factor, maxValue * secondcubperinchcub_.Factor);
		public static TimeCubPerLengthCub FromSecondCubPerInchCubs(double value) => new TimeCubPerLengthCub(value * secondcubperinchcub_.Factor);
		public double GetValueInSecondCubPerInchCubs() => Value_ / secondcubperinchcub_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeCubPerLengthCub timecubperlengthcub, bool throwOnFail=true)
    {
        bool fail = false;
        if (timecubperlengthcub.HasMinValue && timecubperlengthcub.Value_ < timecubperlengthcub.MinValue)
        {
            fail = true;
        }

        if (timecubperlengthcub.HasMaxValue && timecubperlengthcub.Value_ > timecubperlengthcub.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeCubPerLengthCub is outside its bounds.");
        }
        else if (fail)
        {
            return false;
