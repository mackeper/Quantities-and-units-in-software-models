...
#region units
	private static Unit_ secondsqrcentimeterkilogram_ = new Unit_("SecondSqrCentimeterKilogram", "s� cm kg", 1);
	private static Unit_ secondsqrmillimeterkilogram_ = new Unit_("SecondSqrMillimeterKilogram", "s� mm kg", 0.1);
	private static Unit_ secondsqrmeterkilogram_ = new Unit_("SecondSqrMeterKilogram", "s� m kg", 100);
	private static Unit_ secondsqrinchkilogram_ = new Unit_("SecondSqrInchKilogram", "s� in kg", 2.56);
...
#region comparisons
    ...
    public bool Equals(TimeSqrLengthMass other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeSqrLengthMass FromSecondSqrCentimeterKilograms(double value, double minValue, double maxValue) => new TimeSqrLengthMass(value * secondsqrcentimeterkilogram_.Factor, minValue * secondsqrcentimeterkilogram_.Factor, maxValue * secondsqrcentimeterkilogram_.Factor);
		public static TimeSqrLengthMass FromSecondSqrCentimeterKilograms(double value) => new TimeSqrLengthMass(value * secondsqrcentimeterkilogram_.Factor);
		public double GetValueInSecondSqrCentimeterKilograms() => Value_ / secondsqrcentimeterkilogram_.Factor;
		public static TimeSqrLengthMass FromSecondSqrMillimeterKilograms(double value, double minValue, double maxValue) => new TimeSqrLengthMass(value * secondsqrmillimeterkilogram_.Factor, minValue * secondsqrmillimeterkilogram_.Factor, maxValue * secondsqrmillimeterkilogram_.Factor);
		public static TimeSqrLengthMass FromSecondSqrMillimeterKilograms(double value) => new TimeSqrLengthMass(value * secondsqrmillimeterkilogram_.Factor);
		public double GetValueInSecondSqrMillimeterKilograms() => Value_ / secondsqrmillimeterkilogram_.Factor;
		public static TimeSqrLengthMass FromSecondSqrMeterKilograms(double value, double minValue, double maxValue) => new TimeSqrLengthMass(value * secondsqrmeterkilogram_.Factor, minValue * secondsqrmeterkilogram_.Factor, maxValue * secondsqrmeterkilogram_.Factor);
		public static TimeSqrLengthMass FromSecondSqrMeterKilograms(double value) => new TimeSqrLengthMass(value * secondsqrmeterkilogram_.Factor);
		public double GetValueInSecondSqrMeterKilograms() => Value_ / secondsqrmeterkilogram_.Factor;
		public static TimeSqrLengthMass FromSecondSqrInchKilograms(double value, double minValue, double maxValue) => new TimeSqrLengthMass(value * secondsqrinchkilogram_.Factor, minValue * secondsqrinchkilogram_.Factor, maxValue * secondsqrinchkilogram_.Factor);
		public static TimeSqrLengthMass FromSecondSqrInchKilograms(double value) => new TimeSqrLengthMass(value * secondsqrinchkilogram_.Factor);
		public double GetValueInSecondSqrInchKilograms() => Value_ / secondsqrinchkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeSqrLengthMass timesqrlengthmass, bool throwOnFail=true)
    {
        bool fail = false;
        if (timesqrlengthmass.HasMinValue && timesqrlengthmass.Value_ < timesqrlengthmass.MinValue)
        {
            fail = true;
        }

        if (timesqrlengthmass.HasMaxValue && timesqrlengthmass.Value_ > timesqrlengthmass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeSqrLengthMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
