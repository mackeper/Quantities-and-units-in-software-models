...
#region units
	private static Unit_ kilogrampercentimetersqr_ = new Unit_("KilogramPerCentimeterSqr", "kg/cm²", 1.0);
	private static Unit_ kilogrampermillimetersqr_ = new Unit_("KilogramPerMillimeterSqr", "kg/mm²", 99.99999999999999);
	private static Unit_ kilogrampermetersqr_ = new Unit_("KilogramPerMeterSqr", "kg/m²", 0.0001);
	private static Unit_ kilogramperinchsqr_ = new Unit_("KilogramPerInchSqr", "kg/in²", 0.152587890625);
...
#region comparisons
    ...
    public bool Equals(MassPerLengthSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static MassPerLengthSqr FromKilogramPerCentimeterSqrs(double value, double minValue, double maxValue) => new MassPerLengthSqr(value * kilogrampercentimetersqr_.Factor, minValue * kilogrampercentimetersqr_.Factor, maxValue * kilogrampercentimetersqr_.Factor);
		public static MassPerLengthSqr FromKilogramPerCentimeterSqrs(double value) => new MassPerLengthSqr(value * kilogrampercentimetersqr_.Factor);
		public double GetValueInKilogramPerCentimeterSqrs() => Value_ / kilogrampercentimetersqr_.Factor;
		public static MassPerLengthSqr FromKilogramPerMillimeterSqrs(double value, double minValue, double maxValue) => new MassPerLengthSqr(value * kilogrampermillimetersqr_.Factor, minValue * kilogrampermillimetersqr_.Factor, maxValue * kilogrampermillimetersqr_.Factor);
		public static MassPerLengthSqr FromKilogramPerMillimeterSqrs(double value) => new MassPerLengthSqr(value * kilogrampermillimetersqr_.Factor);
		public double GetValueInKilogramPerMillimeterSqrs() => Value_ / kilogrampermillimetersqr_.Factor;
		public static MassPerLengthSqr FromKilogramPerMeterSqrs(double value, double minValue, double maxValue) => new MassPerLengthSqr(value * kilogrampermetersqr_.Factor, minValue * kilogrampermetersqr_.Factor, maxValue * kilogrampermetersqr_.Factor);
		public static MassPerLengthSqr FromKilogramPerMeterSqrs(double value) => new MassPerLengthSqr(value * kilogrampermetersqr_.Factor);
		public double GetValueInKilogramPerMeterSqrs() => Value_ / kilogrampermetersqr_.Factor;
		public static MassPerLengthSqr FromKilogramPerInchSqrs(double value, double minValue, double maxValue) => new MassPerLengthSqr(value * kilogramperinchsqr_.Factor, minValue * kilogramperinchsqr_.Factor, maxValue * kilogramperinchsqr_.Factor);
		public static MassPerLengthSqr FromKilogramPerInchSqrs(double value) => new MassPerLengthSqr(value * kilogramperinchsqr_.Factor);
		public double GetValueInKilogramPerInchSqrs() => Value_ / kilogramperinchsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(MassPerLengthSqr massperlengthsqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (massperlengthsqr.HasMinValue && massperlengthsqr.Value_ < massperlengthsqr.MinValue)
        {
            fail = true;
        }

        if (massperlengthsqr.HasMaxValue && massperlengthsqr.Value_ > massperlengthsqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("MassPerLengthSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
