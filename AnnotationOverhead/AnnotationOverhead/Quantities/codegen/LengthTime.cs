...
#region units
	private static Unit_ centimetersecond_ = new Unit_("CentimeterSecond", "cm s", 1);
	private static Unit_ millimetersecond_ = new Unit_("MillimeterSecond", "mm s", 0.1);
	private static Unit_ metersecond_ = new Unit_("MeterSecond", "m s", 100);
	private static Unit_ inchsecond_ = new Unit_("InchSecond", "in s", 2.56);
...
#region comparisons
    ...
    public bool Equals(LengthTime other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthTime FromCentimeterSeconds(double value, double minValue, double maxValue) => new LengthTime(value * centimetersecond_.Factor, minValue * centimetersecond_.Factor, maxValue * centimetersecond_.Factor);
		public static LengthTime FromCentimeterSeconds(double value) => new LengthTime(value * centimetersecond_.Factor);
		public double GetValueInCentimeterSeconds() => Value_ / centimetersecond_.Factor;
		public static LengthTime FromMillimeterSeconds(double value, double minValue, double maxValue) => new LengthTime(value * millimetersecond_.Factor, minValue * millimetersecond_.Factor, maxValue * millimetersecond_.Factor);
		public static LengthTime FromMillimeterSeconds(double value) => new LengthTime(value * millimetersecond_.Factor);
		public double GetValueInMillimeterSeconds() => Value_ / millimetersecond_.Factor;
		public static LengthTime FromMeterSeconds(double value, double minValue, double maxValue) => new LengthTime(value * metersecond_.Factor, minValue * metersecond_.Factor, maxValue * metersecond_.Factor);
		public static LengthTime FromMeterSeconds(double value) => new LengthTime(value * metersecond_.Factor);
		public double GetValueInMeterSeconds() => Value_ / metersecond_.Factor;
		public static LengthTime FromInchSeconds(double value, double minValue, double maxValue) => new LengthTime(value * inchsecond_.Factor, minValue * inchsecond_.Factor, maxValue * inchsecond_.Factor);
		public static LengthTime FromInchSeconds(double value) => new LengthTime(value * inchsecond_.Factor);
		public double GetValueInInchSeconds() => Value_ / inchsecond_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthTime lengthtime, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthtime.HasMinValue && lengthtime.Value_ < lengthtime.MinValue)
        {
            fail = true;
        }

        if (lengthtime.HasMaxValue && lengthtime.Value_ > lengthtime.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthTime is outside its bounds.");
        }
        else if (fail)
        {
            return false;
