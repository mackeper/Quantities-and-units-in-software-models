...
#region units
	private static Unit_ centimetersqrkilogramsecond_ = new Unit_("CentimeterSqrKilogramSecond", "cm� kg s", 1);
	private static Unit_ millimetersqrkilogramsecond_ = new Unit_("MillimeterSqrKilogramSecond", "mm� kg s", 0.010000000000000002);
	private static Unit_ metersqrkilogramsecond_ = new Unit_("MeterSqrKilogramSecond", "m� kg s", 10000);
	private static Unit_ inchsqrkilogramsecond_ = new Unit_("InchSqrKilogramSecond", "in� kg s", 6.5536);
...
#region comparisons
    ...
    public bool Equals(LengthSqrMassTime other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthSqrMassTime FromCentimeterSqrKilogramSeconds(double value, double minValue, double maxValue) => new LengthSqrMassTime(value * centimetersqrkilogramsecond_.Factor, minValue * centimetersqrkilogramsecond_.Factor, maxValue * centimetersqrkilogramsecond_.Factor);
		public static LengthSqrMassTime FromCentimeterSqrKilogramSeconds(double value) => new LengthSqrMassTime(value * centimetersqrkilogramsecond_.Factor);
		public double GetValueInCentimeterSqrKilogramSeconds() => Value_ / centimetersqrkilogramsecond_.Factor;
		public static LengthSqrMassTime FromMillimeterSqrKilogramSeconds(double value, double minValue, double maxValue) => new LengthSqrMassTime(value * millimetersqrkilogramsecond_.Factor, minValue * millimetersqrkilogramsecond_.Factor, maxValue * millimetersqrkilogramsecond_.Factor);
		public static LengthSqrMassTime FromMillimeterSqrKilogramSeconds(double value) => new LengthSqrMassTime(value * millimetersqrkilogramsecond_.Factor);
		public double GetValueInMillimeterSqrKilogramSeconds() => Value_ / millimetersqrkilogramsecond_.Factor;
		public static LengthSqrMassTime FromMeterSqrKilogramSeconds(double value, double minValue, double maxValue) => new LengthSqrMassTime(value * metersqrkilogramsecond_.Factor, minValue * metersqrkilogramsecond_.Factor, maxValue * metersqrkilogramsecond_.Factor);
		public static LengthSqrMassTime FromMeterSqrKilogramSeconds(double value) => new LengthSqrMassTime(value * metersqrkilogramsecond_.Factor);
		public double GetValueInMeterSqrKilogramSeconds() => Value_ / metersqrkilogramsecond_.Factor;
		public static LengthSqrMassTime FromInchSqrKilogramSeconds(double value, double minValue, double maxValue) => new LengthSqrMassTime(value * inchsqrkilogramsecond_.Factor, minValue * inchsqrkilogramsecond_.Factor, maxValue * inchsqrkilogramsecond_.Factor);
		public static LengthSqrMassTime FromInchSqrKilogramSeconds(double value) => new LengthSqrMassTime(value * inchsqrkilogramsecond_.Factor);
		public double GetValueInInchSqrKilogramSeconds() => Value_ / inchsqrkilogramsecond_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthSqrMassTime lengthsqrmasstime, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthsqrmasstime.HasMinValue && lengthsqrmasstime.Value_ < lengthsqrmasstime.MinValue)
        {
            fail = true;
        }

        if (lengthsqrmasstime.HasMaxValue && lengthsqrmasstime.Value_ > lengthsqrmasstime.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthSqrMassTime is outside its bounds.");
        }
        else if (fail)
        {
            return false;
