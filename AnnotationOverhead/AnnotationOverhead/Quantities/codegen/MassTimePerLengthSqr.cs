...
#region units
	private static Unit_ kilogramsecondpercentimetersqr_ = new Unit_("KilogramSecondPerCentimeterSqr", "kg s/cm²", 1.0);
	private static Unit_ kilogramsecondpermillimetersqr_ = new Unit_("KilogramSecondPerMillimeterSqr", "kg s/mm²", 99.99999999999999);
	private static Unit_ kilogramsecondpermetersqr_ = new Unit_("KilogramSecondPerMeterSqr", "kg s/m²", 0.0001);
	private static Unit_ kilogramsecondperinchsqr_ = new Unit_("KilogramSecondPerInchSqr", "kg s/in²", 0.152587890625);
...
#region comparisons
    ...
    public bool Equals(MassTimePerLengthSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static MassTimePerLengthSqr FromKilogramSecondPerCentimeterSqrs(double value, double minValue, double maxValue) => new MassTimePerLengthSqr(value * kilogramsecondpercentimetersqr_.Factor, minValue * kilogramsecondpercentimetersqr_.Factor, maxValue * kilogramsecondpercentimetersqr_.Factor);
		public static MassTimePerLengthSqr FromKilogramSecondPerCentimeterSqrs(double value) => new MassTimePerLengthSqr(value * kilogramsecondpercentimetersqr_.Factor);
		public double GetValueInKilogramSecondPerCentimeterSqrs() => Value_ / kilogramsecondpercentimetersqr_.Factor;
		public static MassTimePerLengthSqr FromKilogramSecondPerMillimeterSqrs(double value, double minValue, double maxValue) => new MassTimePerLengthSqr(value * kilogramsecondpermillimetersqr_.Factor, minValue * kilogramsecondpermillimetersqr_.Factor, maxValue * kilogramsecondpermillimetersqr_.Factor);
		public static MassTimePerLengthSqr FromKilogramSecondPerMillimeterSqrs(double value) => new MassTimePerLengthSqr(value * kilogramsecondpermillimetersqr_.Factor);
		public double GetValueInKilogramSecondPerMillimeterSqrs() => Value_ / kilogramsecondpermillimetersqr_.Factor;
		public static MassTimePerLengthSqr FromKilogramSecondPerMeterSqrs(double value, double minValue, double maxValue) => new MassTimePerLengthSqr(value * kilogramsecondpermetersqr_.Factor, minValue * kilogramsecondpermetersqr_.Factor, maxValue * kilogramsecondpermetersqr_.Factor);
		public static MassTimePerLengthSqr FromKilogramSecondPerMeterSqrs(double value) => new MassTimePerLengthSqr(value * kilogramsecondpermetersqr_.Factor);
		public double GetValueInKilogramSecondPerMeterSqrs() => Value_ / kilogramsecondpermetersqr_.Factor;
		public static MassTimePerLengthSqr FromKilogramSecondPerInchSqrs(double value, double minValue, double maxValue) => new MassTimePerLengthSqr(value * kilogramsecondperinchsqr_.Factor, minValue * kilogramsecondperinchsqr_.Factor, maxValue * kilogramsecondperinchsqr_.Factor);
		public static MassTimePerLengthSqr FromKilogramSecondPerInchSqrs(double value) => new MassTimePerLengthSqr(value * kilogramsecondperinchsqr_.Factor);
		public double GetValueInKilogramSecondPerInchSqrs() => Value_ / kilogramsecondperinchsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(MassTimePerLengthSqr masstimeperlengthsqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (masstimeperlengthsqr.HasMinValue && masstimeperlengthsqr.Value_ < masstimeperlengthsqr.MinValue)
        {
            fail = true;
        }

        if (masstimeperlengthsqr.HasMaxValue && masstimeperlengthsqr.Value_ > masstimeperlengthsqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("MassTimePerLengthSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
