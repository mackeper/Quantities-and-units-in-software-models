...
#region units
	private static Unit_ centimeterperkilogram_ = new Unit_("CentimeterPerKilogram", "cm/kg", 1.0);
	private static Unit_ millimeterperkilogram_ = new Unit_("MillimeterPerKilogram", "mm/kg", 0.1);
	private static Unit_ meterperkilogram_ = new Unit_("MeterPerKilogram", "m/kg", 100.0);
	private static Unit_ inchperkilogram_ = new Unit_("InchPerKilogram", "in/kg", 2.56);
...
#region comparisons
    ...
    public bool Equals(LengthPerMass other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthPerMass FromCentimeterPerKilograms(double value, double minValue, double maxValue) => new LengthPerMass(value * centimeterperkilogram_.Factor, minValue * centimeterperkilogram_.Factor, maxValue * centimeterperkilogram_.Factor);
		public static LengthPerMass FromCentimeterPerKilograms(double value) => new LengthPerMass(value * centimeterperkilogram_.Factor);
		public double GetValueInCentimeterPerKilograms() => Value_ / centimeterperkilogram_.Factor;
		public static LengthPerMass FromMillimeterPerKilograms(double value, double minValue, double maxValue) => new LengthPerMass(value * millimeterperkilogram_.Factor, minValue * millimeterperkilogram_.Factor, maxValue * millimeterperkilogram_.Factor);
		public static LengthPerMass FromMillimeterPerKilograms(double value) => new LengthPerMass(value * millimeterperkilogram_.Factor);
		public double GetValueInMillimeterPerKilograms() => Value_ / millimeterperkilogram_.Factor;
		public static LengthPerMass FromMeterPerKilograms(double value, double minValue, double maxValue) => new LengthPerMass(value * meterperkilogram_.Factor, minValue * meterperkilogram_.Factor, maxValue * meterperkilogram_.Factor);
		public static LengthPerMass FromMeterPerKilograms(double value) => new LengthPerMass(value * meterperkilogram_.Factor);
		public double GetValueInMeterPerKilograms() => Value_ / meterperkilogram_.Factor;
		public static LengthPerMass FromInchPerKilograms(double value, double minValue, double maxValue) => new LengthPerMass(value * inchperkilogram_.Factor, minValue * inchperkilogram_.Factor, maxValue * inchperkilogram_.Factor);
		public static LengthPerMass FromInchPerKilograms(double value) => new LengthPerMass(value * inchperkilogram_.Factor);
		public double GetValueInInchPerKilograms() => Value_ / inchperkilogram_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthPerMass lengthpermass, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthpermass.HasMinValue && lengthpermass.Value_ < lengthpermass.MinValue)
        {
            fail = true;
        }

        if (lengthpermass.HasMaxValue && lengthpermass.Value_ > lengthpermass.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthPerMass is outside its bounds.");
        }
        else if (fail)
        {
            return false;
