...
#region units
	private static Unit_ centimetersqr_ = new Unit_("CentimeterSqr", "cm²", 1);
	private static Unit_ millimetersqr_ = new Unit_("MillimeterSqr", "mm²", 0.010000000000000002);
	private static Unit_ metersqr_ = new Unit_("MeterSqr", "m²", 10000);
	private static Unit_ inchsqr_ = new Unit_("InchSqr", "in²", 6.5536);
...
#region comparisons
    ...
    public bool Equals(Area other) => other is object && Equals((object)other);
...
#region conversions
		public static Area FromCentimeterSqrs(double value, double minValue, double maxValue) => new Area(value * centimetersqr_.Factor, minValue * centimetersqr_.Factor, maxValue * centimetersqr_.Factor);
		public static Area FromCentimeterSqrs(double value) => new Area(value * centimetersqr_.Factor);
		public double GetValueInCentimeterSqrs() => Value_ / centimetersqr_.Factor;
		public static Area FromMillimeterSqrs(double value, double minValue, double maxValue) => new Area(value * millimetersqr_.Factor, minValue * millimetersqr_.Factor, maxValue * millimetersqr_.Factor);
		public static Area FromMillimeterSqrs(double value) => new Area(value * millimetersqr_.Factor);
		public double GetValueInMillimeterSqrs() => Value_ / millimetersqr_.Factor;
		public static Area FromMeterSqrs(double value, double minValue, double maxValue) => new Area(value * metersqr_.Factor, minValue * metersqr_.Factor, maxValue * metersqr_.Factor);
		public static Area FromMeterSqrs(double value) => new Area(value * metersqr_.Factor);
		public double GetValueInMeterSqrs() => Value_ / metersqr_.Factor;
		public static Area FromInchSqrs(double value, double minValue, double maxValue) => new Area(value * inchsqr_.Factor, minValue * inchsqr_.Factor, maxValue * inchsqr_.Factor);
		public static Area FromInchSqrs(double value) => new Area(value * inchsqr_.Factor);
		public double GetValueInInchSqrs() => Value_ / inchsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(Area area, bool throwOnFail=true)
    {
        bool fail = false;
        if (area.HasMinValue && area.Value_ < area.MinValue)
        {
            fail = true;
        }

        if (area.HasMaxValue && area.Value_ > area.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("Area is outside its bounds.");
        }
        else if (fail)
        {
            return false;
