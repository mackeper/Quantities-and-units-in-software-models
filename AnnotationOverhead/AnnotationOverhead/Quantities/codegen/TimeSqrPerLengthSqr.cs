...
#region units
	private static Unit_ secondsqrpercentimetersqr_ = new Unit_("SecondSqrPerCentimeterSqr", "s²/cm²", 1.0);
	private static Unit_ secondsqrpermillimetersqr_ = new Unit_("SecondSqrPerMillimeterSqr", "s²/mm²", 99.99999999999999);
	private static Unit_ secondsqrpermetersqr_ = new Unit_("SecondSqrPerMeterSqr", "s²/m²", 0.0001);
	private static Unit_ secondsqrperinchsqr_ = new Unit_("SecondSqrPerInchSqr", "s²/in²", 0.152587890625);
...
#region comparisons
    ...
    public bool Equals(TimeSqrPerLengthSqr other) => other is object && Equals((object)other);
...
#region conversions
		public static TimeSqrPerLengthSqr FromSecondSqrPerCentimeterSqrs(double value, double minValue, double maxValue) => new TimeSqrPerLengthSqr(value * secondsqrpercentimetersqr_.Factor, minValue * secondsqrpercentimetersqr_.Factor, maxValue * secondsqrpercentimetersqr_.Factor);
		public static TimeSqrPerLengthSqr FromSecondSqrPerCentimeterSqrs(double value) => new TimeSqrPerLengthSqr(value * secondsqrpercentimetersqr_.Factor);
		public double GetValueInSecondSqrPerCentimeterSqrs() => Value_ / secondsqrpercentimetersqr_.Factor;
		public static TimeSqrPerLengthSqr FromSecondSqrPerMillimeterSqrs(double value, double minValue, double maxValue) => new TimeSqrPerLengthSqr(value * secondsqrpermillimetersqr_.Factor, minValue * secondsqrpermillimetersqr_.Factor, maxValue * secondsqrpermillimetersqr_.Factor);
		public static TimeSqrPerLengthSqr FromSecondSqrPerMillimeterSqrs(double value) => new TimeSqrPerLengthSqr(value * secondsqrpermillimetersqr_.Factor);
		public double GetValueInSecondSqrPerMillimeterSqrs() => Value_ / secondsqrpermillimetersqr_.Factor;
		public static TimeSqrPerLengthSqr FromSecondSqrPerMeterSqrs(double value, double minValue, double maxValue) => new TimeSqrPerLengthSqr(value * secondsqrpermetersqr_.Factor, minValue * secondsqrpermetersqr_.Factor, maxValue * secondsqrpermetersqr_.Factor);
		public static TimeSqrPerLengthSqr FromSecondSqrPerMeterSqrs(double value) => new TimeSqrPerLengthSqr(value * secondsqrpermetersqr_.Factor);
		public double GetValueInSecondSqrPerMeterSqrs() => Value_ / secondsqrpermetersqr_.Factor;
		public static TimeSqrPerLengthSqr FromSecondSqrPerInchSqrs(double value, double minValue, double maxValue) => new TimeSqrPerLengthSqr(value * secondsqrperinchsqr_.Factor, minValue * secondsqrperinchsqr_.Factor, maxValue * secondsqrperinchsqr_.Factor);
		public static TimeSqrPerLengthSqr FromSecondSqrPerInchSqrs(double value) => new TimeSqrPerLengthSqr(value * secondsqrperinchsqr_.Factor);
		public double GetValueInSecondSqrPerInchSqrs() => Value_ / secondsqrperinchsqr_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(TimeSqrPerLengthSqr timesqrperlengthsqr, bool throwOnFail=true)
    {
        bool fail = false;
        if (timesqrperlengthsqr.HasMinValue && timesqrperlengthsqr.Value_ < timesqrperlengthsqr.MinValue)
        {
            fail = true;
        }

        if (timesqrperlengthsqr.HasMaxValue && timesqrperlengthsqr.Value_ > timesqrperlengthsqr.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("TimeSqrPerLengthSqr is outside its bounds.");
        }
        else if (fail)
        {
            return false;
