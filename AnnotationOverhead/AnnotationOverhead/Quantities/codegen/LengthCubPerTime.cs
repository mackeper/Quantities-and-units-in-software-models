...
#region units
	private static Unit_ centimetercubpersecond_ = new Unit_("CentimeterCubPerSecond", "cm³/s", 1.0);
	private static Unit_ millimetercubpersecond_ = new Unit_("MillimeterCubPerSecond", "mm³/s", 0.0010000000000000002);
	private static Unit_ metercubpersecond_ = new Unit_("MeterCubPerSecond", "m³/s", 1000000.0);
	private static Unit_ inchcubpersecond_ = new Unit_("InchCubPerSecond", "in³/s", 16.777216000000003);
...
#region comparisons
    ...
    public bool Equals(LengthCubPerTime other) => other is object && Equals((object)other);
...
#region conversions
		public static LengthCubPerTime FromCentimeterCubPerSeconds(double value, double minValue, double maxValue) => new LengthCubPerTime(value * centimetercubpersecond_.Factor, minValue * centimetercubpersecond_.Factor, maxValue * centimetercubpersecond_.Factor);
		public static LengthCubPerTime FromCentimeterCubPerSeconds(double value) => new LengthCubPerTime(value * centimetercubpersecond_.Factor);
		public double GetValueInCentimeterCubPerSeconds() => Value_ / centimetercubpersecond_.Factor;
		public static LengthCubPerTime FromMillimeterCubPerSeconds(double value, double minValue, double maxValue) => new LengthCubPerTime(value * millimetercubpersecond_.Factor, minValue * millimetercubpersecond_.Factor, maxValue * millimetercubpersecond_.Factor);
		public static LengthCubPerTime FromMillimeterCubPerSeconds(double value) => new LengthCubPerTime(value * millimetercubpersecond_.Factor);
		public double GetValueInMillimeterCubPerSeconds() => Value_ / millimetercubpersecond_.Factor;
		public static LengthCubPerTime FromMeterCubPerSeconds(double value, double minValue, double maxValue) => new LengthCubPerTime(value * metercubpersecond_.Factor, minValue * metercubpersecond_.Factor, maxValue * metercubpersecond_.Factor);
		public static LengthCubPerTime FromMeterCubPerSeconds(double value) => new LengthCubPerTime(value * metercubpersecond_.Factor);
		public double GetValueInMeterCubPerSeconds() => Value_ / metercubpersecond_.Factor;
		public static LengthCubPerTime FromInchCubPerSeconds(double value, double minValue, double maxValue) => new LengthCubPerTime(value * inchcubpersecond_.Factor, minValue * inchcubpersecond_.Factor, maxValue * inchcubpersecond_.Factor);
		public static LengthCubPerTime FromInchCubPerSeconds(double value) => new LengthCubPerTime(value * inchcubpersecond_.Factor);
		public double GetValueInInchCubPerSeconds() => Value_ / inchcubpersecond_.Factor;
...
#region rules
    ...
    public static bool ValidateRules(LengthCubPerTime lengthcubpertime, bool throwOnFail=true)
    {
        bool fail = false;
        if (lengthcubpertime.HasMinValue && lengthcubpertime.Value_ < lengthcubpertime.MinValue)
        {
            fail = true;
        }

        if (lengthcubpertime.HasMaxValue && lengthcubpertime.Value_ > lengthcubpertime.MaxValue)
        {
            fail = true;
        }
        ...
        if (fail && throwOnFail)
        {
            new System.ArgumentException("LengthCubPerTime is outside its bounds.");
        }
        else if (fail)
        {
            return false;
