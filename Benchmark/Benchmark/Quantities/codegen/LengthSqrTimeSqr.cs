...
#region units
  private static Unit_ centimetersqrsecondsqr_ = new Unit_("CentimeterSqrSecondSqr", "cm² s²", 1, 0);
  private static Unit_ millimetersqrsecondsqr_ = new Unit_("MillimeterSqrSecondSqr", "mm² s²", 0.010000000000000002, 0);
  private static Unit_ metersqrsecondsqr_ = new Unit_("MeterSqrSecondSqr", "m² s²", 10000, 0);
  private static Unit_ inchsqrsecondsqr_ = new Unit_("InchSqrSecondSqr", "in² s²", 6.5536, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is LengthSqrTimeSqr other && Equals(other);
  public bool Equals(LengthSqrTimeSqr other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static LengthSqrTimeSqr FromCentimeterSqrSecondSqrs(double value, double minValue, double maxValue) => new LengthSqrTimeSqr((value + centimetersqrsecondsqr_.Offset) * centimetersqrsecondsqr_.Factor, minValue * centimetersqrsecondsqr_.Factor, maxValue * centimetersqrsecondsqr_.Factor);
  public static LengthSqrTimeSqr FromCentimeterSqrSecondSqrs(double value) => new LengthSqrTimeSqr((value + centimetersqrsecondsqr_.Offset) * centimetersqrsecondsqr_.Factor);
  public double GetValueInCentimeterSqrSecondSqrs() => (Value_ - centimetersqrsecondsqr_.Offset) / centimetersqrsecondsqr_.Factor;
  public static LengthSqrTimeSqr FromMillimeterSqrSecondSqrs(double value, double minValue, double maxValue) => new LengthSqrTimeSqr((value + millimetersqrsecondsqr_.Offset) * millimetersqrsecondsqr_.Factor, minValue * millimetersqrsecondsqr_.Factor, maxValue * millimetersqrsecondsqr_.Factor);
  public static LengthSqrTimeSqr FromMillimeterSqrSecondSqrs(double value) => new LengthSqrTimeSqr((value + millimetersqrsecondsqr_.Offset) * millimetersqrsecondsqr_.Factor);
  public double GetValueInMillimeterSqrSecondSqrs() => (Value_ - millimetersqrsecondsqr_.Offset) / millimetersqrsecondsqr_.Factor;
  public static LengthSqrTimeSqr FromMeterSqrSecondSqrs(double value, double minValue, double maxValue) => new LengthSqrTimeSqr((value + metersqrsecondsqr_.Offset) * metersqrsecondsqr_.Factor, minValue * metersqrsecondsqr_.Factor, maxValue * metersqrsecondsqr_.Factor);
  public static LengthSqrTimeSqr FromMeterSqrSecondSqrs(double value) => new LengthSqrTimeSqr((value + metersqrsecondsqr_.Offset) * metersqrsecondsqr_.Factor);
  public double GetValueInMeterSqrSecondSqrs() => (Value_ - metersqrsecondsqr_.Offset) / metersqrsecondsqr_.Factor;
  public static LengthSqrTimeSqr FromInchSqrSecondSqrs(double value, double minValue, double maxValue) => new LengthSqrTimeSqr((value + inchsqrsecondsqr_.Offset) * inchsqrsecondsqr_.Factor, minValue * inchsqrsecondsqr_.Factor, maxValue * inchsqrsecondsqr_.Factor);
  public static LengthSqrTimeSqr FromInchSqrSecondSqrs(double value) => new LengthSqrTimeSqr((value + inchsqrsecondsqr_.Offset) * inchsqrsecondsqr_.Factor);
  public double GetValueInInchSqrSecondSqrs() => (Value_ - inchsqrsecondsqr_.Offset) / inchsqrsecondsqr_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("LengthSqrTimeSqr is outside its bounds.");
    }
    else if (fail)
    {
      return false;
