...
#region units
  private static Unit_ kilogrampercentimetersecond_ = new Unit_("KilogramPerCentimeterSecond", "kg/cm s", 1.0, 0);
  private static Unit_ kilogrampermillimetersecond_ = new Unit_("KilogramPerMillimeterSecond", "kg/mm s", 10.0, 0);
  private static Unit_ kilogrampermetersecond_ = new Unit_("KilogramPerMeterSecond", "kg/m s", 0.01, 0);
  private static Unit_ kilogramperinchsecond_ = new Unit_("KilogramPerInchSecond", "kg/in s", 0.390625, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is MassPerLengthTime other && Equals(other);
  public bool Equals(MassPerLengthTime other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static MassPerLengthTime FromKilogramPerCentimeterSeconds(double value, double minValue, double maxValue) => new MassPerLengthTime((value + kilogrampercentimetersecond_.Offset) * kilogrampercentimetersecond_.Factor, minValue * kilogrampercentimetersecond_.Factor, maxValue * kilogrampercentimetersecond_.Factor);
  public static MassPerLengthTime FromKilogramPerCentimeterSeconds(double value) => new MassPerLengthTime((value + kilogrampercentimetersecond_.Offset) * kilogrampercentimetersecond_.Factor);
  public double GetValueInKilogramPerCentimeterSeconds() => (Value_ - kilogrampercentimetersecond_.Offset) / kilogrampercentimetersecond_.Factor;
  public static MassPerLengthTime FromKilogramPerMillimeterSeconds(double value, double minValue, double maxValue) => new MassPerLengthTime((value + kilogrampermillimetersecond_.Offset) * kilogrampermillimetersecond_.Factor, minValue * kilogrampermillimetersecond_.Factor, maxValue * kilogrampermillimetersecond_.Factor);
  public static MassPerLengthTime FromKilogramPerMillimeterSeconds(double value) => new MassPerLengthTime((value + kilogrampermillimetersecond_.Offset) * kilogrampermillimetersecond_.Factor);
  public double GetValueInKilogramPerMillimeterSeconds() => (Value_ - kilogrampermillimetersecond_.Offset) / kilogrampermillimetersecond_.Factor;
  public static MassPerLengthTime FromKilogramPerMeterSeconds(double value, double minValue, double maxValue) => new MassPerLengthTime((value + kilogrampermetersecond_.Offset) * kilogrampermetersecond_.Factor, minValue * kilogrampermetersecond_.Factor, maxValue * kilogrampermetersecond_.Factor);
  public static MassPerLengthTime FromKilogramPerMeterSeconds(double value) => new MassPerLengthTime((value + kilogrampermetersecond_.Offset) * kilogrampermetersecond_.Factor);
  public double GetValueInKilogramPerMeterSeconds() => (Value_ - kilogrampermetersecond_.Offset) / kilogrampermetersecond_.Factor;
  public static MassPerLengthTime FromKilogramPerInchSeconds(double value, double minValue, double maxValue) => new MassPerLengthTime((value + kilogramperinchsecond_.Offset) * kilogramperinchsecond_.Factor, minValue * kilogramperinchsecond_.Factor, maxValue * kilogramperinchsecond_.Factor);
  public static MassPerLengthTime FromKilogramPerInchSeconds(double value) => new MassPerLengthTime((value + kilogramperinchsecond_.Offset) * kilogramperinchsecond_.Factor);
  public double GetValueInKilogramPerInchSeconds() => (Value_ - kilogramperinchsecond_.Offset) / kilogramperinchsecond_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("MassPerLengthTime is outside its bounds.");
    }
    else if (fail)
    {
      return false;
