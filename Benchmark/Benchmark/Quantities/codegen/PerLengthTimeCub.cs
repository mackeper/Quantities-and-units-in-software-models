...
#region units
  private static Unit_ percentimetersecondcub_ = new Unit_("PerCentimeterSecondCub", "/cm s�", 1.0, 0);
  private static Unit_ permillimetersecondcub_ = new Unit_("PerMillimeterSecondCub", "/mm s�", 0.1, 0);
  private static Unit_ permetersecondcub_ = new Unit_("PerMeterSecondCub", "/m s�", 100.0, 0);
  private static Unit_ perinchsecondcub_ = new Unit_("PerInchSecondCub", "/in s�", 2.56, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is PerLengthTimeCub other && Equals(other);
  public bool Equals(PerLengthTimeCub other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static PerLengthTimeCub FromPerCentimeterSecondCubs(double value, double minValue, double maxValue) => new PerLengthTimeCub((value + percentimetersecondcub_.Offset) * percentimetersecondcub_.Factor, minValue * percentimetersecondcub_.Factor, maxValue * percentimetersecondcub_.Factor);
  public static PerLengthTimeCub FromPerCentimeterSecondCubs(double value) => new PerLengthTimeCub((value + percentimetersecondcub_.Offset) * percentimetersecondcub_.Factor);
  public double GetValueInPerCentimeterSecondCubs() => (Value_ - percentimetersecondcub_.Offset) / percentimetersecondcub_.Factor;
  public static PerLengthTimeCub FromPerMillimeterSecondCubs(double value, double minValue, double maxValue) => new PerLengthTimeCub((value + permillimetersecondcub_.Offset) * permillimetersecondcub_.Factor, minValue * permillimetersecondcub_.Factor, maxValue * permillimetersecondcub_.Factor);
  public static PerLengthTimeCub FromPerMillimeterSecondCubs(double value) => new PerLengthTimeCub((value + permillimetersecondcub_.Offset) * permillimetersecondcub_.Factor);
  public double GetValueInPerMillimeterSecondCubs() => (Value_ - permillimetersecondcub_.Offset) / permillimetersecondcub_.Factor;
  public static PerLengthTimeCub FromPerMeterSecondCubs(double value, double minValue, double maxValue) => new PerLengthTimeCub((value + permetersecondcub_.Offset) * permetersecondcub_.Factor, minValue * permetersecondcub_.Factor, maxValue * permetersecondcub_.Factor);
  public static PerLengthTimeCub FromPerMeterSecondCubs(double value) => new PerLengthTimeCub((value + permetersecondcub_.Offset) * permetersecondcub_.Factor);
  public double GetValueInPerMeterSecondCubs() => (Value_ - permetersecondcub_.Offset) / permetersecondcub_.Factor;
  public static PerLengthTimeCub FromPerInchSecondCubs(double value, double minValue, double maxValue) => new PerLengthTimeCub((value + perinchsecondcub_.Offset) * perinchsecondcub_.Factor, minValue * perinchsecondcub_.Factor, maxValue * perinchsecondcub_.Factor);
  public static PerLengthTimeCub FromPerInchSecondCubs(double value) => new PerLengthTimeCub((value + perinchsecondcub_.Offset) * perinchsecondcub_.Factor);
  public double GetValueInPerInchSecondCubs() => (Value_ - perinchsecondcub_.Offset) / perinchsecondcub_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("PerLengthTimeCub is outside its bounds.");
    }
    else if (fail)
    {
      return false;
