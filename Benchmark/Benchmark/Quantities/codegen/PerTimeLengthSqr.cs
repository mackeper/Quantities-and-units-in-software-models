...
namespace RayQuantities
{
  ...
  {  
    ...
    if (!displayUnitIsImported_ && FakeDatabase.Units.ContainsKey("PerTimeLengthSqr"))
    {
      ...
      {
        case "persecondcentimetersqr": displayUnit_ = persecondcentimetersqr_; break;
        case "persecondmillimetersqr": displayUnit_ = persecondmillimetersqr_; break;
        case "persecondmetersqr": displayUnit_ = persecondmetersqr_; break;
        case "persecondinchsqr": displayUnit_ = persecondinchsqr_; break;
...
#region units
  private static Unit_ persecondcentimetersqr_ = new Unit_("PerSecondCentimeterSqr", "/s cm²", 1.0, 0);
  private static Unit_ persecondmillimetersqr_ = new Unit_("PerSecondMillimeterSqr", "/s mm²", 99.99999999999999, 0);
  private static Unit_ persecondmetersqr_ = new Unit_("PerSecondMeterSqr", "/s m²", 0.0001, 0);
  private static Unit_ persecondinchsqr_ = new Unit_("PerSecondInchSqr", "/s in²", 0.152587890625, 0);
  private static Unit_ platformUnit_ = persecondcentimetersqr_;
  private static Unit_ displayUnit_ = persecondcentimetersqr_;
#endregion

#region comparisons

  public override int GetHashCode() => base.GetHashCode();
  public override bool Equals(Object obj) => obj is PerTimeLengthSqr other && Equals(other);
  public bool Equals(PerTimeLengthSqr other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static PerTimeLengthSqr FromPerSecondCentimeterSqrs(double value, double minValue, double maxValue) => new PerTimeLengthSqr((value + persecondcentimetersqr_.Offset) * persecondcentimetersqr_.Factor, minValue * persecondcentimetersqr_.Factor, maxValue * persecondcentimetersqr_.Factor);
  public static PerTimeLengthSqr FromPerSecondCentimeterSqrs(double value) => new PerTimeLengthSqr((value + persecondcentimetersqr_.Offset) * persecondcentimetersqr_.Factor);
  public double GetValueInPerSecondCentimeterSqrs() => (Value_ - persecondcentimetersqr_.Offset) / persecondcentimetersqr_.Factor;
  public static PerTimeLengthSqr FromPerSecondMillimeterSqrs(double value, double minValue, double maxValue) => new PerTimeLengthSqr((value + persecondmillimetersqr_.Offset) * persecondmillimetersqr_.Factor, minValue * persecondmillimetersqr_.Factor, maxValue * persecondmillimetersqr_.Factor);
  public static PerTimeLengthSqr FromPerSecondMillimeterSqrs(double value) => new PerTimeLengthSqr((value + persecondmillimetersqr_.Offset) * persecondmillimetersqr_.Factor);
  public double GetValueInPerSecondMillimeterSqrs() => (Value_ - persecondmillimetersqr_.Offset) / persecondmillimetersqr_.Factor;
  public static PerTimeLengthSqr FromPerSecondMeterSqrs(double value, double minValue, double maxValue) => new PerTimeLengthSqr((value + persecondmetersqr_.Offset) * persecondmetersqr_.Factor, minValue * persecondmetersqr_.Factor, maxValue * persecondmetersqr_.Factor);
  public static PerTimeLengthSqr FromPerSecondMeterSqrs(double value) => new PerTimeLengthSqr((value + persecondmetersqr_.Offset) * persecondmetersqr_.Factor);
  public double GetValueInPerSecondMeterSqrs() => (Value_ - persecondmetersqr_.Offset) / persecondmetersqr_.Factor;
  public static PerTimeLengthSqr FromPerSecondInchSqrs(double value, double minValue, double maxValue) => new PerTimeLengthSqr((value + persecondinchsqr_.Offset) * persecondinchsqr_.Factor, minValue * persecondinchsqr_.Factor, maxValue * persecondinchsqr_.Factor);
  public static PerTimeLengthSqr FromPerSecondInchSqrs(double value) => new PerTimeLengthSqr((value + persecondinchsqr_.Offset) * persecondinchsqr_.Factor);
  public double GetValueInPerSecondInchSqrs() => (Value_ - persecondinchsqr_.Offset) / persecondinchsqr_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("PerTimeLengthSqr is outside its bounds.");
    }
    else if (fail)
    {
      return false;
