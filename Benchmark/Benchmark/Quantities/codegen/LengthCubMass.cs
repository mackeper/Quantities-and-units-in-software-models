...
#region units
  private static Unit_ centimetercubkilogram_ = new Unit_("CentimeterCubKilogram", "cm³ kg", 1, 0);
  private static Unit_ millimetercubkilogram_ = new Unit_("MillimeterCubKilogram", "mm³ kg", 0.0010000000000000002, 0);
  private static Unit_ metercubkilogram_ = new Unit_("MeterCubKilogram", "m³ kg", 1000000, 0);
  private static Unit_ inchcubkilogram_ = new Unit_("InchCubKilogram", "in³ kg", 16.777216000000003, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is LengthCubMass other && Equals(other);
  public bool Equals(LengthCubMass other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static LengthCubMass FromCentimeterCubKilograms(double value, double minValue, double maxValue) => new LengthCubMass((value + centimetercubkilogram_.Offset) * centimetercubkilogram_.Factor, minValue * centimetercubkilogram_.Factor, maxValue * centimetercubkilogram_.Factor);
  public static LengthCubMass FromCentimeterCubKilograms(double value) => new LengthCubMass((value + centimetercubkilogram_.Offset) * centimetercubkilogram_.Factor);
  public double GetValueInCentimeterCubKilograms() => (Value_ - centimetercubkilogram_.Offset) / centimetercubkilogram_.Factor;
  public static LengthCubMass FromMillimeterCubKilograms(double value, double minValue, double maxValue) => new LengthCubMass((value + millimetercubkilogram_.Offset) * millimetercubkilogram_.Factor, minValue * millimetercubkilogram_.Factor, maxValue * millimetercubkilogram_.Factor);
  public static LengthCubMass FromMillimeterCubKilograms(double value) => new LengthCubMass((value + millimetercubkilogram_.Offset) * millimetercubkilogram_.Factor);
  public double GetValueInMillimeterCubKilograms() => (Value_ - millimetercubkilogram_.Offset) / millimetercubkilogram_.Factor;
  public static LengthCubMass FromMeterCubKilograms(double value, double minValue, double maxValue) => new LengthCubMass((value + metercubkilogram_.Offset) * metercubkilogram_.Factor, minValue * metercubkilogram_.Factor, maxValue * metercubkilogram_.Factor);
  public static LengthCubMass FromMeterCubKilograms(double value) => new LengthCubMass((value + metercubkilogram_.Offset) * metercubkilogram_.Factor);
  public double GetValueInMeterCubKilograms() => (Value_ - metercubkilogram_.Offset) / metercubkilogram_.Factor;
  public static LengthCubMass FromInchCubKilograms(double value, double minValue, double maxValue) => new LengthCubMass((value + inchcubkilogram_.Offset) * inchcubkilogram_.Factor, minValue * inchcubkilogram_.Factor, maxValue * inchcubkilogram_.Factor);
  public static LengthCubMass FromInchCubKilograms(double value) => new LengthCubMass((value + inchcubkilogram_.Offset) * inchcubkilogram_.Factor);
  public double GetValueInInchCubKilograms() => (Value_ - inchcubkilogram_.Offset) / inchcubkilogram_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("LengthCubMass is outside its bounds.");
    }
    else if (fail)
    {
      return false;
