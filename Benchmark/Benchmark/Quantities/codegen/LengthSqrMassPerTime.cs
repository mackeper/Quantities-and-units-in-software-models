...
#region units
  private static Unit_ centimetersqrkilogrampersecond_ = new Unit_("CentimeterSqrKilogramPerSecond", "cm� kg/s", 1.0, 0);
  private static Unit_ millimetersqrkilogrampersecond_ = new Unit_("MillimeterSqrKilogramPerSecond", "mm� kg/s", 0.010000000000000002, 0);
  private static Unit_ metersqrkilogrampersecond_ = new Unit_("MeterSqrKilogramPerSecond", "m� kg/s", 10000.0, 0);
  private static Unit_ inchsqrkilogrampersecond_ = new Unit_("InchSqrKilogramPerSecond", "in� kg/s", 6.5536, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is LengthSqrMassPerTime other && Equals(other);
  public bool Equals(LengthSqrMassPerTime other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static LengthSqrMassPerTime FromCentimeterSqrKilogramPerSeconds(double value, double minValue, double maxValue) => new LengthSqrMassPerTime((value + centimetersqrkilogrampersecond_.Offset) * centimetersqrkilogrampersecond_.Factor, minValue * centimetersqrkilogrampersecond_.Factor, maxValue * centimetersqrkilogrampersecond_.Factor);
  public static LengthSqrMassPerTime FromCentimeterSqrKilogramPerSeconds(double value) => new LengthSqrMassPerTime((value + centimetersqrkilogrampersecond_.Offset) * centimetersqrkilogrampersecond_.Factor);
  public double GetValueInCentimeterSqrKilogramPerSeconds() => (Value_ - centimetersqrkilogrampersecond_.Offset) / centimetersqrkilogrampersecond_.Factor;
  public static LengthSqrMassPerTime FromMillimeterSqrKilogramPerSeconds(double value, double minValue, double maxValue) => new LengthSqrMassPerTime((value + millimetersqrkilogrampersecond_.Offset) * millimetersqrkilogrampersecond_.Factor, minValue * millimetersqrkilogrampersecond_.Factor, maxValue * millimetersqrkilogrampersecond_.Factor);
  public static LengthSqrMassPerTime FromMillimeterSqrKilogramPerSeconds(double value) => new LengthSqrMassPerTime((value + millimetersqrkilogrampersecond_.Offset) * millimetersqrkilogrampersecond_.Factor);
  public double GetValueInMillimeterSqrKilogramPerSeconds() => (Value_ - millimetersqrkilogrampersecond_.Offset) / millimetersqrkilogrampersecond_.Factor;
  public static LengthSqrMassPerTime FromMeterSqrKilogramPerSeconds(double value, double minValue, double maxValue) => new LengthSqrMassPerTime((value + metersqrkilogrampersecond_.Offset) * metersqrkilogrampersecond_.Factor, minValue * metersqrkilogrampersecond_.Factor, maxValue * metersqrkilogrampersecond_.Factor);
  public static LengthSqrMassPerTime FromMeterSqrKilogramPerSeconds(double value) => new LengthSqrMassPerTime((value + metersqrkilogrampersecond_.Offset) * metersqrkilogrampersecond_.Factor);
  public double GetValueInMeterSqrKilogramPerSeconds() => (Value_ - metersqrkilogrampersecond_.Offset) / metersqrkilogrampersecond_.Factor;
  public static LengthSqrMassPerTime FromInchSqrKilogramPerSeconds(double value, double minValue, double maxValue) => new LengthSqrMassPerTime((value + inchsqrkilogrampersecond_.Offset) * inchsqrkilogrampersecond_.Factor, minValue * inchsqrkilogrampersecond_.Factor, maxValue * inchsqrkilogrampersecond_.Factor);
  public static LengthSqrMassPerTime FromInchSqrKilogramPerSeconds(double value) => new LengthSqrMassPerTime((value + inchsqrkilogrampersecond_.Offset) * inchsqrkilogrampersecond_.Factor);
  public double GetValueInInchSqrKilogramPerSeconds() => (Value_ - inchsqrkilogrampersecond_.Offset) / inchsqrkilogrampersecond_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("LengthSqrMassPerTime is outside its bounds.");
    }
    else if (fail)
    {
      return false;
