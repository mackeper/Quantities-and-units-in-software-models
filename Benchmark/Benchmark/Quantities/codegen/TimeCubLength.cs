...
#region units
  private static Unit_ secondcubcentimeter_ = new Unit_("SecondCubCentimeter", "s³ cm", 1, 0);
  private static Unit_ secondcubmillimeter_ = new Unit_("SecondCubMillimeter", "s³ mm", 0.1, 0);
  private static Unit_ secondcubmeter_ = new Unit_("SecondCubMeter", "s³ m", 100, 0);
  private static Unit_ secondcubinch_ = new Unit_("SecondCubInch", "s³ in", 2.56, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is TimeCubLength other && Equals(other);
  public bool Equals(TimeCubLength other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static TimeCubLength FromSecondCubCentimeters(double value, double minValue, double maxValue) => new TimeCubLength((value + secondcubcentimeter_.Offset) * secondcubcentimeter_.Factor, minValue * secondcubcentimeter_.Factor, maxValue * secondcubcentimeter_.Factor);
  public static TimeCubLength FromSecondCubCentimeters(double value) => new TimeCubLength((value + secondcubcentimeter_.Offset) * secondcubcentimeter_.Factor);
  public double GetValueInSecondCubCentimeters() => (Value_ - secondcubcentimeter_.Offset) / secondcubcentimeter_.Factor;
  public static TimeCubLength FromSecondCubMillimeters(double value, double minValue, double maxValue) => new TimeCubLength((value + secondcubmillimeter_.Offset) * secondcubmillimeter_.Factor, minValue * secondcubmillimeter_.Factor, maxValue * secondcubmillimeter_.Factor);
  public static TimeCubLength FromSecondCubMillimeters(double value) => new TimeCubLength((value + secondcubmillimeter_.Offset) * secondcubmillimeter_.Factor);
  public double GetValueInSecondCubMillimeters() => (Value_ - secondcubmillimeter_.Offset) / secondcubmillimeter_.Factor;
  public static TimeCubLength FromSecondCubMeters(double value, double minValue, double maxValue) => new TimeCubLength((value + secondcubmeter_.Offset) * secondcubmeter_.Factor, minValue * secondcubmeter_.Factor, maxValue * secondcubmeter_.Factor);
  public static TimeCubLength FromSecondCubMeters(double value) => new TimeCubLength((value + secondcubmeter_.Offset) * secondcubmeter_.Factor);
  public double GetValueInSecondCubMeters() => (Value_ - secondcubmeter_.Offset) / secondcubmeter_.Factor;
  public static TimeCubLength FromSecondCubInchs(double value, double minValue, double maxValue) => new TimeCubLength((value + secondcubinch_.Offset) * secondcubinch_.Factor, minValue * secondcubinch_.Factor, maxValue * secondcubinch_.Factor);
  public static TimeCubLength FromSecondCubInchs(double value) => new TimeCubLength((value + secondcubinch_.Offset) * secondcubinch_.Factor);
  public double GetValueInSecondCubInchs() => (Value_ - secondcubinch_.Offset) / secondcubinch_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("TimeCubLength is outside its bounds.");
    }
    else if (fail)
    {
      return false;
