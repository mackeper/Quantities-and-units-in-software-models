...
#region units
  private static Unit_ persecondsqrcentimetercub_ = new Unit_("PerSecondSqrCentimeterCub", "/s² cm³", 1.0, 0);
  private static Unit_ persecondsqrmillimetercub_ = new Unit_("PerSecondSqrMillimeterCub", "/s² mm³", 999.9999999999998, 0);
  private static Unit_ persecondsqrmetercub_ = new Unit_("PerSecondSqrMeterCub", "/s² m³", 1e-06, 0);
  private static Unit_ persecondsqrinchcub_ = new Unit_("PerSecondSqrInchCub", "/s² in³", 0.05960464477539062, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is PerTimeSqrLengthCub other && Equals(other);
  public bool Equals(PerTimeSqrLengthCub other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static PerTimeSqrLengthCub FromPerSecondSqrCentimeterCubs(double value, double minValue, double maxValue) => new PerTimeSqrLengthCub((value + persecondsqrcentimetercub_.Offset) * persecondsqrcentimetercub_.Factor, minValue * persecondsqrcentimetercub_.Factor, maxValue * persecondsqrcentimetercub_.Factor);
  public static PerTimeSqrLengthCub FromPerSecondSqrCentimeterCubs(double value) => new PerTimeSqrLengthCub((value + persecondsqrcentimetercub_.Offset) * persecondsqrcentimetercub_.Factor);
  public double GetValueInPerSecondSqrCentimeterCubs() => (Value_ - persecondsqrcentimetercub_.Offset) / persecondsqrcentimetercub_.Factor;
  public static PerTimeSqrLengthCub FromPerSecondSqrMillimeterCubs(double value, double minValue, double maxValue) => new PerTimeSqrLengthCub((value + persecondsqrmillimetercub_.Offset) * persecondsqrmillimetercub_.Factor, minValue * persecondsqrmillimetercub_.Factor, maxValue * persecondsqrmillimetercub_.Factor);
  public static PerTimeSqrLengthCub FromPerSecondSqrMillimeterCubs(double value) => new PerTimeSqrLengthCub((value + persecondsqrmillimetercub_.Offset) * persecondsqrmillimetercub_.Factor);
  public double GetValueInPerSecondSqrMillimeterCubs() => (Value_ - persecondsqrmillimetercub_.Offset) / persecondsqrmillimetercub_.Factor;
  public static PerTimeSqrLengthCub FromPerSecondSqrMeterCubs(double value, double minValue, double maxValue) => new PerTimeSqrLengthCub((value + persecondsqrmetercub_.Offset) * persecondsqrmetercub_.Factor, minValue * persecondsqrmetercub_.Factor, maxValue * persecondsqrmetercub_.Factor);
  public static PerTimeSqrLengthCub FromPerSecondSqrMeterCubs(double value) => new PerTimeSqrLengthCub((value + persecondsqrmetercub_.Offset) * persecondsqrmetercub_.Factor);
  public double GetValueInPerSecondSqrMeterCubs() => (Value_ - persecondsqrmetercub_.Offset) / persecondsqrmetercub_.Factor;
  public static PerTimeSqrLengthCub FromPerSecondSqrInchCubs(double value, double minValue, double maxValue) => new PerTimeSqrLengthCub((value + persecondsqrinchcub_.Offset) * persecondsqrinchcub_.Factor, minValue * persecondsqrinchcub_.Factor, maxValue * persecondsqrinchcub_.Factor);
  public static PerTimeSqrLengthCub FromPerSecondSqrInchCubs(double value) => new PerTimeSqrLengthCub((value + persecondsqrinchcub_.Offset) * persecondsqrinchcub_.Factor);
  public double GetValueInPerSecondSqrInchCubs() => (Value_ - persecondsqrinchcub_.Offset) / persecondsqrinchcub_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("PerTimeSqrLengthCub is outside its bounds.");
    }
    else if (fail)
    {
      return false;
