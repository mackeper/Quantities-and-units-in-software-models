...
#region units
  private static Unit_ secondcubcentimetersqr_ = new Unit_("SecondCubCentimeterSqr", "s³ cm²", 1, 0);
  private static Unit_ secondcubmillimetersqr_ = new Unit_("SecondCubMillimeterSqr", "s³ mm²", 0.010000000000000002, 0);
  private static Unit_ secondcubmetersqr_ = new Unit_("SecondCubMeterSqr", "s³ m²", 10000, 0);
  private static Unit_ secondcubinchsqr_ = new Unit_("SecondCubInchSqr", "s³ in²", 6.5536, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is TimeCubLengthSqr other && Equals(other);
  public bool Equals(TimeCubLengthSqr other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static TimeCubLengthSqr FromSecondCubCentimeterSqrs(double value, double minValue, double maxValue) => new TimeCubLengthSqr((value + secondcubcentimetersqr_.Offset) * secondcubcentimetersqr_.Factor, minValue * secondcubcentimetersqr_.Factor, maxValue * secondcubcentimetersqr_.Factor);
  public static TimeCubLengthSqr FromSecondCubCentimeterSqrs(double value) => new TimeCubLengthSqr((value + secondcubcentimetersqr_.Offset) * secondcubcentimetersqr_.Factor);
  public double GetValueInSecondCubCentimeterSqrs() => (Value_ - secondcubcentimetersqr_.Offset) / secondcubcentimetersqr_.Factor;
  public static TimeCubLengthSqr FromSecondCubMillimeterSqrs(double value, double minValue, double maxValue) => new TimeCubLengthSqr((value + secondcubmillimetersqr_.Offset) * secondcubmillimetersqr_.Factor, minValue * secondcubmillimetersqr_.Factor, maxValue * secondcubmillimetersqr_.Factor);
  public static TimeCubLengthSqr FromSecondCubMillimeterSqrs(double value) => new TimeCubLengthSqr((value + secondcubmillimetersqr_.Offset) * secondcubmillimetersqr_.Factor);
  public double GetValueInSecondCubMillimeterSqrs() => (Value_ - secondcubmillimetersqr_.Offset) / secondcubmillimetersqr_.Factor;
  public static TimeCubLengthSqr FromSecondCubMeterSqrs(double value, double minValue, double maxValue) => new TimeCubLengthSqr((value + secondcubmetersqr_.Offset) * secondcubmetersqr_.Factor, minValue * secondcubmetersqr_.Factor, maxValue * secondcubmetersqr_.Factor);
  public static TimeCubLengthSqr FromSecondCubMeterSqrs(double value) => new TimeCubLengthSqr((value + secondcubmetersqr_.Offset) * secondcubmetersqr_.Factor);
  public double GetValueInSecondCubMeterSqrs() => (Value_ - secondcubmetersqr_.Offset) / secondcubmetersqr_.Factor;
  public static TimeCubLengthSqr FromSecondCubInchSqrs(double value, double minValue, double maxValue) => new TimeCubLengthSqr((value + secondcubinchsqr_.Offset) * secondcubinchsqr_.Factor, minValue * secondcubinchsqr_.Factor, maxValue * secondcubinchsqr_.Factor);
  public static TimeCubLengthSqr FromSecondCubInchSqrs(double value) => new TimeCubLengthSqr((value + secondcubinchsqr_.Offset) * secondcubinchsqr_.Factor);
  public double GetValueInSecondCubInchSqrs() => (Value_ - secondcubinchsqr_.Offset) / secondcubinchsqr_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("TimeCubLengthSqr is outside its bounds.");
    }
    else if (fail)
    {
      return false;
