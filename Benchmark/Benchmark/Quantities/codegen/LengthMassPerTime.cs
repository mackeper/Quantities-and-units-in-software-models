...
#region units
  private static Unit_ centimeterkilogrampersecond_ = new Unit_("CentimeterKilogramPerSecond", "cm kg/s", 1.0, 0);
  private static Unit_ millimeterkilogrampersecond_ = new Unit_("MillimeterKilogramPerSecond", "mm kg/s", 0.1, 0);
  private static Unit_ meterkilogrampersecond_ = new Unit_("MeterKilogramPerSecond", "m kg/s", 100.0, 0);
  private static Unit_ inchkilogrampersecond_ = new Unit_("InchKilogramPerSecond", "in kg/s", 2.56, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is LengthMassPerTime other && Equals(other);
  public bool Equals(LengthMassPerTime other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static LengthMassPerTime FromCentimeterKilogramPerSeconds(double value, double minValue, double maxValue) => new LengthMassPerTime((value + centimeterkilogrampersecond_.Offset) * centimeterkilogrampersecond_.Factor, minValue * centimeterkilogrampersecond_.Factor, maxValue * centimeterkilogrampersecond_.Factor);
  public static LengthMassPerTime FromCentimeterKilogramPerSeconds(double value) => new LengthMassPerTime((value + centimeterkilogrampersecond_.Offset) * centimeterkilogrampersecond_.Factor);
  public double GetValueInCentimeterKilogramPerSeconds() => (Value_ - centimeterkilogrampersecond_.Offset) / centimeterkilogrampersecond_.Factor;
  public static LengthMassPerTime FromMillimeterKilogramPerSeconds(double value, double minValue, double maxValue) => new LengthMassPerTime((value + millimeterkilogrampersecond_.Offset) * millimeterkilogrampersecond_.Factor, minValue * millimeterkilogrampersecond_.Factor, maxValue * millimeterkilogrampersecond_.Factor);
  public static LengthMassPerTime FromMillimeterKilogramPerSeconds(double value) => new LengthMassPerTime((value + millimeterkilogrampersecond_.Offset) * millimeterkilogrampersecond_.Factor);
  public double GetValueInMillimeterKilogramPerSeconds() => (Value_ - millimeterkilogrampersecond_.Offset) / millimeterkilogrampersecond_.Factor;
  public static LengthMassPerTime FromMeterKilogramPerSeconds(double value, double minValue, double maxValue) => new LengthMassPerTime((value + meterkilogrampersecond_.Offset) * meterkilogrampersecond_.Factor, minValue * meterkilogrampersecond_.Factor, maxValue * meterkilogrampersecond_.Factor);
  public static LengthMassPerTime FromMeterKilogramPerSeconds(double value) => new LengthMassPerTime((value + meterkilogrampersecond_.Offset) * meterkilogrampersecond_.Factor);
  public double GetValueInMeterKilogramPerSeconds() => (Value_ - meterkilogrampersecond_.Offset) / meterkilogrampersecond_.Factor;
  public static LengthMassPerTime FromInchKilogramPerSeconds(double value, double minValue, double maxValue) => new LengthMassPerTime((value + inchkilogrampersecond_.Offset) * inchkilogrampersecond_.Factor, minValue * inchkilogrampersecond_.Factor, maxValue * inchkilogrampersecond_.Factor);
  public static LengthMassPerTime FromInchKilogramPerSeconds(double value) => new LengthMassPerTime((value + inchkilogrampersecond_.Offset) * inchkilogrampersecond_.Factor);
  public double GetValueInInchKilogramPerSeconds() => (Value_ - inchkilogrampersecond_.Offset) / inchkilogrampersecond_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("LengthMassPerTime is outside its bounds.");
    }
    else if (fail)
    {
      return false;
