...
#region units
  private static Unit_ centimetercubperkilogram_ = new Unit_("CentimeterCubPerKilogram", "cm³/kg", 1.0, 0);
  private static Unit_ millimetercubperkilogram_ = new Unit_("MillimeterCubPerKilogram", "mm³/kg", 0.0010000000000000002, 0);
  private static Unit_ metercubperkilogram_ = new Unit_("MeterCubPerKilogram", "m³/kg", 1000000.0, 0);
  private static Unit_ inchcubperkilogram_ = new Unit_("InchCubPerKilogram", "in³/kg", 16.777216000000003, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is LengthCubPerMass other && Equals(other);
  public bool Equals(LengthCubPerMass other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static LengthCubPerMass FromCentimeterCubPerKilograms(double value, double minValue, double maxValue) => new LengthCubPerMass((value + centimetercubperkilogram_.Offset) * centimetercubperkilogram_.Factor, minValue * centimetercubperkilogram_.Factor, maxValue * centimetercubperkilogram_.Factor);
  public static LengthCubPerMass FromCentimeterCubPerKilograms(double value) => new LengthCubPerMass((value + centimetercubperkilogram_.Offset) * centimetercubperkilogram_.Factor);
  public double GetValueInCentimeterCubPerKilograms() => (Value_ - centimetercubperkilogram_.Offset) / centimetercubperkilogram_.Factor;
  public static LengthCubPerMass FromMillimeterCubPerKilograms(double value, double minValue, double maxValue) => new LengthCubPerMass((value + millimetercubperkilogram_.Offset) * millimetercubperkilogram_.Factor, minValue * millimetercubperkilogram_.Factor, maxValue * millimetercubperkilogram_.Factor);
  public static LengthCubPerMass FromMillimeterCubPerKilograms(double value) => new LengthCubPerMass((value + millimetercubperkilogram_.Offset) * millimetercubperkilogram_.Factor);
  public double GetValueInMillimeterCubPerKilograms() => (Value_ - millimetercubperkilogram_.Offset) / millimetercubperkilogram_.Factor;
  public static LengthCubPerMass FromMeterCubPerKilograms(double value, double minValue, double maxValue) => new LengthCubPerMass((value + metercubperkilogram_.Offset) * metercubperkilogram_.Factor, minValue * metercubperkilogram_.Factor, maxValue * metercubperkilogram_.Factor);
  public static LengthCubPerMass FromMeterCubPerKilograms(double value) => new LengthCubPerMass((value + metercubperkilogram_.Offset) * metercubperkilogram_.Factor);
  public double GetValueInMeterCubPerKilograms() => (Value_ - metercubperkilogram_.Offset) / metercubperkilogram_.Factor;
  public static LengthCubPerMass FromInchCubPerKilograms(double value, double minValue, double maxValue) => new LengthCubPerMass((value + inchcubperkilogram_.Offset) * inchcubperkilogram_.Factor, minValue * inchcubperkilogram_.Factor, maxValue * inchcubperkilogram_.Factor);
  public static LengthCubPerMass FromInchCubPerKilograms(double value) => new LengthCubPerMass((value + inchcubperkilogram_.Offset) * inchcubperkilogram_.Factor);
  public double GetValueInInchCubPerKilograms() => (Value_ - inchcubperkilogram_.Offset) / inchcubperkilogram_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("LengthCubPerMass is outside its bounds.");
    }
    else if (fail)
    {
      return false;
