...
#region units
  private static Unit_ kilogrampercentimeter_ = new Unit_("KilogramPerCentimeter", "kg/cm", 1.0, 0);
  private static Unit_ kilogrampermillimeter_ = new Unit_("KilogramPerMillimeter", "kg/mm", 10.0, 0);
  private static Unit_ kilogrampermeter_ = new Unit_("KilogramPerMeter", "kg/m", 0.01, 0);
  private static Unit_ kilogramperinch_ = new Unit_("KilogramPerInch", "kg/in", 0.390625, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is MassPerLength other && Equals(other);
  public bool Equals(MassPerLength other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static MassPerLength FromKilogramPerCentimeters(double value, double minValue, double maxValue) => new MassPerLength((value + kilogrampercentimeter_.Offset) * kilogrampercentimeter_.Factor, minValue * kilogrampercentimeter_.Factor, maxValue * kilogrampercentimeter_.Factor);
  public static MassPerLength FromKilogramPerCentimeters(double value) => new MassPerLength((value + kilogrampercentimeter_.Offset) * kilogrampercentimeter_.Factor);
  public double GetValueInKilogramPerCentimeters() => (Value_ - kilogrampercentimeter_.Offset) / kilogrampercentimeter_.Factor;
  public static MassPerLength FromKilogramPerMillimeters(double value, double minValue, double maxValue) => new MassPerLength((value + kilogrampermillimeter_.Offset) * kilogrampermillimeter_.Factor, minValue * kilogrampermillimeter_.Factor, maxValue * kilogrampermillimeter_.Factor);
  public static MassPerLength FromKilogramPerMillimeters(double value) => new MassPerLength((value + kilogrampermillimeter_.Offset) * kilogrampermillimeter_.Factor);
  public double GetValueInKilogramPerMillimeters() => (Value_ - kilogrampermillimeter_.Offset) / kilogrampermillimeter_.Factor;
  public static MassPerLength FromKilogramPerMeters(double value, double minValue, double maxValue) => new MassPerLength((value + kilogrampermeter_.Offset) * kilogrampermeter_.Factor, minValue * kilogrampermeter_.Factor, maxValue * kilogrampermeter_.Factor);
  public static MassPerLength FromKilogramPerMeters(double value) => new MassPerLength((value + kilogrampermeter_.Offset) * kilogrampermeter_.Factor);
  public double GetValueInKilogramPerMeters() => (Value_ - kilogrampermeter_.Offset) / kilogrampermeter_.Factor;
  public static MassPerLength FromKilogramPerInchs(double value, double minValue, double maxValue) => new MassPerLength((value + kilogramperinch_.Offset) * kilogramperinch_.Factor, minValue * kilogramperinch_.Factor, maxValue * kilogramperinch_.Factor);
  public static MassPerLength FromKilogramPerInchs(double value) => new MassPerLength((value + kilogramperinch_.Offset) * kilogramperinch_.Factor);
  public double GetValueInKilogramPerInchs() => (Value_ - kilogramperinch_.Offset) / kilogramperinch_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("MassPerLength is outside its bounds.");
    }
    else if (fail)
    {
      return false;
