...
namespace RayQuantities
{
  ...
  {  
    ...
    if (!displayUnitIsImported_ && FakeDatabase.Units.ContainsKey("PerTimeLengthCub"))
    {
      ...
      {
        case "persecondcentimetercub": displayUnit_ = persecondcentimetercub_; break;
        case "persecondmillimetercub": displayUnit_ = persecondmillimetercub_; break;
        case "persecondmetercub": displayUnit_ = persecondmetercub_; break;
        case "persecondinchcub": displayUnit_ = persecondinchcub_; break;
...
#region units
  private static Unit_ persecondcentimetercub_ = new Unit_("PerSecondCentimeterCub", "/s cm�", 1.0, 0);
  private static Unit_ persecondmillimetercub_ = new Unit_("PerSecondMillimeterCub", "/s mm�", 999.9999999999998, 0);
  private static Unit_ persecondmetercub_ = new Unit_("PerSecondMeterCub", "/s m�", 1e-06, 0);
  private static Unit_ persecondinchcub_ = new Unit_("PerSecondInchCub", "/s in�", 0.05960464477539062, 0);
  private static Unit_ platformUnit_ = persecondcentimetercub_;
  private static Unit_ displayUnit_ = persecondcentimetercub_;
#endregion

#region comparisons

  public override int GetHashCode() => base.GetHashCode();
  public override bool Equals(Object obj) => obj is PerTimeLengthCub other && Equals(other);
  public bool Equals(PerTimeLengthCub other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static PerTimeLengthCub FromPerSecondCentimeterCubs(double value, double minValue, double maxValue) => new PerTimeLengthCub((value + persecondcentimetercub_.Offset) * persecondcentimetercub_.Factor, minValue * persecondcentimetercub_.Factor, maxValue * persecondcentimetercub_.Factor);
  public static PerTimeLengthCub FromPerSecondCentimeterCubs(double value) => new PerTimeLengthCub((value + persecondcentimetercub_.Offset) * persecondcentimetercub_.Factor);
  public double GetValueInPerSecondCentimeterCubs() => (Value_ - persecondcentimetercub_.Offset) / persecondcentimetercub_.Factor;
  public static PerTimeLengthCub FromPerSecondMillimeterCubs(double value, double minValue, double maxValue) => new PerTimeLengthCub((value + persecondmillimetercub_.Offset) * persecondmillimetercub_.Factor, minValue * persecondmillimetercub_.Factor, maxValue * persecondmillimetercub_.Factor);
  public static PerTimeLengthCub FromPerSecondMillimeterCubs(double value) => new PerTimeLengthCub((value + persecondmillimetercub_.Offset) * persecondmillimetercub_.Factor);
  public double GetValueInPerSecondMillimeterCubs() => (Value_ - persecondmillimetercub_.Offset) / persecondmillimetercub_.Factor;
  public static PerTimeLengthCub FromPerSecondMeterCubs(double value, double minValue, double maxValue) => new PerTimeLengthCub((value + persecondmetercub_.Offset) * persecondmetercub_.Factor, minValue * persecondmetercub_.Factor, maxValue * persecondmetercub_.Factor);
  public static PerTimeLengthCub FromPerSecondMeterCubs(double value) => new PerTimeLengthCub((value + persecondmetercub_.Offset) * persecondmetercub_.Factor);
  public double GetValueInPerSecondMeterCubs() => (Value_ - persecondmetercub_.Offset) / persecondmetercub_.Factor;
  public static PerTimeLengthCub FromPerSecondInchCubs(double value, double minValue, double maxValue) => new PerTimeLengthCub((value + persecondinchcub_.Offset) * persecondinchcub_.Factor, minValue * persecondinchcub_.Factor, maxValue * persecondinchcub_.Factor);
  public static PerTimeLengthCub FromPerSecondInchCubs(double value) => new PerTimeLengthCub((value + persecondinchcub_.Offset) * persecondinchcub_.Factor);
  public double GetValueInPerSecondInchCubs() => (Value_ - persecondinchcub_.Offset) / persecondinchcub_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("PerTimeLengthCub is outside its bounds.");
    }
    else if (fail)
    {
      return false;
