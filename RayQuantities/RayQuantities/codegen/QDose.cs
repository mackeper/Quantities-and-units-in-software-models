...
#region units
  private static Unit_ centimetersqrpersecondsqr_ = new Unit_("CentimeterSqrPerSecondSqr", "cm²/s²", 1.0, 0);
  private static Unit_ millimetersqrpersecondsqr_ = new Unit_("MillimeterSqrPerSecondSqr", "mm²/s²", 0.010000000000000002, 0);
  private static Unit_ metersqrpersecondsqr_ = new Unit_("MeterSqrPerSecondSqr", "m²/s²", 10000.0, 0);
  private static Unit_ inchsqrpersecondsqr_ = new Unit_("InchSqrPerSecondSqr", "in²/s²", 6.5536, 0);
  private static Unit_ gray_ = new Unit_("Gray", "Gy", 10000, 0);
  private static Unit_ centigray_ = new Unit_("Centigray", "cGy", 100, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is QDose other && Equals(other);
  public bool Equals(QDose other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static QDose FromCentimeterSqrPerSecondSqrs(double value, double minValue, double maxValue) => new QDose((value + centimetersqrpersecondsqr_.Offset) * centimetersqrpersecondsqr_.Factor, minValue * centimetersqrpersecondsqr_.Factor, maxValue * centimetersqrpersecondsqr_.Factor);
  public static QDose FromCentimeterSqrPerSecondSqrs(double value) => new QDose((value + centimetersqrpersecondsqr_.Offset) * centimetersqrpersecondsqr_.Factor);
  public double GetValueInCentimeterSqrPerSecondSqrs() => (Value_ - centimetersqrpersecondsqr_.Offset) / centimetersqrpersecondsqr_.Factor;
  public static QDose FromMillimeterSqrPerSecondSqrs(double value, double minValue, double maxValue) => new QDose((value + millimetersqrpersecondsqr_.Offset) * millimetersqrpersecondsqr_.Factor, minValue * millimetersqrpersecondsqr_.Factor, maxValue * millimetersqrpersecondsqr_.Factor);
  public static QDose FromMillimeterSqrPerSecondSqrs(double value) => new QDose((value + millimetersqrpersecondsqr_.Offset) * millimetersqrpersecondsqr_.Factor);
  public double GetValueInMillimeterSqrPerSecondSqrs() => (Value_ - millimetersqrpersecondsqr_.Offset) / millimetersqrpersecondsqr_.Factor;
  public static QDose FromMeterSqrPerSecondSqrs(double value, double minValue, double maxValue) => new QDose((value + metersqrpersecondsqr_.Offset) * metersqrpersecondsqr_.Factor, minValue * metersqrpersecondsqr_.Factor, maxValue * metersqrpersecondsqr_.Factor);
  public static QDose FromMeterSqrPerSecondSqrs(double value) => new QDose((value + metersqrpersecondsqr_.Offset) * metersqrpersecondsqr_.Factor);
  public double GetValueInMeterSqrPerSecondSqrs() => (Value_ - metersqrpersecondsqr_.Offset) / metersqrpersecondsqr_.Factor;
  public static QDose FromInchSqrPerSecondSqrs(double value, double minValue, double maxValue) => new QDose((value + inchsqrpersecondsqr_.Offset) * inchsqrpersecondsqr_.Factor, minValue * inchsqrpersecondsqr_.Factor, maxValue * inchsqrpersecondsqr_.Factor);
  public static QDose FromInchSqrPerSecondSqrs(double value) => new QDose((value + inchsqrpersecondsqr_.Offset) * inchsqrpersecondsqr_.Factor);
  public double GetValueInInchSqrPerSecondSqrs() => (Value_ - inchsqrpersecondsqr_.Offset) / inchsqrpersecondsqr_.Factor;
  public static QDose FromGrays(double value, double minValue, double maxValue) => new QDose((value + gray_.Offset) * gray_.Factor, minValue * gray_.Factor, maxValue * gray_.Factor);
  public static QDose FromGrays(double value) => new QDose((value + gray_.Offset) * gray_.Factor);
  public double GetValueInGrays() => (Value_ - gray_.Offset) / gray_.Factor;
  public static QDose FromCentigrays(double value, double minValue, double maxValue) => new QDose((value + centigray_.Offset) * centigray_.Factor, minValue * centigray_.Factor, maxValue * centigray_.Factor);
  public static QDose FromCentigrays(double value) => new QDose((value + centigray_.Offset) * centigray_.Factor);
  public double GetValueInCentigrays() => (Value_ - centigray_.Offset) / centigray_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("QDose is outside its bounds.");
    }
    else if (fail)
    {
      return false;
