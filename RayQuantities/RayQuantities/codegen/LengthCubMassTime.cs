...
#region units
  private static Unit_ centimetercubkilogramsecond_ = new Unit_("CentimeterCubKilogramSecond", "cm³ kg s", 1, 0);
  private static Unit_ millimetercubkilogramsecond_ = new Unit_("MillimeterCubKilogramSecond", "mm³ kg s", 0.0010000000000000002, 0);
  private static Unit_ metercubkilogramsecond_ = new Unit_("MeterCubKilogramSecond", "m³ kg s", 1000000, 0);
  private static Unit_ inchcubkilogramsecond_ = new Unit_("InchCubKilogramSecond", "in³ kg s", 16.777216000000003, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is LengthCubMassTime other && Equals(other);
  public bool Equals(LengthCubMassTime other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static LengthCubMassTime FromCentimeterCubKilogramSeconds(double value, double minValue, double maxValue) => new LengthCubMassTime((value + centimetercubkilogramsecond_.Offset) * centimetercubkilogramsecond_.Factor, minValue * centimetercubkilogramsecond_.Factor, maxValue * centimetercubkilogramsecond_.Factor);
  public static LengthCubMassTime FromCentimeterCubKilogramSeconds(double value) => new LengthCubMassTime((value + centimetercubkilogramsecond_.Offset) * centimetercubkilogramsecond_.Factor);
  public double GetValueInCentimeterCubKilogramSeconds() => (Value_ - centimetercubkilogramsecond_.Offset) / centimetercubkilogramsecond_.Factor;
  public static LengthCubMassTime FromMillimeterCubKilogramSeconds(double value, double minValue, double maxValue) => new LengthCubMassTime((value + millimetercubkilogramsecond_.Offset) * millimetercubkilogramsecond_.Factor, minValue * millimetercubkilogramsecond_.Factor, maxValue * millimetercubkilogramsecond_.Factor);
  public static LengthCubMassTime FromMillimeterCubKilogramSeconds(double value) => new LengthCubMassTime((value + millimetercubkilogramsecond_.Offset) * millimetercubkilogramsecond_.Factor);
  public double GetValueInMillimeterCubKilogramSeconds() => (Value_ - millimetercubkilogramsecond_.Offset) / millimetercubkilogramsecond_.Factor;
  public static LengthCubMassTime FromMeterCubKilogramSeconds(double value, double minValue, double maxValue) => new LengthCubMassTime((value + metercubkilogramsecond_.Offset) * metercubkilogramsecond_.Factor, minValue * metercubkilogramsecond_.Factor, maxValue * metercubkilogramsecond_.Factor);
  public static LengthCubMassTime FromMeterCubKilogramSeconds(double value) => new LengthCubMassTime((value + metercubkilogramsecond_.Offset) * metercubkilogramsecond_.Factor);
  public double GetValueInMeterCubKilogramSeconds() => (Value_ - metercubkilogramsecond_.Offset) / metercubkilogramsecond_.Factor;
  public static LengthCubMassTime FromInchCubKilogramSeconds(double value, double minValue, double maxValue) => new LengthCubMassTime((value + inchcubkilogramsecond_.Offset) * inchcubkilogramsecond_.Factor, minValue * inchcubkilogramsecond_.Factor, maxValue * inchcubkilogramsecond_.Factor);
  public static LengthCubMassTime FromInchCubKilogramSeconds(double value) => new LengthCubMassTime((value + inchcubkilogramsecond_.Offset) * inchcubkilogramsecond_.Factor);
  public double GetValueInInchCubKilogramSeconds() => (Value_ - inchcubkilogramsecond_.Offset) / inchcubkilogramsecond_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("LengthCubMassTime is outside its bounds.");
    }
    else if (fail)
    {
      return false;
