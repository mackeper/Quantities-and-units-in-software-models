...
#region units
  private static Unit_ kilogrampercentimetercub_ = new Unit_("KilogramPerCentimeterCub", "kg/cm�", 1.0, 0);
  private static Unit_ kilogrampermillimetercub_ = new Unit_("KilogramPerMillimeterCub", "kg/mm�", 999.9999999999998, 0);
  private static Unit_ kilogrampermetercub_ = new Unit_("KilogramPerMeterCub", "kg/m�", 1e-06, 0);
  private static Unit_ kilogramperinchcub_ = new Unit_("KilogramPerInchCub", "kg/in�", 0.05960464477539062, 0);
...
#region comparisons
  ...
  public bool Equals(Density other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static Density FromKilogramPerCentimeterCubs(double value, double minValue, double maxValue) => new Density((value + kilogrampercentimetercub_.Offset) * kilogrampercentimetercub_.Factor, minValue * kilogrampercentimetercub_.Factor, maxValue * kilogrampercentimetercub_.Factor);
  public static Density FromKilogramPerCentimeterCubs(double value) => new Density((value + kilogrampercentimetercub_.Offset) * kilogrampercentimetercub_.Factor);
  public double GetValueInKilogramPerCentimeterCubs() => (Value_ - kilogrampercentimetercub_.Offset) / kilogrampercentimetercub_.Factor;
  public static Density FromKilogramPerMillimeterCubs(double value, double minValue, double maxValue) => new Density((value + kilogrampermillimetercub_.Offset) * kilogrampermillimetercub_.Factor, minValue * kilogrampermillimetercub_.Factor, maxValue * kilogrampermillimetercub_.Factor);
  public static Density FromKilogramPerMillimeterCubs(double value) => new Density((value + kilogrampermillimetercub_.Offset) * kilogrampermillimetercub_.Factor);
  public double GetValueInKilogramPerMillimeterCubs() => (Value_ - kilogrampermillimetercub_.Offset) / kilogrampermillimetercub_.Factor;
  public static Density FromKilogramPerMeterCubs(double value, double minValue, double maxValue) => new Density((value + kilogrampermetercub_.Offset) * kilogrampermetercub_.Factor, minValue * kilogrampermetercub_.Factor, maxValue * kilogrampermetercub_.Factor);
  public static Density FromKilogramPerMeterCubs(double value) => new Density((value + kilogrampermetercub_.Offset) * kilogrampermetercub_.Factor);
  public double GetValueInKilogramPerMeterCubs() => (Value_ - kilogrampermetercub_.Offset) / kilogrampermetercub_.Factor;
  public static Density FromKilogramPerInchCubs(double value, double minValue, double maxValue) => new Density((value + kilogramperinchcub_.Offset) * kilogramperinchcub_.Factor, minValue * kilogramperinchcub_.Factor, maxValue * kilogramperinchcub_.Factor);
  public static Density FromKilogramPerInchCubs(double value) => new Density((value + kilogramperinchcub_.Offset) * kilogramperinchcub_.Factor);
  public double GetValueInKilogramPerInchCubs() => (Value_ - kilogramperinchcub_.Offset) / kilogramperinchcub_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("Density is outside its bounds.");
    }
    else if (fail)
    {
      return false;
