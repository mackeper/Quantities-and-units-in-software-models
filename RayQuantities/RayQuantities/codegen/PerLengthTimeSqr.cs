...
namespace RayQuantities
{
  ...
  {  
    ...
    if (!displayUnitIsImported_ && FakeDatabase.Units.ContainsKey("PerLengthTimeSqr"))
    {
      ...
      {
        case "percentimetersecondsqr": displayUnit_ = percentimetersecondsqr_; break;
        case "permillimetersecondsqr": displayUnit_ = permillimetersecondsqr_; break;
        case "permetersecondsqr": displayUnit_ = permetersecondsqr_; break;
        case "perinchsecondsqr": displayUnit_ = perinchsecondsqr_; break;
...
#region units
  private static Unit_ percentimetersecondsqr_ = new Unit_("PerCentimeterSecondSqr", "/cm s²", 1.0, 0);
  private static Unit_ permillimetersecondsqr_ = new Unit_("PerMillimeterSecondSqr", "/mm s²", 0.1, 0);
  private static Unit_ permetersecondsqr_ = new Unit_("PerMeterSecondSqr", "/m s²", 100.0, 0);
  private static Unit_ perinchsecondsqr_ = new Unit_("PerInchSecondSqr", "/in s²", 2.56, 0);
  private static Unit_ platformUnit_ = percentimetersecondsqr_;
  private static Unit_ displayUnit_ = percentimetersecondsqr_;
#endregion

#region comparisons

  public override int GetHashCode() => base.GetHashCode();
  public override bool Equals(Object obj) => obj is PerLengthTimeSqr other && Equals(other);
  public bool Equals(PerLengthTimeSqr other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static PerLengthTimeSqr FromPerCentimeterSecondSqrs(double value, double minValue, double maxValue) => new PerLengthTimeSqr((value + percentimetersecondsqr_.Offset) * percentimetersecondsqr_.Factor, minValue * percentimetersecondsqr_.Factor, maxValue * percentimetersecondsqr_.Factor);
  public static PerLengthTimeSqr FromPerCentimeterSecondSqrs(double value) => new PerLengthTimeSqr((value + percentimetersecondsqr_.Offset) * percentimetersecondsqr_.Factor);
  public double GetValueInPerCentimeterSecondSqrs() => (Value_ - percentimetersecondsqr_.Offset) / percentimetersecondsqr_.Factor;
  public static PerLengthTimeSqr FromPerMillimeterSecondSqrs(double value, double minValue, double maxValue) => new PerLengthTimeSqr((value + permillimetersecondsqr_.Offset) * permillimetersecondsqr_.Factor, minValue * permillimetersecondsqr_.Factor, maxValue * permillimetersecondsqr_.Factor);
  public static PerLengthTimeSqr FromPerMillimeterSecondSqrs(double value) => new PerLengthTimeSqr((value + permillimetersecondsqr_.Offset) * permillimetersecondsqr_.Factor);
  public double GetValueInPerMillimeterSecondSqrs() => (Value_ - permillimetersecondsqr_.Offset) / permillimetersecondsqr_.Factor;
  public static PerLengthTimeSqr FromPerMeterSecondSqrs(double value, double minValue, double maxValue) => new PerLengthTimeSqr((value + permetersecondsqr_.Offset) * permetersecondsqr_.Factor, minValue * permetersecondsqr_.Factor, maxValue * permetersecondsqr_.Factor);
  public static PerLengthTimeSqr FromPerMeterSecondSqrs(double value) => new PerLengthTimeSqr((value + permetersecondsqr_.Offset) * permetersecondsqr_.Factor);
  public double GetValueInPerMeterSecondSqrs() => (Value_ - permetersecondsqr_.Offset) / permetersecondsqr_.Factor;
  public static PerLengthTimeSqr FromPerInchSecondSqrs(double value, double minValue, double maxValue) => new PerLengthTimeSqr((value + perinchsecondsqr_.Offset) * perinchsecondsqr_.Factor, minValue * perinchsecondsqr_.Factor, maxValue * perinchsecondsqr_.Factor);
  public static PerLengthTimeSqr FromPerInchSecondSqrs(double value) => new PerLengthTimeSqr((value + perinchsecondsqr_.Offset) * perinchsecondsqr_.Factor);
  public double GetValueInPerInchSecondSqrs() => (Value_ - perinchsecondsqr_.Offset) / perinchsecondsqr_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("PerLengthTimeSqr is outside its bounds.");
    }
    else if (fail)
    {
      return false;
