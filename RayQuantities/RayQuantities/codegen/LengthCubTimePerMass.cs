...
#region units
  private static Unit_ centimetercubsecondperkilogram_ = new Unit_("CentimeterCubSecondPerKilogram", "cm³ s/kg", 1.0, 0);
  private static Unit_ millimetercubsecondperkilogram_ = new Unit_("MillimeterCubSecondPerKilogram", "mm³ s/kg", 0.0010000000000000002, 0);
  private static Unit_ metercubsecondperkilogram_ = new Unit_("MeterCubSecondPerKilogram", "m³ s/kg", 1000000.0, 0);
  private static Unit_ inchcubsecondperkilogram_ = new Unit_("InchCubSecondPerKilogram", "in³ s/kg", 16.777216000000003, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is LengthCubTimePerMass other && Equals(other);
  public bool Equals(LengthCubTimePerMass other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static LengthCubTimePerMass FromCentimeterCubSecondPerKilograms(double value, double minValue, double maxValue) => new LengthCubTimePerMass((value + centimetercubsecondperkilogram_.Offset) * centimetercubsecondperkilogram_.Factor, minValue * centimetercubsecondperkilogram_.Factor, maxValue * centimetercubsecondperkilogram_.Factor);
  public static LengthCubTimePerMass FromCentimeterCubSecondPerKilograms(double value) => new LengthCubTimePerMass((value + centimetercubsecondperkilogram_.Offset) * centimetercubsecondperkilogram_.Factor);
  public double GetValueInCentimeterCubSecondPerKilograms() => (Value_ - centimetercubsecondperkilogram_.Offset) / centimetercubsecondperkilogram_.Factor;
  public static LengthCubTimePerMass FromMillimeterCubSecondPerKilograms(double value, double minValue, double maxValue) => new LengthCubTimePerMass((value + millimetercubsecondperkilogram_.Offset) * millimetercubsecondperkilogram_.Factor, minValue * millimetercubsecondperkilogram_.Factor, maxValue * millimetercubsecondperkilogram_.Factor);
  public static LengthCubTimePerMass FromMillimeterCubSecondPerKilograms(double value) => new LengthCubTimePerMass((value + millimetercubsecondperkilogram_.Offset) * millimetercubsecondperkilogram_.Factor);
  public double GetValueInMillimeterCubSecondPerKilograms() => (Value_ - millimetercubsecondperkilogram_.Offset) / millimetercubsecondperkilogram_.Factor;
  public static LengthCubTimePerMass FromMeterCubSecondPerKilograms(double value, double minValue, double maxValue) => new LengthCubTimePerMass((value + metercubsecondperkilogram_.Offset) * metercubsecondperkilogram_.Factor, minValue * metercubsecondperkilogram_.Factor, maxValue * metercubsecondperkilogram_.Factor);
  public static LengthCubTimePerMass FromMeterCubSecondPerKilograms(double value) => new LengthCubTimePerMass((value + metercubsecondperkilogram_.Offset) * metercubsecondperkilogram_.Factor);
  public double GetValueInMeterCubSecondPerKilograms() => (Value_ - metercubsecondperkilogram_.Offset) / metercubsecondperkilogram_.Factor;
  public static LengthCubTimePerMass FromInchCubSecondPerKilograms(double value, double minValue, double maxValue) => new LengthCubTimePerMass((value + inchcubsecondperkilogram_.Offset) * inchcubsecondperkilogram_.Factor, minValue * inchcubsecondperkilogram_.Factor, maxValue * inchcubsecondperkilogram_.Factor);
  public static LengthCubTimePerMass FromInchCubSecondPerKilograms(double value) => new LengthCubTimePerMass((value + inchcubsecondperkilogram_.Offset) * inchcubsecondperkilogram_.Factor);
  public double GetValueInInchCubSecondPerKilograms() => (Value_ - inchcubsecondperkilogram_.Offset) / inchcubsecondperkilogram_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("LengthCubTimePerMass is outside its bounds.");
    }
    else if (fail)
    {
      return false;
