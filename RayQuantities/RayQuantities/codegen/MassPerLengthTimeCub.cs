...
#region units
  private static Unit_ kilogrampercentimetersecondcub_ = new Unit_("KilogramPerCentimeterSecondCub", "kg/cm s�", 1.0, 0);
  private static Unit_ kilogrampermillimetersecondcub_ = new Unit_("KilogramPerMillimeterSecondCub", "kg/mm s�", 10.0, 0);
  private static Unit_ kilogrampermetersecondcub_ = new Unit_("KilogramPerMeterSecondCub", "kg/m s�", 0.01, 0);
  private static Unit_ kilogramperinchsecondcub_ = new Unit_("KilogramPerInchSecondCub", "kg/in s�", 0.390625, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is MassPerLengthTimeCub other && Equals(other);
  public bool Equals(MassPerLengthTimeCub other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static MassPerLengthTimeCub FromKilogramPerCentimeterSecondCubs(double value, double minValue, double maxValue) => new MassPerLengthTimeCub((value + kilogrampercentimetersecondcub_.Offset) * kilogrampercentimetersecondcub_.Factor, minValue * kilogrampercentimetersecondcub_.Factor, maxValue * kilogrampercentimetersecondcub_.Factor);
  public static MassPerLengthTimeCub FromKilogramPerCentimeterSecondCubs(double value) => new MassPerLengthTimeCub((value + kilogrampercentimetersecondcub_.Offset) * kilogrampercentimetersecondcub_.Factor);
  public double GetValueInKilogramPerCentimeterSecondCubs() => (Value_ - kilogrampercentimetersecondcub_.Offset) / kilogrampercentimetersecondcub_.Factor;
  public static MassPerLengthTimeCub FromKilogramPerMillimeterSecondCubs(double value, double minValue, double maxValue) => new MassPerLengthTimeCub((value + kilogrampermillimetersecondcub_.Offset) * kilogrampermillimetersecondcub_.Factor, minValue * kilogrampermillimetersecondcub_.Factor, maxValue * kilogrampermillimetersecondcub_.Factor);
  public static MassPerLengthTimeCub FromKilogramPerMillimeterSecondCubs(double value) => new MassPerLengthTimeCub((value + kilogrampermillimetersecondcub_.Offset) * kilogrampermillimetersecondcub_.Factor);
  public double GetValueInKilogramPerMillimeterSecondCubs() => (Value_ - kilogrampermillimetersecondcub_.Offset) / kilogrampermillimetersecondcub_.Factor;
  public static MassPerLengthTimeCub FromKilogramPerMeterSecondCubs(double value, double minValue, double maxValue) => new MassPerLengthTimeCub((value + kilogrampermetersecondcub_.Offset) * kilogrampermetersecondcub_.Factor, minValue * kilogrampermetersecondcub_.Factor, maxValue * kilogrampermetersecondcub_.Factor);
  public static MassPerLengthTimeCub FromKilogramPerMeterSecondCubs(double value) => new MassPerLengthTimeCub((value + kilogrampermetersecondcub_.Offset) * kilogrampermetersecondcub_.Factor);
  public double GetValueInKilogramPerMeterSecondCubs() => (Value_ - kilogrampermetersecondcub_.Offset) / kilogrampermetersecondcub_.Factor;
  public static MassPerLengthTimeCub FromKilogramPerInchSecondCubs(double value, double minValue, double maxValue) => new MassPerLengthTimeCub((value + kilogramperinchsecondcub_.Offset) * kilogramperinchsecondcub_.Factor, minValue * kilogramperinchsecondcub_.Factor, maxValue * kilogramperinchsecondcub_.Factor);
  public static MassPerLengthTimeCub FromKilogramPerInchSecondCubs(double value) => new MassPerLengthTimeCub((value + kilogramperinchsecondcub_.Offset) * kilogramperinchsecondcub_.Factor);
  public double GetValueInKilogramPerInchSecondCubs() => (Value_ - kilogramperinchsecondcub_.Offset) / kilogramperinchsecondcub_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("MassPerLengthTimeCub is outside its bounds.");
    }
    else if (fail)
    {
      return false;
