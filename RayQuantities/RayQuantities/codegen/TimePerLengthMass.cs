...
#region units
  private static Unit_ secondpercentimeterkilogram_ = new Unit_("SecondPerCentimeterKilogram", "s/cm kg", 1.0, 0);
  private static Unit_ secondpermillimeterkilogram_ = new Unit_("SecondPerMillimeterKilogram", "s/mm kg", 10.0, 0);
  private static Unit_ secondpermeterkilogram_ = new Unit_("SecondPerMeterKilogram", "s/m kg", 0.01, 0);
  private static Unit_ secondperinchkilogram_ = new Unit_("SecondPerInchKilogram", "s/in kg", 0.390625, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is TimePerLengthMass other && Equals(other);
  public bool Equals(TimePerLengthMass other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static TimePerLengthMass FromSecondPerCentimeterKilograms(double value, double minValue, double maxValue) => new TimePerLengthMass((value + secondpercentimeterkilogram_.Offset) * secondpercentimeterkilogram_.Factor, minValue * secondpercentimeterkilogram_.Factor, maxValue * secondpercentimeterkilogram_.Factor);
  public static TimePerLengthMass FromSecondPerCentimeterKilograms(double value) => new TimePerLengthMass((value + secondpercentimeterkilogram_.Offset) * secondpercentimeterkilogram_.Factor);
  public double GetValueInSecondPerCentimeterKilograms() => (Value_ - secondpercentimeterkilogram_.Offset) / secondpercentimeterkilogram_.Factor;
  public static TimePerLengthMass FromSecondPerMillimeterKilograms(double value, double minValue, double maxValue) => new TimePerLengthMass((value + secondpermillimeterkilogram_.Offset) * secondpermillimeterkilogram_.Factor, minValue * secondpermillimeterkilogram_.Factor, maxValue * secondpermillimeterkilogram_.Factor);
  public static TimePerLengthMass FromSecondPerMillimeterKilograms(double value) => new TimePerLengthMass((value + secondpermillimeterkilogram_.Offset) * secondpermillimeterkilogram_.Factor);
  public double GetValueInSecondPerMillimeterKilograms() => (Value_ - secondpermillimeterkilogram_.Offset) / secondpermillimeterkilogram_.Factor;
  public static TimePerLengthMass FromSecondPerMeterKilograms(double value, double minValue, double maxValue) => new TimePerLengthMass((value + secondpermeterkilogram_.Offset) * secondpermeterkilogram_.Factor, minValue * secondpermeterkilogram_.Factor, maxValue * secondpermeterkilogram_.Factor);
  public static TimePerLengthMass FromSecondPerMeterKilograms(double value) => new TimePerLengthMass((value + secondpermeterkilogram_.Offset) * secondpermeterkilogram_.Factor);
  public double GetValueInSecondPerMeterKilograms() => (Value_ - secondpermeterkilogram_.Offset) / secondpermeterkilogram_.Factor;
  public static TimePerLengthMass FromSecondPerInchKilograms(double value, double minValue, double maxValue) => new TimePerLengthMass((value + secondperinchkilogram_.Offset) * secondperinchkilogram_.Factor, minValue * secondperinchkilogram_.Factor, maxValue * secondperinchkilogram_.Factor);
  public static TimePerLengthMass FromSecondPerInchKilograms(double value) => new TimePerLengthMass((value + secondperinchkilogram_.Offset) * secondperinchkilogram_.Factor);
  public double GetValueInSecondPerInchKilograms() => (Value_ - secondperinchkilogram_.Offset) / secondperinchkilogram_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("TimePerLengthMass is outside its bounds.");
    }
    else if (fail)
    {
      return false;
