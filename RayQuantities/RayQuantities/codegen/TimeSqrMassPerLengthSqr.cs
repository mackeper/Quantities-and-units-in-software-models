...
#region units
  private static Unit_ secondsqrkilogrampercentimetersqr_ = new Unit_("SecondSqrKilogramPerCentimeterSqr", "s² kg/cm²", 1.0, 0);
  private static Unit_ secondsqrkilogrampermillimetersqr_ = new Unit_("SecondSqrKilogramPerMillimeterSqr", "s² kg/mm²", 99.99999999999999, 0);
  private static Unit_ secondsqrkilogrampermetersqr_ = new Unit_("SecondSqrKilogramPerMeterSqr", "s² kg/m²", 0.0001, 0);
  private static Unit_ secondsqrkilogramperinchsqr_ = new Unit_("SecondSqrKilogramPerInchSqr", "s² kg/in²", 0.152587890625, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is TimeSqrMassPerLengthSqr other && Equals(other);
  public bool Equals(TimeSqrMassPerLengthSqr other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static TimeSqrMassPerLengthSqr FromSecondSqrKilogramPerCentimeterSqrs(double value, double minValue, double maxValue) => new TimeSqrMassPerLengthSqr((value + secondsqrkilogrampercentimetersqr_.Offset) * secondsqrkilogrampercentimetersqr_.Factor, minValue * secondsqrkilogrampercentimetersqr_.Factor, maxValue * secondsqrkilogrampercentimetersqr_.Factor);
  public static TimeSqrMassPerLengthSqr FromSecondSqrKilogramPerCentimeterSqrs(double value) => new TimeSqrMassPerLengthSqr((value + secondsqrkilogrampercentimetersqr_.Offset) * secondsqrkilogrampercentimetersqr_.Factor);
  public double GetValueInSecondSqrKilogramPerCentimeterSqrs() => (Value_ - secondsqrkilogrampercentimetersqr_.Offset) / secondsqrkilogrampercentimetersqr_.Factor;
  public static TimeSqrMassPerLengthSqr FromSecondSqrKilogramPerMillimeterSqrs(double value, double minValue, double maxValue) => new TimeSqrMassPerLengthSqr((value + secondsqrkilogrampermillimetersqr_.Offset) * secondsqrkilogrampermillimetersqr_.Factor, minValue * secondsqrkilogrampermillimetersqr_.Factor, maxValue * secondsqrkilogrampermillimetersqr_.Factor);
  public static TimeSqrMassPerLengthSqr FromSecondSqrKilogramPerMillimeterSqrs(double value) => new TimeSqrMassPerLengthSqr((value + secondsqrkilogrampermillimetersqr_.Offset) * secondsqrkilogrampermillimetersqr_.Factor);
  public double GetValueInSecondSqrKilogramPerMillimeterSqrs() => (Value_ - secondsqrkilogrampermillimetersqr_.Offset) / secondsqrkilogrampermillimetersqr_.Factor;
  public static TimeSqrMassPerLengthSqr FromSecondSqrKilogramPerMeterSqrs(double value, double minValue, double maxValue) => new TimeSqrMassPerLengthSqr((value + secondsqrkilogrampermetersqr_.Offset) * secondsqrkilogrampermetersqr_.Factor, minValue * secondsqrkilogrampermetersqr_.Factor, maxValue * secondsqrkilogrampermetersqr_.Factor);
  public static TimeSqrMassPerLengthSqr FromSecondSqrKilogramPerMeterSqrs(double value) => new TimeSqrMassPerLengthSqr((value + secondsqrkilogrampermetersqr_.Offset) * secondsqrkilogrampermetersqr_.Factor);
  public double GetValueInSecondSqrKilogramPerMeterSqrs() => (Value_ - secondsqrkilogrampermetersqr_.Offset) / secondsqrkilogrampermetersqr_.Factor;
  public static TimeSqrMassPerLengthSqr FromSecondSqrKilogramPerInchSqrs(double value, double minValue, double maxValue) => new TimeSqrMassPerLengthSqr((value + secondsqrkilogramperinchsqr_.Offset) * secondsqrkilogramperinchsqr_.Factor, minValue * secondsqrkilogramperinchsqr_.Factor, maxValue * secondsqrkilogramperinchsqr_.Factor);
  public static TimeSqrMassPerLengthSqr FromSecondSqrKilogramPerInchSqrs(double value) => new TimeSqrMassPerLengthSqr((value + secondsqrkilogramperinchsqr_.Offset) * secondsqrkilogramperinchsqr_.Factor);
  public double GetValueInSecondSqrKilogramPerInchSqrs() => (Value_ - secondsqrkilogramperinchsqr_.Offset) / secondsqrkilogramperinchsqr_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("TimeSqrMassPerLengthSqr is outside its bounds.");
    }
    else if (fail)
    {
      return false;
