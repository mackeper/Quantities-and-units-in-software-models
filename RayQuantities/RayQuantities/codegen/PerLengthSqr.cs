...
#region units
  private static Unit_ percentimetersqr_ = new Unit_("PerCentimeterSqr", "/cm²", 1.0, 0);
  private static Unit_ permillimetersqr_ = new Unit_("PerMillimeterSqr", "/mm²", 0.010000000000000002, 0);
  private static Unit_ permetersqr_ = new Unit_("PerMeterSqr", "/m²", 10000.0, 0);
  private static Unit_ perinchsqr_ = new Unit_("PerInchSqr", "/in²", 6.5536, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is PerLengthSqr other && Equals(other);
  public bool Equals(PerLengthSqr other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static PerLengthSqr FromPerCentimeterSqrs(double value, double minValue, double maxValue) => new PerLengthSqr((value + percentimetersqr_.Offset) * percentimetersqr_.Factor, minValue * percentimetersqr_.Factor, maxValue * percentimetersqr_.Factor);
  public static PerLengthSqr FromPerCentimeterSqrs(double value) => new PerLengthSqr((value + percentimetersqr_.Offset) * percentimetersqr_.Factor);
  public double GetValueInPerCentimeterSqrs() => (Value_ - percentimetersqr_.Offset) / percentimetersqr_.Factor;
  public static PerLengthSqr FromPerMillimeterSqrs(double value, double minValue, double maxValue) => new PerLengthSqr((value + permillimetersqr_.Offset) * permillimetersqr_.Factor, minValue * permillimetersqr_.Factor, maxValue * permillimetersqr_.Factor);
  public static PerLengthSqr FromPerMillimeterSqrs(double value) => new PerLengthSqr((value + permillimetersqr_.Offset) * permillimetersqr_.Factor);
  public double GetValueInPerMillimeterSqrs() => (Value_ - permillimetersqr_.Offset) / permillimetersqr_.Factor;
  public static PerLengthSqr FromPerMeterSqrs(double value, double minValue, double maxValue) => new PerLengthSqr((value + permetersqr_.Offset) * permetersqr_.Factor, minValue * permetersqr_.Factor, maxValue * permetersqr_.Factor);
  public static PerLengthSqr FromPerMeterSqrs(double value) => new PerLengthSqr((value + permetersqr_.Offset) * permetersqr_.Factor);
  public double GetValueInPerMeterSqrs() => (Value_ - permetersqr_.Offset) / permetersqr_.Factor;
  public static PerLengthSqr FromPerInchSqrs(double value, double minValue, double maxValue) => new PerLengthSqr((value + perinchsqr_.Offset) * perinchsqr_.Factor, minValue * perinchsqr_.Factor, maxValue * perinchsqr_.Factor);
  public static PerLengthSqr FromPerInchSqrs(double value) => new PerLengthSqr((value + perinchsqr_.Offset) * perinchsqr_.Factor);
  public double GetValueInPerInchSqrs() => (Value_ - perinchsqr_.Offset) / perinchsqr_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("PerLengthSqr is outside its bounds.");
    }
    else if (fail)
    {
      return false;
