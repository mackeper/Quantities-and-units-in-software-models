...
#region units
  private static Unit_ kilogramsecondpercentimeter_ = new Unit_("KilogramSecondPerCentimeter", "kg s/cm", 1.0, 0);
  private static Unit_ kilogramsecondpermillimeter_ = new Unit_("KilogramSecondPerMillimeter", "kg s/mm", 10.0, 0);
  private static Unit_ kilogramsecondpermeter_ = new Unit_("KilogramSecondPerMeter", "kg s/m", 0.01, 0);
  private static Unit_ kilogramsecondperinch_ = new Unit_("KilogramSecondPerInch", "kg s/in", 0.390625, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is MassTimePerLength other && Equals(other);
  public bool Equals(MassTimePerLength other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static MassTimePerLength FromKilogramSecondPerCentimeters(double value, double minValue, double maxValue) => new MassTimePerLength((value + kilogramsecondpercentimeter_.Offset) * kilogramsecondpercentimeter_.Factor, minValue * kilogramsecondpercentimeter_.Factor, maxValue * kilogramsecondpercentimeter_.Factor);
  public static MassTimePerLength FromKilogramSecondPerCentimeters(double value) => new MassTimePerLength((value + kilogramsecondpercentimeter_.Offset) * kilogramsecondpercentimeter_.Factor);
  public double GetValueInKilogramSecondPerCentimeters() => (Value_ - kilogramsecondpercentimeter_.Offset) / kilogramsecondpercentimeter_.Factor;
  public static MassTimePerLength FromKilogramSecondPerMillimeters(double value, double minValue, double maxValue) => new MassTimePerLength((value + kilogramsecondpermillimeter_.Offset) * kilogramsecondpermillimeter_.Factor, minValue * kilogramsecondpermillimeter_.Factor, maxValue * kilogramsecondpermillimeter_.Factor);
  public static MassTimePerLength FromKilogramSecondPerMillimeters(double value) => new MassTimePerLength((value + kilogramsecondpermillimeter_.Offset) * kilogramsecondpermillimeter_.Factor);
  public double GetValueInKilogramSecondPerMillimeters() => (Value_ - kilogramsecondpermillimeter_.Offset) / kilogramsecondpermillimeter_.Factor;
  public static MassTimePerLength FromKilogramSecondPerMeters(double value, double minValue, double maxValue) => new MassTimePerLength((value + kilogramsecondpermeter_.Offset) * kilogramsecondpermeter_.Factor, minValue * kilogramsecondpermeter_.Factor, maxValue * kilogramsecondpermeter_.Factor);
  public static MassTimePerLength FromKilogramSecondPerMeters(double value) => new MassTimePerLength((value + kilogramsecondpermeter_.Offset) * kilogramsecondpermeter_.Factor);
  public double GetValueInKilogramSecondPerMeters() => (Value_ - kilogramsecondpermeter_.Offset) / kilogramsecondpermeter_.Factor;
  public static MassTimePerLength FromKilogramSecondPerInchs(double value, double minValue, double maxValue) => new MassTimePerLength((value + kilogramsecondperinch_.Offset) * kilogramsecondperinch_.Factor, minValue * kilogramsecondperinch_.Factor, maxValue * kilogramsecondperinch_.Factor);
  public static MassTimePerLength FromKilogramSecondPerInchs(double value) => new MassTimePerLength((value + kilogramsecondperinch_.Offset) * kilogramsecondperinch_.Factor);
  public double GetValueInKilogramSecondPerInchs() => (Value_ - kilogramsecondperinch_.Offset) / kilogramsecondperinch_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("MassTimePerLength is outside its bounds.");
    }
    else if (fail)
    {
      return false;
