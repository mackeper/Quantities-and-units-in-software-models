...
#region units
  private static Unit_ secondsqrkilogram_ = new Unit_("SecondSqrKilogram", "s² kg", 1, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is TimeSqrMass other && Equals(other);
  public bool Equals(TimeSqrMass other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static TimeSqrMass FromSecondSqrKilograms(double value, double minValue, double maxValue) => new TimeSqrMass((value + secondsqrkilogram_.Offset) * secondsqrkilogram_.Factor, minValue * secondsqrkilogram_.Factor, maxValue * secondsqrkilogram_.Factor);
  public static TimeSqrMass FromSecondSqrKilograms(double value) => new TimeSqrMass((value + secondsqrkilogram_.Offset) * secondsqrkilogram_.Factor);
  public double GetValueInSecondSqrKilograms() => (Value_ - secondsqrkilogram_.Offset) / secondsqrkilogram_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("TimeSqrMass is outside its bounds.");
    }
    else if (fail)
    {
      return false;
