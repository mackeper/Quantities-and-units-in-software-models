...
#region units
  private static Unit_ centimetersqrperkilogramsecond_ = new Unit_("CentimeterSqrPerKilogramSecond", "cm²/kg s", 1.0, 0);
  private static Unit_ millimetersqrperkilogramsecond_ = new Unit_("MillimeterSqrPerKilogramSecond", "mm²/kg s", 0.010000000000000002, 0);
  private static Unit_ metersqrperkilogramsecond_ = new Unit_("MeterSqrPerKilogramSecond", "m²/kg s", 10000.0, 0);
  private static Unit_ inchsqrperkilogramsecond_ = new Unit_("InchSqrPerKilogramSecond", "in²/kg s", 6.5536, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is LengthSqrPerMassTime other && Equals(other);
  public bool Equals(LengthSqrPerMassTime other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static LengthSqrPerMassTime FromCentimeterSqrPerKilogramSeconds(double value, double minValue, double maxValue) => new LengthSqrPerMassTime((value + centimetersqrperkilogramsecond_.Offset) * centimetersqrperkilogramsecond_.Factor, minValue * centimetersqrperkilogramsecond_.Factor, maxValue * centimetersqrperkilogramsecond_.Factor);
  public static LengthSqrPerMassTime FromCentimeterSqrPerKilogramSeconds(double value) => new LengthSqrPerMassTime((value + centimetersqrperkilogramsecond_.Offset) * centimetersqrperkilogramsecond_.Factor);
  public double GetValueInCentimeterSqrPerKilogramSeconds() => (Value_ - centimetersqrperkilogramsecond_.Offset) / centimetersqrperkilogramsecond_.Factor;
  public static LengthSqrPerMassTime FromMillimeterSqrPerKilogramSeconds(double value, double minValue, double maxValue) => new LengthSqrPerMassTime((value + millimetersqrperkilogramsecond_.Offset) * millimetersqrperkilogramsecond_.Factor, minValue * millimetersqrperkilogramsecond_.Factor, maxValue * millimetersqrperkilogramsecond_.Factor);
  public static LengthSqrPerMassTime FromMillimeterSqrPerKilogramSeconds(double value) => new LengthSqrPerMassTime((value + millimetersqrperkilogramsecond_.Offset) * millimetersqrperkilogramsecond_.Factor);
  public double GetValueInMillimeterSqrPerKilogramSeconds() => (Value_ - millimetersqrperkilogramsecond_.Offset) / millimetersqrperkilogramsecond_.Factor;
  public static LengthSqrPerMassTime FromMeterSqrPerKilogramSeconds(double value, double minValue, double maxValue) => new LengthSqrPerMassTime((value + metersqrperkilogramsecond_.Offset) * metersqrperkilogramsecond_.Factor, minValue * metersqrperkilogramsecond_.Factor, maxValue * metersqrperkilogramsecond_.Factor);
  public static LengthSqrPerMassTime FromMeterSqrPerKilogramSeconds(double value) => new LengthSqrPerMassTime((value + metersqrperkilogramsecond_.Offset) * metersqrperkilogramsecond_.Factor);
  public double GetValueInMeterSqrPerKilogramSeconds() => (Value_ - metersqrperkilogramsecond_.Offset) / metersqrperkilogramsecond_.Factor;
  public static LengthSqrPerMassTime FromInchSqrPerKilogramSeconds(double value, double minValue, double maxValue) => new LengthSqrPerMassTime((value + inchsqrperkilogramsecond_.Offset) * inchsqrperkilogramsecond_.Factor, minValue * inchsqrperkilogramsecond_.Factor, maxValue * inchsqrperkilogramsecond_.Factor);
  public static LengthSqrPerMassTime FromInchSqrPerKilogramSeconds(double value) => new LengthSqrPerMassTime((value + inchsqrperkilogramsecond_.Offset) * inchsqrperkilogramsecond_.Factor);
  public double GetValueInInchSqrPerKilogramSeconds() => (Value_ - inchsqrperkilogramsecond_.Offset) / inchsqrperkilogramsecond_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("LengthSqrPerMassTime is outside its bounds.");
    }
    else if (fail)
    {
      return false;
