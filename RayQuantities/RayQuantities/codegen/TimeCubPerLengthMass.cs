...
#region units
  private static Unit_ secondcubpercentimeterkilogram_ = new Unit_("SecondCubPerCentimeterKilogram", "s³/cm kg", 1.0, 0);
  private static Unit_ secondcubpermillimeterkilogram_ = new Unit_("SecondCubPerMillimeterKilogram", "s³/mm kg", 10.0, 0);
  private static Unit_ secondcubpermeterkilogram_ = new Unit_("SecondCubPerMeterKilogram", "s³/m kg", 0.01, 0);
  private static Unit_ secondcubperinchkilogram_ = new Unit_("SecondCubPerInchKilogram", "s³/in kg", 0.390625, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is TimeCubPerLengthMass other && Equals(other);
  public bool Equals(TimeCubPerLengthMass other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static TimeCubPerLengthMass FromSecondCubPerCentimeterKilograms(double value, double minValue, double maxValue) => new TimeCubPerLengthMass((value + secondcubpercentimeterkilogram_.Offset) * secondcubpercentimeterkilogram_.Factor, minValue * secondcubpercentimeterkilogram_.Factor, maxValue * secondcubpercentimeterkilogram_.Factor);
  public static TimeCubPerLengthMass FromSecondCubPerCentimeterKilograms(double value) => new TimeCubPerLengthMass((value + secondcubpercentimeterkilogram_.Offset) * secondcubpercentimeterkilogram_.Factor);
  public double GetValueInSecondCubPerCentimeterKilograms() => (Value_ - secondcubpercentimeterkilogram_.Offset) / secondcubpercentimeterkilogram_.Factor;
  public static TimeCubPerLengthMass FromSecondCubPerMillimeterKilograms(double value, double minValue, double maxValue) => new TimeCubPerLengthMass((value + secondcubpermillimeterkilogram_.Offset) * secondcubpermillimeterkilogram_.Factor, minValue * secondcubpermillimeterkilogram_.Factor, maxValue * secondcubpermillimeterkilogram_.Factor);
  public static TimeCubPerLengthMass FromSecondCubPerMillimeterKilograms(double value) => new TimeCubPerLengthMass((value + secondcubpermillimeterkilogram_.Offset) * secondcubpermillimeterkilogram_.Factor);
  public double GetValueInSecondCubPerMillimeterKilograms() => (Value_ - secondcubpermillimeterkilogram_.Offset) / secondcubpermillimeterkilogram_.Factor;
  public static TimeCubPerLengthMass FromSecondCubPerMeterKilograms(double value, double minValue, double maxValue) => new TimeCubPerLengthMass((value + secondcubpermeterkilogram_.Offset) * secondcubpermeterkilogram_.Factor, minValue * secondcubpermeterkilogram_.Factor, maxValue * secondcubpermeterkilogram_.Factor);
  public static TimeCubPerLengthMass FromSecondCubPerMeterKilograms(double value) => new TimeCubPerLengthMass((value + secondcubpermeterkilogram_.Offset) * secondcubpermeterkilogram_.Factor);
  public double GetValueInSecondCubPerMeterKilograms() => (Value_ - secondcubpermeterkilogram_.Offset) / secondcubpermeterkilogram_.Factor;
  public static TimeCubPerLengthMass FromSecondCubPerInchKilograms(double value, double minValue, double maxValue) => new TimeCubPerLengthMass((value + secondcubperinchkilogram_.Offset) * secondcubperinchkilogram_.Factor, minValue * secondcubperinchkilogram_.Factor, maxValue * secondcubperinchkilogram_.Factor);
  public static TimeCubPerLengthMass FromSecondCubPerInchKilograms(double value) => new TimeCubPerLengthMass((value + secondcubperinchkilogram_.Offset) * secondcubperinchkilogram_.Factor);
  public double GetValueInSecondCubPerInchKilograms() => (Value_ - secondcubperinchkilogram_.Offset) / secondcubperinchkilogram_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("TimeCubPerLengthMass is outside its bounds.");
    }
    else if (fail)
    {
      return false;
