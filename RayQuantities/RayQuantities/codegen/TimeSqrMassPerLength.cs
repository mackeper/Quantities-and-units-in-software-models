...
#region units
  private static Unit_ secondsqrkilogrampercentimeter_ = new Unit_("SecondSqrKilogramPerCentimeter", "s� kg/cm", 1.0, 0);
  private static Unit_ secondsqrkilogrampermillimeter_ = new Unit_("SecondSqrKilogramPerMillimeter", "s� kg/mm", 10.0, 0);
  private static Unit_ secondsqrkilogrampermeter_ = new Unit_("SecondSqrKilogramPerMeter", "s� kg/m", 0.01, 0);
  private static Unit_ secondsqrkilogramperinch_ = new Unit_("SecondSqrKilogramPerInch", "s� kg/in", 0.390625, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is TimeSqrMassPerLength other && Equals(other);
  public bool Equals(TimeSqrMassPerLength other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static TimeSqrMassPerLength FromSecondSqrKilogramPerCentimeters(double value, double minValue, double maxValue) => new TimeSqrMassPerLength((value + secondsqrkilogrampercentimeter_.Offset) * secondsqrkilogrampercentimeter_.Factor, minValue * secondsqrkilogrampercentimeter_.Factor, maxValue * secondsqrkilogrampercentimeter_.Factor);
  public static TimeSqrMassPerLength FromSecondSqrKilogramPerCentimeters(double value) => new TimeSqrMassPerLength((value + secondsqrkilogrampercentimeter_.Offset) * secondsqrkilogrampercentimeter_.Factor);
  public double GetValueInSecondSqrKilogramPerCentimeters() => (Value_ - secondsqrkilogrampercentimeter_.Offset) / secondsqrkilogrampercentimeter_.Factor;
  public static TimeSqrMassPerLength FromSecondSqrKilogramPerMillimeters(double value, double minValue, double maxValue) => new TimeSqrMassPerLength((value + secondsqrkilogrampermillimeter_.Offset) * secondsqrkilogrampermillimeter_.Factor, minValue * secondsqrkilogrampermillimeter_.Factor, maxValue * secondsqrkilogrampermillimeter_.Factor);
  public static TimeSqrMassPerLength FromSecondSqrKilogramPerMillimeters(double value) => new TimeSqrMassPerLength((value + secondsqrkilogrampermillimeter_.Offset) * secondsqrkilogrampermillimeter_.Factor);
  public double GetValueInSecondSqrKilogramPerMillimeters() => (Value_ - secondsqrkilogrampermillimeter_.Offset) / secondsqrkilogrampermillimeter_.Factor;
  public static TimeSqrMassPerLength FromSecondSqrKilogramPerMeters(double value, double minValue, double maxValue) => new TimeSqrMassPerLength((value + secondsqrkilogrampermeter_.Offset) * secondsqrkilogrampermeter_.Factor, minValue * secondsqrkilogrampermeter_.Factor, maxValue * secondsqrkilogrampermeter_.Factor);
  public static TimeSqrMassPerLength FromSecondSqrKilogramPerMeters(double value) => new TimeSqrMassPerLength((value + secondsqrkilogrampermeter_.Offset) * secondsqrkilogrampermeter_.Factor);
  public double GetValueInSecondSqrKilogramPerMeters() => (Value_ - secondsqrkilogrampermeter_.Offset) / secondsqrkilogrampermeter_.Factor;
  public static TimeSqrMassPerLength FromSecondSqrKilogramPerInchs(double value, double minValue, double maxValue) => new TimeSqrMassPerLength((value + secondsqrkilogramperinch_.Offset) * secondsqrkilogramperinch_.Factor, minValue * secondsqrkilogramperinch_.Factor, maxValue * secondsqrkilogramperinch_.Factor);
  public static TimeSqrMassPerLength FromSecondSqrKilogramPerInchs(double value) => new TimeSqrMassPerLength((value + secondsqrkilogramperinch_.Offset) * secondsqrkilogramperinch_.Factor);
  public double GetValueInSecondSqrKilogramPerInchs() => (Value_ - secondsqrkilogramperinch_.Offset) / secondsqrkilogramperinch_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("TimeSqrMassPerLength is outside its bounds.");
    }
    else if (fail)
    {
      return false;
