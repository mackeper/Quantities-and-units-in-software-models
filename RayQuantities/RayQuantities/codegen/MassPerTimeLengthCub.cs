...
#region units
  private static Unit_ kilogrampersecondcentimetercub_ = new Unit_("KilogramPerSecondCentimeterCub", "kg/s cm�", 1.0, 0);
  private static Unit_ kilogrampersecondmillimetercub_ = new Unit_("KilogramPerSecondMillimeterCub", "kg/s mm�", 999.9999999999998, 0);
  private static Unit_ kilogrampersecondmetercub_ = new Unit_("KilogramPerSecondMeterCub", "kg/s m�", 1e-06, 0);
  private static Unit_ kilogrampersecondinchcub_ = new Unit_("KilogramPerSecondInchCub", "kg/s in�", 0.05960464477539062, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is MassPerTimeLengthCub other && Equals(other);
  public bool Equals(MassPerTimeLengthCub other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static MassPerTimeLengthCub FromKilogramPerSecondCentimeterCubs(double value, double minValue, double maxValue) => new MassPerTimeLengthCub((value + kilogrampersecondcentimetercub_.Offset) * kilogrampersecondcentimetercub_.Factor, minValue * kilogrampersecondcentimetercub_.Factor, maxValue * kilogrampersecondcentimetercub_.Factor);
  public static MassPerTimeLengthCub FromKilogramPerSecondCentimeterCubs(double value) => new MassPerTimeLengthCub((value + kilogrampersecondcentimetercub_.Offset) * kilogrampersecondcentimetercub_.Factor);
  public double GetValueInKilogramPerSecondCentimeterCubs() => (Value_ - kilogrampersecondcentimetercub_.Offset) / kilogrampersecondcentimetercub_.Factor;
  public static MassPerTimeLengthCub FromKilogramPerSecondMillimeterCubs(double value, double minValue, double maxValue) => new MassPerTimeLengthCub((value + kilogrampersecondmillimetercub_.Offset) * kilogrampersecondmillimetercub_.Factor, minValue * kilogrampersecondmillimetercub_.Factor, maxValue * kilogrampersecondmillimetercub_.Factor);
  public static MassPerTimeLengthCub FromKilogramPerSecondMillimeterCubs(double value) => new MassPerTimeLengthCub((value + kilogrampersecondmillimetercub_.Offset) * kilogrampersecondmillimetercub_.Factor);
  public double GetValueInKilogramPerSecondMillimeterCubs() => (Value_ - kilogrampersecondmillimetercub_.Offset) / kilogrampersecondmillimetercub_.Factor;
  public static MassPerTimeLengthCub FromKilogramPerSecondMeterCubs(double value, double minValue, double maxValue) => new MassPerTimeLengthCub((value + kilogrampersecondmetercub_.Offset) * kilogrampersecondmetercub_.Factor, minValue * kilogrampersecondmetercub_.Factor, maxValue * kilogrampersecondmetercub_.Factor);
  public static MassPerTimeLengthCub FromKilogramPerSecondMeterCubs(double value) => new MassPerTimeLengthCub((value + kilogrampersecondmetercub_.Offset) * kilogrampersecondmetercub_.Factor);
  public double GetValueInKilogramPerSecondMeterCubs() => (Value_ - kilogrampersecondmetercub_.Offset) / kilogrampersecondmetercub_.Factor;
  public static MassPerTimeLengthCub FromKilogramPerSecondInchCubs(double value, double minValue, double maxValue) => new MassPerTimeLengthCub((value + kilogrampersecondinchcub_.Offset) * kilogrampersecondinchcub_.Factor, minValue * kilogrampersecondinchcub_.Factor, maxValue * kilogrampersecondinchcub_.Factor);
  public static MassPerTimeLengthCub FromKilogramPerSecondInchCubs(double value) => new MassPerTimeLengthCub((value + kilogrampersecondinchcub_.Offset) * kilogrampersecondinchcub_.Factor);
  public double GetValueInKilogramPerSecondInchCubs() => (Value_ - kilogrampersecondinchcub_.Offset) / kilogrampersecondinchcub_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("MassPerTimeLengthCub is outside its bounds.");
    }
    else if (fail)
    {
      return false;
