...
#region units
  private static Unit_ centimetercubpersecondsqr_ = new Unit_("CentimeterCubPerSecondSqr", "cm³/s²", 1.0, 0);
  private static Unit_ millimetercubpersecondsqr_ = new Unit_("MillimeterCubPerSecondSqr", "mm³/s²", 0.0010000000000000002, 0);
  private static Unit_ metercubpersecondsqr_ = new Unit_("MeterCubPerSecondSqr", "m³/s²", 1000000.0, 0);
  private static Unit_ inchcubpersecondsqr_ = new Unit_("InchCubPerSecondSqr", "in³/s²", 16.777216000000003, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is LengthCubPerTimeSqr other && Equals(other);
  public bool Equals(LengthCubPerTimeSqr other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static LengthCubPerTimeSqr FromCentimeterCubPerSecondSqrs(double value, double minValue, double maxValue) => new LengthCubPerTimeSqr((value + centimetercubpersecondsqr_.Offset) * centimetercubpersecondsqr_.Factor, minValue * centimetercubpersecondsqr_.Factor, maxValue * centimetercubpersecondsqr_.Factor);
  public static LengthCubPerTimeSqr FromCentimeterCubPerSecondSqrs(double value) => new LengthCubPerTimeSqr((value + centimetercubpersecondsqr_.Offset) * centimetercubpersecondsqr_.Factor);
  public double GetValueInCentimeterCubPerSecondSqrs() => (Value_ - centimetercubpersecondsqr_.Offset) / centimetercubpersecondsqr_.Factor;
  public static LengthCubPerTimeSqr FromMillimeterCubPerSecondSqrs(double value, double minValue, double maxValue) => new LengthCubPerTimeSqr((value + millimetercubpersecondsqr_.Offset) * millimetercubpersecondsqr_.Factor, minValue * millimetercubpersecondsqr_.Factor, maxValue * millimetercubpersecondsqr_.Factor);
  public static LengthCubPerTimeSqr FromMillimeterCubPerSecondSqrs(double value) => new LengthCubPerTimeSqr((value + millimetercubpersecondsqr_.Offset) * millimetercubpersecondsqr_.Factor);
  public double GetValueInMillimeterCubPerSecondSqrs() => (Value_ - millimetercubpersecondsqr_.Offset) / millimetercubpersecondsqr_.Factor;
  public static LengthCubPerTimeSqr FromMeterCubPerSecondSqrs(double value, double minValue, double maxValue) => new LengthCubPerTimeSqr((value + metercubpersecondsqr_.Offset) * metercubpersecondsqr_.Factor, minValue * metercubpersecondsqr_.Factor, maxValue * metercubpersecondsqr_.Factor);
  public static LengthCubPerTimeSqr FromMeterCubPerSecondSqrs(double value) => new LengthCubPerTimeSqr((value + metercubpersecondsqr_.Offset) * metercubpersecondsqr_.Factor);
  public double GetValueInMeterCubPerSecondSqrs() => (Value_ - metercubpersecondsqr_.Offset) / metercubpersecondsqr_.Factor;
  public static LengthCubPerTimeSqr FromInchCubPerSecondSqrs(double value, double minValue, double maxValue) => new LengthCubPerTimeSqr((value + inchcubpersecondsqr_.Offset) * inchcubpersecondsqr_.Factor, minValue * inchcubpersecondsqr_.Factor, maxValue * inchcubpersecondsqr_.Factor);
  public static LengthCubPerTimeSqr FromInchCubPerSecondSqrs(double value) => new LengthCubPerTimeSqr((value + inchcubpersecondsqr_.Offset) * inchcubpersecondsqr_.Factor);
  public double GetValueInInchCubPerSecondSqrs() => (Value_ - inchcubpersecondsqr_.Offset) / inchcubpersecondsqr_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("LengthCubPerTimeSqr is outside its bounds.");
    }
    else if (fail)
    {
      return false;
