...
#region units
  private static Unit_ secondsqrperkilogram_ = new Unit_("SecondSqrPerKilogram", "s²/kg", 1.0, 0);
...
#region comparisons
  ...
  public override bool Equals(Object obj) => obj is TimeSqrPerMass other && Equals(other);
  public bool Equals(TimeSqrPerMass other) => other is object && Math.Abs(Value_ - other.Value_) <= epsilon;
...
#region conversions
  public static TimeSqrPerMass FromSecondSqrPerKilograms(double value, double minValue, double maxValue) => new TimeSqrPerMass((value + secondsqrperkilogram_.Offset) * secondsqrperkilogram_.Factor, minValue * secondsqrperkilogram_.Factor, maxValue * secondsqrperkilogram_.Factor);
  public static TimeSqrPerMass FromSecondSqrPerKilograms(double value) => new TimeSqrPerMass((value + secondsqrperkilogram_.Offset) * secondsqrperkilogram_.Factor);
  public double GetValueInSecondSqrPerKilograms() => (Value_ - secondsqrperkilogram_.Offset) / secondsqrperkilogram_.Factor;
...
#region rules
  ...
  public bool ValidateRules(bool throwOnFail=true)
  {
    ...
    if (fail && throwOnFail)
    {
      throw new System.ArgumentException("TimeSqrPerMass is outside its bounds.");
    }
    else if (fail)
    {
      return false;
